...
- Latest Lab follow-up: Unit 107 `dual-portfolio-formula-interaction-spillover-causality-v1`, `VALID_NO_TRANSFERABLE_DIRECT_FORMULA_INTERACTION_NO_SEED`; both exact interaction clues reversed in formula-unseen later direct-component economics
...
- Active serial Lab detour: Unit 108 `us-equity-index-cash-close-intraday-momentum-v1`, literature-fixed US30+US100 previous-cash-close→15:30 sign continuation through the 16:00 cash close; declaration frozen with economics unopened and no Optimization integration authority
...
This is the sole continuous economic-optimization stream and is physically independent from Live-Dev and Lab. The fixed paired-month replacement development candidate uses component weights `2 / 1.5 / 2 / 2.5 / 1.5 / 0` at position/aggregate risk `0.04 / 0.18`. Its native selection actual/stressed net remains `+$5,786.63 / +$5,477.524` at relative equity DD `20.256887565%`; its proxy-selected native June-July execution/cost confirmation remains `+$32.74 / +$30.626` at `18.675302130%`. Both months participated in proxy candidate gating and ranking, so this interval is not an independent statistical holdout. The latest dual-portfolio formula campaign screened `8,639` wide-range points under both this contract and exact Live-derived `1 / 1 / 1 / 1 / 1 / 1`, found zero robust replacement or paired plateau and sent no point to MT5. Its two exact post-selection interactions were then isolated in Lab Unit 107: selection uplift was genuinely majority-direct, but changed-component economics reversed in both E4 and continuous June-July, so neither interaction retained a seed. The internal-formula axis is closed unless materially new independent evidence creates a different causal mechanism. Environment, engineering, configuration, history and report faults remain correction states with no economic verdict or retry cap. Every MT5 campaign is uniquely identified and tester-only, isolated from Master, Live and Lab. No result promotes automatically; explicit user authorization and a separate Lab engineering handoff are required before any possible Live change.
