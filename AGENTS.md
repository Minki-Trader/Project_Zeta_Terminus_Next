...
- Optimization candidates may deliberately diverge from Live behavior, including strategy removal/replacement, portfolio reconstruction and destructive economic variants, provided the exact Live-derived control remains attributable and no candidate source, runtime or output touches Live or Lab.
