...
const string EXECUTION_VERSION = "zt-next-lab-cxr1-entry-gate";
...
const string RELEASE_ID = "NEXT-LAB-CXR1-ENTRY-GATE";
const string PORTFOLIO_ID = "ZT-PORT-NEXT-LAB-CXR1-ENTRY-GATE";
...
const string STATE_MARKER = "ZT_NEXT_LAB_CXR1_ENTRY_GATE_STATE_V7";
const string STATE_PATH_A =
   "ZetaTerminusNext\\lab\\cxr1\\cxr1-state-a.csv";
const string STATE_PATH_B =
   "ZetaTerminusNext\\lab\\cxr1\\cxr1-state-b.csv";
const string EVENT_PATH_A =
   "ZetaTerminusNext\\lab\\cxr1\\cxr1-events-a.csv";
const string EVENT_PATH_B =
   "ZetaTerminusNext\\lab\\cxr1\\cxr1-events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaTerminusNext\\lab\\cxr1\\cxr1-current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaTerminusNext\\lab\\cxr1\\cxr1-current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaTerminusNext\\lab\\cxr1\\cxr1.lock";
...
const ulong MAGIC_RC16_LONG = 260825100;
const ulong MAGIC_RC4_BOTH = 260825101;
const ulong MAGIC_US100_CROSS = 260825102;
const ulong MAGIC_US30_PRESSURE = 260825103;
const ulong MAGIC_US30_RETURN = 260825104;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260825105;
