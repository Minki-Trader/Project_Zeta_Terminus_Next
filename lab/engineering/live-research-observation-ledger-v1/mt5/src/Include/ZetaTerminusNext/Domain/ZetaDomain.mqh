...
const string EXECUTION_VERSION =
   "zt-next-lab-live-research-observation-ledger-v1";
...
const string RELEASE_ID =
   "NEXT-LAB-LIVE-RESEARCH-OBSERVATION-LEDGER-V1";
const string PORTFOLIO_ID = "ZT-PORT-NEXT-LAB-RLO-V1";
...
const string STATE_MARKER =
   "ZT_NEXT_LAB_LIVE_RESEARCH_OBSERVATION_LEDGER_V1";
const string STATE_PATH_A =
   "ZetaTerminusNext\\lab\\rlo1\\rlo1-state-a.csv";
const string STATE_PATH_B =
   "ZetaTerminusNext\\lab\\rlo1\\rlo1-state-b.csv";
const string EVENT_PATH_A =
   "ZetaTerminusNext\\lab\\rlo1\\rlo1-events-a.csv";
const string EVENT_PATH_B =
   "ZetaTerminusNext\\lab\\rlo1\\rlo1-events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaTerminusNext\\lab\\rlo1\\rlo1-current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaTerminusNext\\lab\\rlo1\\rlo1-current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaTerminusNext\\lab\\rlo1\\rlo1.lock";
const string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaTerminusNext\\lab\\rlo1";
...
const string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaTerminusNext\\lab\\rlo1\\research-state-a.csv";
const string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaTerminusNext\\lab\\rlo1\\research-state-b.csv";
const string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaTerminusNext\\lab\\rlo1\\research-candidates.csv";
const string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaTerminusNext\\lab\\rlo1\\research-lifecycles.csv";
...
const ulong MAGIC_RC16_LONG = 260826300;
const ulong MAGIC_RC4_BOTH = 260826301;
const ulong MAGIC_US100_CROSS = 260826302;
const ulong MAGIC_US30_PRESSURE = 260826303;
const ulong MAGIC_US30_RETURN = 260826304;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260826305;
