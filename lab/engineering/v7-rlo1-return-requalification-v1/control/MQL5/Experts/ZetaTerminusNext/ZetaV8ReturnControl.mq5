...
#property description "Execution version: zt-lab-v8-return-control-v1"
...
#include <ZetaTerminusNext\Observation\ZetaReturnDiagnostics.mqh>
...
int OnInit()
  {
   ...
   FolderCreate("ZetaTerminusNext\\live\\v8-return-control");
   FolderCreate("ZetaTerminusNext\\live\\v8-return-control\\state");
   FolderCreate("ZetaTerminusNext\\live\\v8-return-control\\research");
   if(tester_mode)
