...
const string SCHEMA_VERSION = "8RC1";
const string RELEASE_ID = "LAB-V8RR1-465f2fa6c951";
const string PORTFOLIO_ID = "ZT-PORT-LAB-V8RR1-20260907";
...
const string STATE_MARKER =
   "ZT_NEXT_8RC1_STATE_V1";
const string STATE_PATH_A =
   "ZetaTerminusNext\\live\\v8-return-control\\state\\state-a.csv";
const string STATE_PATH_B =
   "ZetaTerminusNext\\live\\v8-return-control\\state\\state-b.csv";
const string EVENT_PATH_A =
   "ZetaTerminusNext\\live\\v8-return-control\\state\\events-a.csv";
const string EVENT_PATH_B =
   "ZetaTerminusNext\\live\\v8-return-control\\state\\events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaTerminusNext\\live\\v8-return-control\\state\\current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaTerminusNext\\live\\v8-return-control\\state\\current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaTerminusNext\\live\\v8-return-control\\state\\runtime.lock";
const string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaTerminusNext\\live\\v8-return-control\\research";
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-next-v8-return-control-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_NEXT_8RC1_OBSERVATION_STATE_V1";
const string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaTerminusNext\\live\\v8-return-control\\research\\research-state-a.csv";
const string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaTerminusNext\\live\\v8-return-control\\research\\research-state-b.csv";
const string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaTerminusNext\\live\\v8-return-control\\research\\research-candidates.csv";
const string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaTerminusNext\\live\\v8-return-control\\research\\research-lifecycles.csv";
...
const ulong MAGIC_RC16_LONG = 260907801;
const ulong MAGIC_RC4_BOTH = 260907802;
const ulong MAGIC_US100_CROSS = 260907803;
const ulong MAGIC_US30_PRESSURE = 260907804;
const ulong MAGIC_US30_RETURN = 260907805;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260907806;
