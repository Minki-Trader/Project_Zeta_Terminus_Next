...
#property description "Project Zeta Terminus Next paired-month Live replacement engineering handoff"
#property description "Execution version: zt-next-lab-paired-month-live-replacement-handoff-v1"

#include <Trade\Trade.mqh>

#include <ZetaPairedMonthLiveReplacementHandoffV1\Domain\ZetaDomain.mqh>
#include <ZetaPairedMonthLiveReplacementHandoffV1\Time\ZetaSessionClock.mqh>
#include <ZetaPairedMonthLiveReplacementHandoffV1\Strategies\ZetaStrategyShared.mqh>
#include <ZetaPairedMonthLiveReplacementHandoffV1\Strategies\ZetaRC16.mqh>
#include <ZetaPairedMonthLiveReplacementHandoffV1\Strategies\ZetaRC4.mqh>
#include <ZetaPairedMonthLiveReplacementHandoffV1\Strategies\ZetaCross.mqh>
#include <ZetaPairedMonthLiveReplacementHandoffV1\Strategies\ZetaPressure.mqh>
#include <ZetaPairedMonthLiveReplacementHandoffV1\Strategies\ZetaReturn.mqh>
#include <ZetaPairedMonthLiveReplacementHandoffV1\Strategies\ZetaPassive.mqh>
#include <ZetaPairedMonthLiveReplacementHandoffV1\Portfolio\ZetaPortfolioRisk.mqh>
#include <ZetaPairedMonthLiveReplacementHandoffV1\Execution\ZetaOwnership.mqh>
#include <ZetaPairedMonthLiveReplacementHandoffV1\Execution\ZetaOrders.mqh>
#include <ZetaPairedMonthLiveReplacementHandoffV1\Execution\ZetaProtectionAndReconciliation.mqh>
#include <ZetaPairedMonthLiveReplacementHandoffV1\Persistence\ZetaStateAndEvents.mqh>
#include <ZetaPairedMonthLiveReplacementHandoffV1\Observation\ZetaResearchObservation.mqh>
...
int OnInit()
  {
   ...
   FolderCreate("ZetaTerminusNext\\lab\\pmlrh1");
   FolderCreate("ZetaTerminusNext\\lab\\pmlrh1\\state");
   FolderCreate("ZetaTerminusNext\\lab\\pmlrh1\\research");
