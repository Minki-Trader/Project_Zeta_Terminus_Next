...
// Self-contained Lab engineering handoff of the fixed paired-month candidate.
// Economic terms are frozen; only Lab identity and mutable paths differ.
...
const string EXECUTION_VERSION =
   "zt-next-lab-paired-month-live-replacement-handoff-v1";
...
const string SCHEMA_VERSION = "lab-pmlrh-1";
const string RELEASE_ID = "NEXT-LAB-PMLRH1-20260829";
const string PORTFOLIO_ID = "ZT-PORT-NEXT-LAB-PMLRH1-20260829";
...
const string EXECUTION_FINGERPRINT =
   "paired-month-live-capable-lab-handoff-entries-disabled-default-separated-state-logs-ownership-v1";
const string STATE_MARKER =
   "ZT_NEXT_LAB_PMLRH1_STATE_V1";
const string STATE_PATH_A =
   "ZetaTerminusNext\\lab\\pmlrh1\\state\\state-a.csv";
const string STATE_PATH_B =
   "ZetaTerminusNext\\lab\\pmlrh1\\state\\state-b.csv";
const string EVENT_PATH_A =
   "ZetaTerminusNext\\lab\\pmlrh1\\state\\events-a.csv";
const string EVENT_PATH_B =
   "ZetaTerminusNext\\lab\\pmlrh1\\state\\events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaTerminusNext\\lab\\pmlrh1\\state\\current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaTerminusNext\\lab\\pmlrh1\\state\\current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaTerminusNext\\lab\\pmlrh1\\state\\runtime.lock";
const string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaTerminusNext\\lab\\pmlrh1\\research";
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-next-lab-paired-month-live-replacement-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_NEXT_LAB_PMLRH1_OBSERVATION_STATE_V1";
const string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaTerminusNext\\lab\\pmlrh1\\research\\research-state-a.csv";
const string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaTerminusNext\\lab\\pmlrh1\\research\\research-state-b.csv";
const string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaTerminusNext\\lab\\pmlrh1\\research\\research-candidates.csv";
const string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaTerminusNext\\lab\\pmlrh1\\research\\research-lifecycles.csv";
...
const ulong MAGIC_RC16_LONG = 260829941;
const ulong MAGIC_RC4_BOTH = 260829942;
const ulong MAGIC_US100_CROSS = 260829943;
const ulong MAGIC_US30_PRESSURE = 260829944;
const ulong MAGIC_US30_RETURN = 260829945;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260829946;
