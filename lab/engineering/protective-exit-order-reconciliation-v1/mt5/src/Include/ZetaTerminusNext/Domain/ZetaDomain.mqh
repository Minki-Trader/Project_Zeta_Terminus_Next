...
const string EXECUTION_VERSION =
   "zt-next-lab-protective-exit-order-reconciliation-v1";
...
const string RELEASE_ID =
   "NEXT-LAB-PROTECTIVE-EXIT-ORDER-RECONCILIATION-V1";
const string PORTFOLIO_ID = "ZT-PORT-NEXT-LAB-PER-V1";
...
const string STATE_MARKER =
   "ZT_NEXT_LAB_PROTECTIVE_EXIT_ORDER_RECONCILIATION_V1";
const string STATE_PATH_A =
   "ZetaTerminusNext\\lab\\per1\\per1-state-a.csv";
const string STATE_PATH_B =
   "ZetaTerminusNext\\lab\\per1\\per1-state-b.csv";
const string EVENT_PATH_A =
   "ZetaTerminusNext\\lab\\per1\\per1-events-a.csv";
const string EVENT_PATH_B =
   "ZetaTerminusNext\\lab\\per1\\per1-events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaTerminusNext\\lab\\per1\\per1-current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaTerminusNext\\lab\\per1\\per1-current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaTerminusNext\\lab\\per1\\per1.lock";
...
const ulong MAGIC_RC16_LONG = 260825200;
const ulong MAGIC_RC4_BOTH = 260825201;
const ulong MAGIC_US100_CROSS = 260825202;
const ulong MAGIC_US30_PRESSURE = 260825203;
const ulong MAGIC_US30_RETURN = 260825204;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260825205;
