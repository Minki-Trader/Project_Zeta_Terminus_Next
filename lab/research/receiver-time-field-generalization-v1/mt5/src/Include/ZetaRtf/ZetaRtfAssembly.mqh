#ifndef ZETA_RTF_ASSEMBLY_MQH
#define ZETA_RTF_ASSEMBLY_MQH
...
#include <ZetaRtf\ZetaRtfTimeField.mqh>
...
// Shared assembly for the three predeclared Tester-only RTF paths.
...
int OnInit()
  {
   ...
   FolderCreate("ZetaRtf");
   FolderCreate(RTF_FOLDER);
   if(tester_mode)
