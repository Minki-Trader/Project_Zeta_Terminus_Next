...
#ifndef RTF_PATH_KIND
   #error RTF_PATH_KIND must be defined by the receiver-time-field entrypoint
#endif
#ifndef RTF_PATH_LABEL
   #error RTF_PATH_LABEL must be defined by the receiver-time-field entrypoint
#endif
#ifndef RTF_EXECUTION_VERSION
   #error RTF_EXECUTION_VERSION must be defined by the receiver-time-field entrypoint
#endif
#ifndef RTF_RELEASE_ID
   #error RTF_RELEASE_ID must be defined by the receiver-time-field entrypoint
#endif
#ifndef RTF_PORTFOLIO_ID
   #error RTF_PORTFOLIO_ID must be defined by the receiver-time-field entrypoint
#endif
#ifndef RTF_ECONOMIC_FINGERPRINT
   #error RTF_ECONOMIC_FINGERPRINT must be defined by the receiver-time-field entrypoint
#endif
#ifndef RTF_EXECUTION_FINGERPRINT
   #error RTF_EXECUTION_FINGERPRINT must be defined by the receiver-time-field entrypoint
#endif
#ifndef RTF_STATE_MARKER
   #error RTF_STATE_MARKER must be defined by the receiver-time-field entrypoint
#endif
#ifndef RTF_STATE_PATH_A
   #error RTF_STATE_PATH_A must be defined by the receiver-time-field entrypoint
#endif
#ifndef RTF_STATE_PATH_B
   #error RTF_STATE_PATH_B must be defined by the receiver-time-field entrypoint
#endif
#ifndef RTF_EVENT_PATH_A
   #error RTF_EVENT_PATH_A must be defined by the receiver-time-field entrypoint
#endif
#ifndef RTF_EVENT_PATH_B
   #error RTF_EVENT_PATH_B must be defined by the receiver-time-field entrypoint
#endif
#ifndef RTF_CURRENT_SNAPSHOT_PATH_A
   #error RTF_CURRENT_SNAPSHOT_PATH_A must be defined by the receiver-time-field entrypoint
#endif
#ifndef RTF_CURRENT_SNAPSHOT_PATH_B
   #error RTF_CURRENT_SNAPSHOT_PATH_B must be defined by the receiver-time-field entrypoint
#endif
#ifndef RTF_OWNERSHIP_PATH
   #error RTF_OWNERSHIP_PATH must be defined by the receiver-time-field entrypoint
#endif
#ifndef RTF_MAGIC_BASE
   #error RTF_MAGIC_BASE must be defined by the receiver-time-field entrypoint
#endif
#ifndef RTF_FOLDER
   #error RTF_FOLDER must be defined by the receiver-time-field entrypoint
#endif

// One-time frozen CP2 copy with only the declared Tester-only receiver-time field seam.
...
const string EXECUTION_VERSION = RTF_EXECUTION_VERSION;
const string ECONOMIC_VERSION =
   "zt-next-pre500-finite-risk-portfolio-v7-modular-parent-b70-v6r6";
const string PROJECT_ID = "project-zeta-terminus-next-lab-rtf";
const string SCHEMA_VERSION = "RTF1";
const string RELEASE_ID = RTF_RELEASE_ID;
const string PORTFOLIO_ID = RTF_PORTFOLIO_ID;
const string ECONOMIC_FINGERPRINT = RTF_ECONOMIC_FINGERPRINT;
const string EXECUTION_FINGERPRINT = RTF_EXECUTION_FINGERPRINT;
const string STATE_MARKER = RTF_STATE_MARKER;
const string STATE_PATH_A = RTF_STATE_PATH_A;
const string STATE_PATH_B = RTF_STATE_PATH_B;
const string EVENT_PATH_A = RTF_EVENT_PATH_A;
const string EVENT_PATH_B = RTF_EVENT_PATH_B;
const string CURRENT_SNAPSHOT_PATH_A = RTF_CURRENT_SNAPSHOT_PATH_A;
const string CURRENT_SNAPSHOT_PATH_B = RTF_CURRENT_SNAPSHOT_PATH_B;
const string OWNERSHIP_PATH = RTF_OWNERSHIP_PATH;
...
const ulong MAGIC_RC16_LONG = RTF_MAGIC_BASE;
const ulong MAGIC_RC4_BOTH = RTF_MAGIC_BASE + 1;
const ulong MAGIC_US100_CROSS = RTF_MAGIC_BASE + 2;
const ulong MAGIC_US30_PRESSURE = RTF_MAGIC_BASE + 3;
const ulong MAGIC_US30_RETURN = RTF_MAGIC_BASE + 4;
const ulong MAGIC_US100_PASSIVE_LIMIT = RTF_MAGIC_BASE + 5;
