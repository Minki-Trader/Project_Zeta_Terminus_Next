...
RUNTIME_ROOT = ROOT / "lab" / "runtime" / "rva120-portable"
TERMINAL = RUNTIME_ROOT / "terminal64.exe"
OUTPUT_ROOT = ROOT / "lab" / "artifacts" / "raw" / FAMILY / "input"
BAR_PATH = OUTPUT_ROOT / "US100_M15_BARS_20231201_20260731.csv"
SPEC_PATH = OUTPUT_ROOT / "US100_SYMBOL_SPEC_V1.json"

SYMBOL = "US100"
START_UTC = datetime(2023, 12, 1, 0, 0, 0, tzinfo=timezone.utc)
...
def write_spec(info: object) -> None:
    payload = {
        "schema": "zeta-next-us100-realized-variance-asymmetry-response-environment-correction-symbol-spec-v1",
        "symbol": SYMBOL,
