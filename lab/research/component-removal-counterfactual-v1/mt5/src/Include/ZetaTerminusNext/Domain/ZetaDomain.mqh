...
const string STATE_MARKER =
   "ZT_NEXT_LAB_COMPONENT_REMOVAL_COUNTERFACTUAL_V1";
const string STATE_PATH_A =
   "ZetaTerminusNext\\lab\\crc81\\crc81-state-a.csv";
const string STATE_PATH_B =
   "ZetaTerminusNext\\lab\\crc81\\crc81-state-b.csv";
const string EVENT_PATH_A =
   "ZetaTerminusNext\\lab\\crc81\\crc81-events-a.csv";
const string EVENT_PATH_B =
   "ZetaTerminusNext\\lab\\crc81\\crc81-events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaTerminusNext\\lab\\crc81\\crc81-current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaTerminusNext\\lab\\crc81\\crc81-current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaTerminusNext\\lab\\crc81\\crc81.lock";
...
const ulong MAGIC_RC16_LONG = 260827100;
const ulong MAGIC_RC4_BOTH = 260827101;
const ulong MAGIC_US100_CROSS = 260827102;
const ulong MAGIC_US30_PRESSURE = 260827103;
const ulong MAGIC_US30_RETURN = 260827104;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260827105;
