...
#property description "Trade-free US100 completed-M15 realized-variance asymmetry observer for Zeta Next Lab Unit 032."

input int InpRunCode = 1;

const string OBSERVER_ID = "ZETA-NEXT-US100-REALIZED-VARIANCE-ASYMMETRY-RESPONSE-V1";
...
{
   FolderCreate("US100RealizedVarianceAsymmetryResponseV1");
   g_output_directory =
      StringFormat("US100RealizedVarianceAsymmetryResponseV1\\run-%d", InpRunCode);
