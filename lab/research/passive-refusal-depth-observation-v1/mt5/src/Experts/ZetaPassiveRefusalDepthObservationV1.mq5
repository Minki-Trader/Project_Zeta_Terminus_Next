...
#property description "Project Zeta Terminus Next Passive refusal depth observation V1"
#property description "Execution version: zt-next-lab-rfd-v1-observation"
...
#include <ZetaRfd\ZetaPassiveRefusalDepthObservation.mqh>
...
bool InitializeConnectedRuntime()
  {
   ...
   PrintFormat("%s initialized portfolio=%s recovered=%s "
               ...
               state_sequence);
   RfdPrintRequiredContracts("START");
   return(true);
  }
...
int OnInit()
  {
   ...
   FolderCreate("ZetaRfd");
   FolderCreate("ZetaRfd\\observation");
   if(tester_mode)
...
void OnDeinit(const int reason)
  {
   ...
   RfdPrintRequiredContracts("END");
   RfdPrintFinalTelemetry();
   ReleaseRuntimeOwnership();
  }
