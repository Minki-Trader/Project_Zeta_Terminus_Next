...
const string EXECUTION_VERSION = "zt-next-lab-rfd-v1-observation";
...
const string RELEASE_ID = "NEXT-LAB-RFD-V1-OBSERVATION";
const string PORTFOLIO_ID = "ZT-LAB-RFD-V1-OBSERVATION";
...
const string EXECUTION_FINGERPRINT =
   "next-cp2-rfd-v1-inert-causal-nonfill-geometry-observer";
const string STATE_MARKER = "ZT_NEXT_LAB_RFD_V1_OBSERVATION_STATE_V7";
const string STATE_PATH_A =
   "ZetaRfd\\observation\\state-a.csv";
const string STATE_PATH_B =
   "ZetaRfd\\observation\\state-b.csv";
const string EVENT_PATH_A =
   "ZetaRfd\\observation\\events-a.csv";
const string EVENT_PATH_B =
   "ZetaRfd\\observation\\events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaRfd\\observation\\current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaRfd\\observation\\current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaRfd\\observation\\ownership.lock";
...
const ulong MAGIC_RC16_LONG = 260825500;
const ulong MAGIC_RC4_BOTH = 260825501;
const ulong MAGIC_US100_CROSS = 260825502;
const ulong MAGIC_US30_PRESSURE = 260825503;
const ulong MAGIC_US30_RETURN = 260825504;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260825505;
