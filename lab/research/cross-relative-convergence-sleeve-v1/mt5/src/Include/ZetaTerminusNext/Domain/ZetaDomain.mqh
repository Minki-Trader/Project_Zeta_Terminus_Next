...
// Unit 093 owns one self-contained CONTROL versus DUAL_APPEND research identity.

enum ECrossRelativeConvergenceProfile
  {
   CRCS93_CONTROL = 0,
   CRCS93_DUAL_APPEND = 1
  };
...
const int US30_CONVERGENCE = 6;
const int US500_CONVERGENCE = 7;
...
const ulong MAGIC_RC16_LONG = 260827300;
const ulong MAGIC_RC4_BOTH = 260827301;
const ulong MAGIC_US100_CROSS = 260827302;
const ulong MAGIC_US30_PRESSURE = 260827303;
const ulong MAGIC_US30_RETURN = 260827304;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260827305;
const ulong MAGIC_US30_CONVERGENCE = 260827306;
const ulong MAGIC_US500_CONVERGENCE = 260827307;
...
void InitializeComponentDefinitions()
  {
   ...
   component_definitions[US30_CONVERGENCE].id =
      "ZT-H1-US30-CROSS-CONV-c58a4fe5e6";
   component_definitions[US30_CONVERGENCE].symbol = "US30";
   component_definitions[US30_CONVERGENCE].timeframe = PERIOD_H1;
   component_definitions[US30_CONVERGENCE].hold_bars = 2;
   component_definitions[US30_CONVERGENCE].magic = MAGIC_US30_CONVERGENCE;

   component_definitions[US500_CONVERGENCE].id =
      "ZT-H1-US500-CROSS-CONV-63b2eb323d";
   component_definitions[US500_CONVERGENCE].symbol = "US500";
   component_definitions[US500_CONVERGENCE].timeframe = PERIOD_H1;
   component_definitions[US500_CONVERGENCE].hold_bars = 2;
   component_definitions[US500_CONVERGENCE].magic = MAGIC_US500_CONVERGENCE;
  }
...
int event_segment_handle = INVALID_HANDLE;
int event_segment_handle_index = -1;
