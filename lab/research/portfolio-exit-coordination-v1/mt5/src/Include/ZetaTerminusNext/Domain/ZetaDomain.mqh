...
#ifndef PEC_POLICY_KIND
   #error PEC_POLICY_KIND must be defined by the portfolio-exit-coordination entrypoint
#endif
#ifndef PEC_POLICY_LABEL
   #error PEC_POLICY_LABEL must be defined by the portfolio-exit-coordination entrypoint
#endif
#ifndef PEC_EXECUTION_VERSION
   #error PEC_EXECUTION_VERSION must be defined by the portfolio-exit-coordination entrypoint
#endif
#ifndef PEC_RELEASE_ID
   #error PEC_RELEASE_ID must be defined by the portfolio-exit-coordination entrypoint
#endif
#ifndef PEC_PORTFOLIO_ID
   #error PEC_PORTFOLIO_ID must be defined by the portfolio-exit-coordination entrypoint
#endif
#ifndef PEC_ECONOMIC_FINGERPRINT
   #error PEC_ECONOMIC_FINGERPRINT must be defined by the portfolio-exit-coordination entrypoint
#endif
#ifndef PEC_EXECUTION_FINGERPRINT
   #error PEC_EXECUTION_FINGERPRINT must be defined by the portfolio-exit-coordination entrypoint
#endif
#ifndef PEC_STATE_MARKER
   #error PEC_STATE_MARKER must be defined by the portfolio-exit-coordination entrypoint
#endif
#ifndef PEC_STATE_PATH_A
   #error PEC_STATE_PATH_A must be defined by the portfolio-exit-coordination entrypoint
#endif
#ifndef PEC_STATE_PATH_B
   #error PEC_STATE_PATH_B must be defined by the portfolio-exit-coordination entrypoint
#endif
#ifndef PEC_EVENT_PATH_A
   #error PEC_EVENT_PATH_A must be defined by the portfolio-exit-coordination entrypoint
#endif
#ifndef PEC_EVENT_PATH_B
   #error PEC_EVENT_PATH_B must be defined by the portfolio-exit-coordination entrypoint
#endif
#ifndef PEC_CURRENT_SNAPSHOT_PATH_A
   #error PEC_CURRENT_SNAPSHOT_PATH_A must be defined by the portfolio-exit-coordination entrypoint
#endif
#ifndef PEC_CURRENT_SNAPSHOT_PATH_B
   #error PEC_CURRENT_SNAPSHOT_PATH_B must be defined by the portfolio-exit-coordination entrypoint
#endif
#ifndef PEC_OWNERSHIP_PATH
   #error PEC_OWNERSHIP_PATH must be defined by the portfolio-exit-coordination entrypoint
#endif
#ifndef PEC_MAGIC_BASE
   #error PEC_MAGIC_BASE must be defined by the portfolio-exit-coordination entrypoint
#endif

// One-time frozen CP2 copy with only the declared Tester-only exit policy seam.
...
const string EXECUTION_VERSION = PEC_EXECUTION_VERSION;
const string ECONOMIC_VERSION =
   "zt-next-pre500-finite-risk-portfolio-v7-modular-parent-b70-v6r6";
const string PROJECT_ID = "project-zeta-terminus-next-lab-pec";
const string SCHEMA_VERSION = "PEC1";
const string RELEASE_ID = PEC_RELEASE_ID;
const string PORTFOLIO_ID = PEC_PORTFOLIO_ID;
const string ECONOMIC_FINGERPRINT = PEC_ECONOMIC_FINGERPRINT;
const string EXECUTION_FINGERPRINT = PEC_EXECUTION_FINGERPRINT;
const string STATE_MARKER = PEC_STATE_MARKER;
const string STATE_PATH_A = PEC_STATE_PATH_A;
const string STATE_PATH_B = PEC_STATE_PATH_B;
const string EVENT_PATH_A = PEC_EVENT_PATH_A;
const string EVENT_PATH_B = PEC_EVENT_PATH_B;
const string CURRENT_SNAPSHOT_PATH_A = PEC_CURRENT_SNAPSHOT_PATH_A;
const string CURRENT_SNAPSHOT_PATH_B = PEC_CURRENT_SNAPSHOT_PATH_B;
const string OWNERSHIP_PATH = PEC_OWNERSHIP_PATH;
...
const ulong MAGIC_RC16_LONG = PEC_MAGIC_BASE + 0;
const ulong MAGIC_RC4_BOTH = PEC_MAGIC_BASE + 1;
const ulong MAGIC_US100_CROSS = PEC_MAGIC_BASE + 2;
const ulong MAGIC_US30_PRESSURE = PEC_MAGIC_BASE + 3;
const ulong MAGIC_US30_RETURN = PEC_MAGIC_BASE + 4;
const ulong MAGIC_US100_PASSIVE_LIMIT = PEC_MAGIC_BASE + 5;
