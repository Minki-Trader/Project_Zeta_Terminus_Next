#ifndef ZETA_SIRA_POLICY_DOMAIN_MQH
#define ZETA_SIRA_POLICY_DOMAIN_MQH

// Lab-only Strategy Independence and Risk Allocation declarations.
// Frozen V7 economics remain unchanged; wrappers provide isolated identity.
...
const int SIRA_SELECTED_COMPONENT = SIRA_SELECTED_COMPONENT_VALUE;
const int SIRA_POLICY_MODE = SIRA_POLICY_MODE_VALUE;
const string EXECUTION_VERSION = SIRA_EXECUTION_VERSION;
...
const string RELEASE_ID = SIRA_RELEASE_ID;
const string PORTFOLIO_ID = SIRA_PORTFOLIO_ID;
...
const string STATE_MARKER = SIRA_STATE_MARKER;
const string STATE_PATH_A = SIRA_STATE_PATH_A;
const string STATE_PATH_B = SIRA_STATE_PATH_B;
const string EVENT_PATH_A = SIRA_EVENT_PATH_A;
const string EVENT_PATH_B = SIRA_EVENT_PATH_B;
const string CURRENT_SNAPSHOT_PATH_A = SIRA_CURRENT_SNAPSHOT_PATH_A;
const string CURRENT_SNAPSHOT_PATH_B = SIRA_CURRENT_SNAPSHOT_PATH_B;
const string OWNERSHIP_PATH = SIRA_OWNERSHIP_PATH;
...
const ulong MAGIC_RC16_LONG = SIRA_MAGIC_BASE + 1;
const ulong MAGIC_RC4_BOTH = SIRA_MAGIC_BASE + 2;
const ulong MAGIC_US100_CROSS = SIRA_MAGIC_BASE + 3;
const ulong MAGIC_US30_PRESSURE = SIRA_MAGIC_BASE + 4;
const ulong MAGIC_US30_RETURN = SIRA_MAGIC_BASE + 5;
const ulong MAGIC_US100_PASSIVE_LIMIT = SIRA_MAGIC_BASE + 6;
...
long sira_opportunity_records = 0;
long sira_current_opportunity_id = 0;
int sira_pre_active_mask = 0;
double sira_pre_aggregate_planned_risk = 0.0;
double sira_pre_equity = 0.0;
double sira_pre_margin = 0.0;
double sira_pre_risk_capital = 0.0;
bool sira_pre_rc4_shadow_occupied = false;
long sira_policy_reservation_skips = 0;
