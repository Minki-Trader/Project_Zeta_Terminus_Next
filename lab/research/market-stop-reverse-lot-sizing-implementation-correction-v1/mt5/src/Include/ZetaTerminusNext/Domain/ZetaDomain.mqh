...
input int    InpMarketStopProfile     = 0;
input datetime InpMarketStopActivation = D'2026.04.01 00:00:00';
input int    InpMarketStopAtrPeriod   = 14;
input double InpMarketStopMultiplierRC16 = 0.0;
input double InpMarketStopMultiplierRC4 = 0.0;
input double InpMarketStopMultiplierCross = 0.0;
input double InpMarketStopMultiplierPressure = 0.0;
input double InpMarketStopMultiplierReturn = 0.0;

const string EXECUTION_VERSION =
   "zt-next-lab-market-stop-reverse-lot-sizing-ic1";
...
const string STATE_MARKER =
   "ZT_NEXT_LAB_MARKET_STOP_REVERSE_LOT_SIZING_IC1";
const string STATE_PATH_A =
   "ZetaTerminusNext\\research\\msrl62ic1\\msrl62ic1-state-a.csv";
const string STATE_PATH_B =
   "ZetaTerminusNext\\research\\msrl62ic1\\msrl62ic1-state-b.csv";
const string EVENT_PATH_A =
   "ZetaTerminusNext\\research\\msrl62ic1\\msrl62ic1-events-a.csv";
const string EVENT_PATH_B =
   "ZetaTerminusNext\\research\\msrl62ic1\\msrl62ic1-events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaTerminusNext\\research\\msrl62ic1\\msrl62ic1-current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaTerminusNext\\research\\msrl62ic1\\msrl62ic1-current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaTerminusNext\\research\\msrl62ic1\\msrl62ic1.lock";
...
const ulong MAGIC_RC16_LONG = 260828621;
const ulong MAGIC_RC4_BOTH = 260828622;
const ulong MAGIC_US100_CROSS = 260828623;
const ulong MAGIC_US30_PRESSURE = 260828624;
const ulong MAGIC_US30_RETURN = 260828625;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260828626;
...
int event_segment = 0;
int event_file_handle = INVALID_HANDLE;
int event_file_segment = -1;
...
long market_stop_native_atr_observations = 0;
long market_stop_atr_unavailable = 0;
long market_stop_sizing_attempts = 0;
long market_stop_distance_blocks = 0;
long market_stop_min_lot_blocks = 0;
long market_stop_accepted = 0;
long market_stop_non_native_volume = 0;
