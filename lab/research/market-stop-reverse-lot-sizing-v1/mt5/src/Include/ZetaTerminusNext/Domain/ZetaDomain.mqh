...
const string EXECUTION_VERSION =
   "zt-next-lab-market-stop-reverse-lot-sizing-v1";
...
const string RELEASE_ID =
   "NEXT-LAB-MARKET-STOP-REVERSE-LOT-SIZING-V1";
const string PORTFOLIO_ID = "ZT-PORT-NEXT-LAB-MSRL62-V1";
...
const string STATE_MARKER =
   "ZT_NEXT_LAB_MARKET_STOP_REVERSE_LOT_SIZING_V1";
const string STATE_PATH_A =
   "ZetaTerminusNext\\lab\\msrl62\\msrl62-state-a.csv";
const string STATE_PATH_B =
   "ZetaTerminusNext\\lab\\msrl62\\msrl62-state-b.csv";
const string EVENT_PATH_A =
   "ZetaTerminusNext\\lab\\msrl62\\msrl62-events-a.csv";
const string EVENT_PATH_B =
   "ZetaTerminusNext\\lab\\msrl62\\msrl62-events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaTerminusNext\\lab\\msrl62\\msrl62-current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaTerminusNext\\lab\\msrl62\\msrl62-current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaTerminusNext\\lab\\msrl62\\msrl62.lock";
...
const ulong MAGIC_RC16_LONG = 260826620;
const ulong MAGIC_RC4_BOTH = 260826621;
const ulong MAGIC_US100_CROSS = 260826622;
const ulong MAGIC_US30_PRESSURE = 260826623;
const ulong MAGIC_US30_RETURN = 260826624;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260826625;
