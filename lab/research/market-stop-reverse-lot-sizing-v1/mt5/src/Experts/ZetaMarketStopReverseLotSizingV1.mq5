...
#property description "Project Zeta Terminus Next Lab market-stop reverse-lot sizing"
#property description "Execution version: zt-next-lab-market-stop-reverse-lot-sizing-v1"
...
int OnInit()
  {
   ...
   FolderCreate("ZetaTerminusNext\\lab\\msrl62");
   if(tester_mode)
