...
const string STATE_MARKER =
   "ZT_NEXT_LAB_NATIVE_HOLD_SCHEDULE_CURVE_V1";
const string STATE_PATH_A =
   "ZetaTerminusNext\\lab\\hsc60\\hsc60-state-a.csv";
const string STATE_PATH_B =
   "ZetaTerminusNext\\lab\\hsc60\\hsc60-state-b.csv";
const string EVENT_PATH_A =
   "ZetaTerminusNext\\lab\\hsc60\\hsc60-events-a.csv";
const string EVENT_PATH_B =
   "ZetaTerminusNext\\lab\\hsc60\\hsc60-events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaTerminusNext\\lab\\hsc60\\hsc60-current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaTerminusNext\\lab\\hsc60\\hsc60-current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaTerminusNext\\lab\\hsc60\\hsc60.lock";
...
const ulong MAGIC_RC16_LONG = 260826600;
const ulong MAGIC_RC4_BOTH = 260826601;
const ulong MAGIC_US100_CROSS = 260826602;
const ulong MAGIC_US30_PRESSURE = 260826603;
const ulong MAGIC_US30_RETURN = 260826604;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260826605;
...
void InitializeComponentDefinitions()
  {
   ...
   else if(InpHoldScheduleProfile == 2)
     {
      rc16_hold = 10;
      rc4_hold = 15;
      cross_hold = 5;
   ...
   component_definitions[RC16_LONG].hold_bars = rc16_hold;
   ...
   component_definitions[RC4_BOTH].hold_bars = rc4_hold;
   ...
   component_definitions[US100_CROSS].hold_bars = cross_hold;
   ...
   component_definitions[US30_PRESSURE].hold_bars = pressure_hold;
   ...
   component_definitions[US30_RETURN_REV_LONG].hold_bars = return_hold;
   ...
   component_definitions[US100_PASSIVE_LIMIT].hold_bars = passive_hold;
