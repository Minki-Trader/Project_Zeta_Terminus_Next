...
void ResetRuntimeState()
  {
   ...
   one_hour_adverse_exit_evaluations = 0;
   one_hour_adverse_exit_triggers = 0;
   one_hour_adverse_exit_successes = 0;
   one_hour_adverse_exit_close_failures = 0;
   one_hour_adverse_exit_data_faults = 0;
   ArrayInitialize(one_hour_adverse_exit_component_triggers, 0);
  }
