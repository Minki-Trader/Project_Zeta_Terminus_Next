...
input int    InpOneHourAdverseExitKind = 0;

const string EXECUTION_VERSION =
   "zt-next-lab-one-hour-adverse-exit-management-v1";
...
const ulong MAGIC_RC16_LONG = 260826400;
const ulong MAGIC_RC4_BOTH = 260826401;
const ulong MAGIC_US100_CROSS = 260826402;
const ulong MAGIC_US30_PRESSURE = 260826403;
const ulong MAGIC_US30_RETURN = 260826404;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260826405;
...
long one_hour_adverse_exit_evaluations = 0;
long one_hour_adverse_exit_triggers = 0;
long one_hour_adverse_exit_successes = 0;
long one_hour_adverse_exit_close_failures = 0;
long one_hour_adverse_exit_data_faults = 0;
long one_hour_adverse_exit_component_triggers[COMPONENT_COUNT];
