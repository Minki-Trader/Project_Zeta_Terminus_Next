...
- `research/intraday-sizing-risk-clock-ratchet-v1/`: 활성 Program 3 / meso Unit 067 source-free family; durable pre-order snapshot에서 일 1회 lot 시계와 매 admission 위험자본 시계의 동일-day 괴리, 부동손익 상태 및 stop/stressed-R 전달을 CP2 전수와 완결된 binding journal tail에서 한 번 판정
