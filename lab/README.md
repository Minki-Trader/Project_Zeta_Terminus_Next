...
- `research/predecision-market-participation-state-v1/`: 열린 Program 2 / meso Unit 084 family; 첫 판단 전 US30·US100·US500 H1 틱 참여상태를 새 데이터 역할로 고정했고, 격리된 3-symbol acquisition 뒤 CP2 lifecycle 가치·stop 부담을 한 번 판정 예정
