...
- `research/cftc-leveraged-money-relative-flow-v1/`: 활성 Program 2 / meso→macro Unit 089 source-free family; 공식 CFTC 개별 Nasdaq/DJIA futures-only leveraged-money 상대 flow를 보수적 공표일 이후에만 사용해 US100 대 US30 book 경제를 판별하며, 선언은 공식 취득·조건부 outcome 전에 동결됨
