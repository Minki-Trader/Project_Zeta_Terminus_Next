...
- `research/prior-vix-relative-regime-context-implementation-correction-v1/`: 진행 중인 Program 2 / Unit 045 구현교정 sibling; 원 선언·무효 기록과 공식 Cboe 스냅샷을 보존하고 fused period selector만 정확히 교정해 같은 2,233-lifecycle 실험을 한 경계로 완주
