...
현재 active research family는 Program 2 / meso→macro Unit 109 `research/three-index-europe-open-inventory-drift-v1/` 하나다. NY Fed가 외부에서 고정한 02:00..03:00 ET LONG을 US30+US100+US500 각 0.01 lot의 불가분 묶음으로 한 번 판정한다. H1 3개와 계약 receipt는 family-owned raw input으로 물리 복사했고, 시간열만 연 사전 구조는 P1/P2/P3/P4/latest `366/259/257/106/45`일과 하루 3 starts를 확인했다. 가격·spread·gross/observed/stressed 경제값은 선언 시점에 열지 않았다. 이웃 시간·DST 변형·short/reversion·single-symbol·요일/월·가중치·포트폴리오 구제는 금지되며, 완전 유효 경제판정 뒤 즉시 Optimization 전체 맵으로 복귀한다. 최신 marker는 `FRONTIER_UNIT_109_THREE_INDEX_EUROPE_OPEN_INVENTORY_DRIFT_DECLARED_ECONOMICS_UNOPENED`다.
