...
- `research/prior-cash-breadth-book-rotation-implementation-correction-v1/`: 활성 Unit 091 구현교정 sibling; 원 V1 경제계약과 기존 공식 원문·1,044행 CSV를 해시 그대로 상속하고 누락 receipt만 복원해 결과 전 commit/push 대기, MQL·Tester·Live 없음
