...
현재 active research family는 없다. Program 2 / micro→meso Unit 114 `research/us500-preopen-laguardia-sunshine-cash-direction-v1/`은 NOAA LCDv2 LaGuardia 실제현지 05/06/07/08시 평균운량 `<=4 LONG / >4 SHORT`를 `985`개 당일 US500 cash session에 한 번 집계했다. Full gross/observed/doubled-spread는 `+$1.42925/-$2.86960/-$7.16845`; P2/P3 양수에도 P1/P4/latest·prelatest·full이 실패하고 unconditional LONG보다 `$8.59330` 낮아 valid ambiguous no-seed로 닫혔다. GHCNh 최신결손은 경제 미개봉 상태에서 전기간 단일 LCDv2로 교정됐고 연구실패가 아니다. seed·Optimization candidate·MT5·Live 권한은 없으며 연속 Goal은 serial whole-map discovery로 복귀했다. 최신 marker는 `FRONTIER_UNIT_114_CLOSED_VALID_AMBIGUOUS_LAGUARDIA_MORNING_SUNSHINE_US500_CASH_DIRECTION_NO_SEED_MAP_RECOMPARED`다.
