...
- `research/cross-common-beta-decomposition-v1/`: 활성 Program 1 / meso Unit 064 source-free family; 동기화 H1 24,417행·비계정 lot 사양·805/756 수명주기와 1,512개 mark를 결과 전 동결했고, US100 상대성분·US30/US500 공통베타 분산과 현재 lot-step 최소자본의 단일 고정 집계만 남음; stop 경로·회귀 beta·비용·실행·Live는 제외
