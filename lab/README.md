...
- `research/cross-component-same-symbol-signal-state-v1/`: 열린 Program 1 / meso Unit 059 source-free family; 다른 전략의 직전 동일심볼 통과신호 지속·반전이 후보→birth 전달과 component-adjusted lifecycle 가치로 이어지는지 한 번의 고정 집계로 판정하며 CLOSE 경제결과는 선언·push 전 미개봉
