...
- `research/first-peer-profit-memory-checkpoint-v1/`: 열린 Program 4 / micro Unit 057 source-free family; 첫 peer 자연청산 때 대상 포지션이 이익을 유지한 `60`건과 이전 이익을 전부 반납한 `61`건의 엄격 checkpoint가 선언 동결되었고 연결 CLOSE 결과는 아직 미개봉
