...
- `research/rc-compression-horizon-slot-independence-v1/`: 활성 Program 5 / meso→macro Unit 068 source-free family; RC16·RC4의 P4 신호 연관을 다른 고정시각 US30 쌍과 대조하고 CP2 4기간 동시점유·stressed 공동손실까지 전달될 때만 두 위험 slot의 구조적 중복을 인정
