...
- `research/us100-realized-variance-asymmetry-response-v1/`: 활성 Unit 032 fresh observer family; 상세 로그가 깨끗한 2024+ 전용 경계에서 16개 M15 상승·하락 실현분산 비대칭 질문이 구현·결과 전 동결됨
