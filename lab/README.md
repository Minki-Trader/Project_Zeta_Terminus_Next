...
현재 active research family는 없다. Program 2 / meso→macro Unit 110 `research/us500-epu-volatility-disconnect-cash-session-v1/`은 `AMBIGUOUS_EPU_VOLATILITY_DISCONNECT_TRANSFER_NO_SEED`로 닫혔다. `HIGH_D_LOW_V`의 P1-P4 stressed economics는 `+$15.9915`, PF `1.3760`, DD `3.087%`, net/DD `5.1803`으로 강했고 low-disconnect·unconditional controls를 앞섰지만, P1 net/DD는 고정 `1.25` 선에 `1.1603`으로 미달했고 latest June-July는 gross/observed/stressed `-$0.4048/-$0.4923/-$0.5798`로 역전했다. No seed, Optimization candidate or MT5 shortlist survives; fixed candidate와 Live는 unchanged이고 Optimization whole map이 재개됐다. 최신 marker는 `FRONTIER_UNIT_110_CLOSED_AMBIGUOUS_EPU_VOLATILITY_DISCONNECT_TRANSFER_NO_SEED_MAP_RECOMPARED`다.
