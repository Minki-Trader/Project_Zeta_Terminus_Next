...
- `research/standard-options-expiration-week-state-implementation-correction-v1/`: 활성 Unit 090 구현교정 sibling; 원 V1의 경제 선언·원문·schedule·gate를 해시 그대로 상속하고 누락 receipt만 복원해 결과 전 commit/push 대기, MQL·Tester·Live 없음
