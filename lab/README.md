...
현재 active research family는 없다. Program 1 / meso→macro Unit 108 `us-equity-index-cash-close-intraday-momentum-v1`은 987 paired days·1,974 trades의 exact 문헌 continuation을 한 번 판정했다. full gross/observed/stressed `+$53.9629 / +$29.4199 / +$4.8769`였지만 stressed PF `1.0136`, DD `27.0211%`, net/DD `0.1805`, US100 `-$3.72385`, positive months `22/48`; P1·P4·latest가 실패하고 P3 2025에 집중되어 `VALID_NO_CASH_CLOSE_INTRADAY_MOMENTUM_AFTER_COST_NO_SEED`로 닫혔다. seed·MT5·single-symbol/direction·clock/threshold rescue 없음. 최신 marker는 `FRONTIER_UNIT_108_CLOSED_VALID_NO_CASH_CLOSE_INTRADAY_MOMENTUM_AFTER_COST_NO_SEED_MAP_RECOMPARED`; Optimization Goal은 전체 맵으로 복귀했다.
