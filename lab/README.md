...
- `research/natural-book-drawdown-complementarity-v1/`: 열린 Program 5 / Unit 050 source-free family; US30·US100 자연 책이 서로의 네 기간 최대 closed-drawdown 구간을 실제로 상쇄하는지 양방향 한 묶음으로 사전 고정, close economics 미열람
