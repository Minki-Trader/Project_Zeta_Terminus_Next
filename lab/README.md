...
현재 active research family는 Program 1 / meso→macro Unit 108 `us-equity-index-cash-close-intraday-momentum-v1` 하나다. 문헌이 고정한 전일 New York 현물 종가→15:30 ET 방향을 US30·US100에서 15:30→16:00 continuation으로 한 번 판정하며, 두 심볼은 불가분 0.01-lot 묶음이다. outcome-free scan의 P1-P5 starts는 `706 / 484 / 490 / 204 / 90`; final-half-hour 경제는 아직 열지 않았다. 선언 commit/push 뒤 단일 source-free doubled-spread 집계만 허용하며 reversion·clock·threshold·subgroup·single-symbol·US500 rescue는 없다. 최신 marker는 `FRONTIER_UNIT_108_CASH_CLOSE_INTRADAY_MOMENTUM_DECLARED_ECONOMICS_UNOPENED`; Optimization Goal은 이 unit 종료 직후 전체 맵 비교로 복귀한다.
...
- `research/us-equity-index-cash-close-intraday-momentum-v1/`: active source-free Program 1 / meso→macro Unit 108 family; literature-fixed previous-cash-close→15:30 sign의 US30+US100 15:30→16:00 continuation 불가분 묶음, 결과 미열람 선언 동결·단일 doubled-spread 집계 대기
