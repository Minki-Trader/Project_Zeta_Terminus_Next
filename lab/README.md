...
- `research/market-stop-reverse-lot-sizing-implementation-correction-v1/`: 활성 Program 5 / micro→macro Unit 062 구현교정 sibling; 같은 전체 실험의 유효 FIT `1/1`에서 108개 stop/ATR 관측과 다섯 G17 중앙값을 고정하고 exact candidate SET을 생성했다. 구현·집계 교정은 내부 단계이며 selection `0/2`, conditional latest `0/2`, 최종 경제판정은 미개봉
