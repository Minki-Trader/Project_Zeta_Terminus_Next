...
현재 active research family는 없다. Program 1 / macro→meso Unit 112 `research/us500-earnings-extrapolation-monthly-signal-v1/`은 exact Guo (2025) RFS 신호의 FPMarkets US500 정규 cash-session 이전을 한 번 완전 집계해 valid ambiguous temporal-instability/no-seed로 닫았다. P1 stressed는 `+$10.0534`로 넓게 양수였지만 2023H2가 `-$0.64145`, 이후 P2/P3/P4/latest가 모두 음수였고 full gross/observed/stressed는 `+$4.16985 / -$0.24600 / -$4.66185`였다. 역사적 효과는 uniform null이 아니나 실행 가능한 지속성이 없으며 인접 공식·방향·시각·carrier·비용·사이징 구조는 함께 닫혔다. Optimization whole-map 탐색이 즉시 재개됐고 seed, candidate, MT5 shortlist, Live authority는 없다. 최신 marker는 `FRONTIER_UNIT_112_CLOSED_AMBIGUOUS_RFS_NEWSY_MONTH_US500_CASH_SESSION_DIRECTION_NO_SEED_MAP_RECOMPARED`다.
