...
- `research/sloos-ci-credit-supply-impulse-book-state-v1/`: 열린 Program 2 / meso→macro Unit 095 단일 실험 family; 공식 39개 SLOOS 원문·19행 impulse와 outcome-free 밀도(`1,034`일/`2,188` births, 최소 period-book-state `22`, component-state `48`)를 유효 동결했다. Table 1 Question 1A 대·중견기업 C&I만으로 US30의 US100 대비 stressed-R/stop 악화를 한 번 판정하며 level·수요·terms·소기업·subgroup·lag/window·risk 구제는 선언에서 함께 닫힘
