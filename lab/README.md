...
현재 active research family는 Program 2 / macro→meso Unit 115 `research/us30-house-recess-cash-long-v1/`이다. House Clerk 공식 `790`개 입법일의 직전 공지로 각 NYSE 날짜를 인과적으로 `HOUSE_RECESS/HOUSE_OPEN`으로 고정하고, exact-boundary `1,017`일 중 recess `337`일에만 0.01 US30을 09:30 ET부터 15:59까지 LONG한다. 공지 연결·직접 membership 오류는 0, lead는 1–5일이며 P1/P2/P3/P4/latest 표본은 `374/250/248/102/43`이다. premetric은 M1 `time`만 읽었고 target 가격·spread·수익·PF·DD·control·verdict는 미개봉이다. 선언을 `origin/main`에 올린 뒤 완전한 경제 집계를 정확히 한 번만 수행하며, 환경·설계·공학 오류는 연구실패가 아닌 무제한 교정 상태다. seed·Optimization·MT5·Live 권한은 아직 없고 최신 marker는 `FRONTIER_UNIT_115_HOUSE_RECESS_US30_CASH_LONG_DECLARED_ECONOMICS_UNOPENED`다.
