...
- `research/sloos-ci-credit-supply-impulse-book-state-v1/`: 열린 Program 2 / meso→macro Unit 095 단일 실험 family; 공식 SLOOS Table 1 Question 1A domestic All Respondents의 대·중견기업 C&I 순긴축 변화만 고정하고, 발표 당일 제외·다음 server date 활성화 뒤 US30의 US100 대비 stressed-R/stop 악화를 한 번 판정한다. level·수요·terms·소기업·subgroup·lag/window·risk 구제는 선언에서 함께 닫힘
