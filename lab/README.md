...
현재 active research family는 없다. Program 2 / macro→meso Unit 113 `research/us500-blockbuster-release-next-week-mood-v1/`은 exact Hong·Wei 다음 주 규칙의 full gross/observed/doubled-spread가 `-$0.30950/-$1.57520/-$2.84090`, P1/P2/P3가 모두 음수여서 valid economic strong null로 닫혔다. `+$10.15240`인 same-week count는 미리 고정한 비승격 timing control이라 후보로 전환하지 않고 같은 bundle에서 종료했다. seed·Optimization candidate·MT5·Live 권한은 없고 고정 후보는 그대로다. 연속 Goal은 serial Optimization whole-map discovery로 복귀했다. 최신 marker는 `FRONTIER_UNIT_113_CLOSED_VALID_NO_BLOCKBUSTER_RELEASE_NEXT_WEEK_US500_CASH_EFFECT_AFTER_COST_NO_SEED_MAP_RECOMPARED`다.
