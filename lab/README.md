...
- `research/round-number-crossing-response-v1/`: 열린 Program 1 / micro→meso Unit 094 단일 실험 family; 실제 라운드넘버 격자와 동일 경로의 반 칸 placebo 격자를 US30/US100/US500에서 비교한다. P1 2024가 continuation/reversion 중 최대 한 방향만 선택할 수 있고, 선택된 동일 계약만 P2 2025·P3 2026 Jan-May·P4 Jun-Jul latest로 확인한다. 최대 12개 직렬 실틱 observer 경로이며 주문·포지션·Live 변경은 없다
