...
- `research/round-number-crossing-response-v1/`: 열린 Program 1 / micro→meso Unit 094 단일 실험 family; 무거래 observer 1개와 12개 고정 경로는 build 6140 `0/0`이다. 첫 P1 US30은 symbols/HCS 동기화 drift로 경제 미열람 폐기됐고, 현재 환경 V2에서 전체 P1을 US30부터 재시작한다. 구현·환경 교정은 별도 실험 경계가 아니다
