...
현재 active research family는 없다. Unit 102 `three-index-h1-body-engulfing-response-v1`은 outcome-free 밀도 `5.12..5.78` signals/day를 통과했지만 P1 `2,023`건에서 continuation/reversion doubled-spread가 `-$87.65035 / -$12.57265`, PF `0.82455 / 0.97276`으로 두 방향 모두 7개 discovery 관문을 전부 실패했다. P2-P5 경제는 미개봉이고 retained seed·MT5 shortlist·인접 candlestick 구제·Lab MQL·Live 권한은 없다. 최신 scheduler marker는 `FRONTIER_UNIT_102_CLOSED_VALID_BODY_ENGULFING_NO_P1_DIRECTION_NO_SEED`; Optimization Goal은 전체 맵 재비교로 복귀한다.
