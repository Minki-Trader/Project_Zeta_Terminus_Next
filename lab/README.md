...
- `research/performance-endogenous-risk-geometry-v1/`: 활성 Program 4 / micro→macro Unit 069 source-free family; 결과 전 H1 토폴로지를 24,417개 동기화 시각·3개 지수 가격열로 정정·동결했고, CP2 전수의 `planned_risk/0.04` 자본, 초기 stop 거리, prior-24 H1 open 변동성, stressed cost/R과 stop hazard를 남은 단 한 번의 전역 자본꼬리 및 시간블록 내 국소 대조로 판정
