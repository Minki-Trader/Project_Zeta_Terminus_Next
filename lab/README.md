...
- `research/us100-realized-variance-asymmetry-response-v1/`: 활성 Unit 032 fresh observer family; Tester agent 경로길이 사전실패 뒤 동일 물리 runtime을 `runtime/rva32-portable/`로 단축, 경제결과는 여전히 미개방
