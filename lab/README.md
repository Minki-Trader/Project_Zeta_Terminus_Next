...
- `research/scheduled-us-macro-event-exposure-v1/`: 활성 Program 2 / Unit 041 source-free family; 공식 FOMC·CPI·고용 128회와 `보유 중 발표 노출 / 발표 후 120분 신규진입` 두 역할을 선언 동결, 이벤트 조건부 결과는 미개봉
