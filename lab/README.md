...
현재 active research family는 Program 1 / macro→meso Unit 112 `research/us500-earnings-extrapolation-monthly-signal-v1/`이다. Guo (2025) RFS의 January/April/July/October earnings-newsy-month 신호를 저자 CC0 replication data/code에서 그대로 동결하고, June 2021 이후만 전용 Lab US500 D1 1회 취득으로 인과적으로 연결했다. 목표월은 July 2022–July 2026 `49`개월, 방향은 `24 LONG / 25 SHORT / 0 FLAT`, 정규 cash-session 밀도는 P1-P5 `374/250/248/102/43`일이다. 0.01 lot으로 09:30→16:00 ET만 거래하며 same-beta no-target-flip과 unconditional LONG은 대조군일 뿐이다. Target price·spread·P/L·PF·DD·gate·verdict는 아직 미개봉이고 seed, Optimization candidate, MT5 shortlist, Live authority는 없다. 최신 marker는 `FRONTIER_UNIT_112_RFS_EARNINGS_EXTRAPOLATION_MONTHLY_SIGNAL_DECLARED_ECONOMICS_UNOPENED`다.
