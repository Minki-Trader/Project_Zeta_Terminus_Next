...
- `research/market-stop-reverse-lot-sizing-implementation-correction-v1/`: 활성 Program 5 / micro→macro Unit 062 구현교정 sibling; 원래 경제 계약 전체를 그대로 상속하고 report-parent 생성과 실제 소비 입력 중심 환경 동결만 교정해 동일 실험을 종결할 예정. 새 Unit 095가 아니며 소스·런타임·경제 결과는 선언 커밋 전 미개봉
