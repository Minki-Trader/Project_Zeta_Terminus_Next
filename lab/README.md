...
현재 active research family는 없다. Unit 103 `two-index-h1-directional-lead-lag-response-v1`은 두 ordered pair 모두 `6.94..6.96` signals/day의 outcome-free 밀도를 통과했지만, P1 `2,548`건씩의 US100→US30 / US30→US100 observed 경제가 `-$39.3505 / -$36.4665`, doubled-spread가 `-$86.1960 / -$73.7686`, PF가 `0.83358 / 0.77490`이었다. 두 pair 모두 calendar split·leader sign을 포함한 7개 discovery 관문을 전부 실패했다. P2-P5 경제는 미개봉이고 retained seed·MT5 shortlist·인접 lead-lag 구제·Lab MQL·Live 권한은 없다. 최신 scheduler marker는 `FRONTIER_UNIT_103_CLOSED_VALID_DIRECTIONAL_LEAD_LAG_NO_P1_VARIANT_NO_SEED`; Optimization Goal은 전체 맵 재비교로 복귀한다.
