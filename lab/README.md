...
- `research/cross-relative-convergence-sleeve-v1/`: 활성 Program 1 / meso→macro Unit 093 단일 실험 family; 자체 source/config/runtime와 최종 build 6140 EX5는 고정됐고 최초 환경동기화·보고서경로 사전실행은 무효 격리 후 V2 환경을 재동결했으며, 현재 6전략 CONTROL과 고정 US30+US500 DUAL_APPEND 수렴 sleeve를 binding-long·isolated-latest 4경로에서 처음부터 함께 판정하고 개별 symbol·threshold·clock·hold 구제는 없음
