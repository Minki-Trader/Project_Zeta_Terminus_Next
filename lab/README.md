...
- `research/market-stop-reverse-lot-sizing-v1/`: 열린 Program 5 / micro→macro Unit 062 family; 독립 source/runtime과 build-6140 `0 errors / 0 warnings` EX5를 첫 결과 전에 동결했으며, 다섯 market-entry 컴포넌트의 native stop/ATR14 fit 1회가 다음 단계다. Passive·risk accounting·Live는 고정
