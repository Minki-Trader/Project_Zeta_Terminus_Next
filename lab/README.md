...
- `research/prior-cash-breadth-book-rotation-v1/`: 활성 Program 1 / meso→macro Unit 091 source-free family; 직전 완료 미국 cash session의 RSP equal-weight 대 SPY cap-weight open-to-close 리더십이 다음 native day의 US30-US100 상대 book 가치를 바꾸는지 공식 OHLC와 2,233개 lifecycle로 고정 판정 예정
