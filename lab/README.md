...
현재 active research family는 없다. Program 2 / meso→macro Unit 109 `three-index-europe-open-inventory-drift-v1`은 NY Fed의 exact 02:00..03:00 ET LONG을 US30+US100+US500 불가분 묶음으로 한 번 판정했다. 1,033 days·3,099 trades의 full gross/observed/stressed는 `-$0.27335 / -$34.8362 / -$69.39905`, stressed PF `0.6869`, DD `77.6002%`; P1-P4 모두, prelatest 세 symbol·다섯 weekday·38/46 months가 음수였다. Latest만 `+$7.6862`였으며 June 집중이라 `VALID_NO_THREE_INDEX_EUROPE_OPEN_DRIFT_AFTER_COST_NO_SEED`로 닫혔다. seed·MT5·clock/DST/symbol/subgroup/integration rescue 없음. 최신 marker는 `FRONTIER_UNIT_109_CLOSED_VALID_NO_THREE_INDEX_EUROPE_OPEN_DRIFT_AFTER_COST_NO_SEED_MAP_RECOMPARED`; Optimization Goal은 전체 맵으로 복귀했다.
