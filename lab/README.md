...
- `research/frontier-evidence-path-yield-audit-v1/`: 활성 Program 7 / Unit 043 source-free meta family; Unit 023-042의 반복 가능한 추적증거 10개·fresh observer 9개 획득경로 전수를 선언 동결, 권위 경제판정·무결성 이탈 분류 미개봉
