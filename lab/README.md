...
- `research/us100-realized-variance-asymmetry-response-authoritative-history-v1/`: 열린 Program 1 / meso Unit 096 단일 실험 family; Unit 032의 경제 미판정 계약을 threshold·window·horizon·기간 변경 없이 그대로 고정했다. 자체 source/config/EX5와 neutral Lab에서 만든 lean `rva96-portable`은 build 6140 `0 errors / 0 warnings`, 링크·다른-family 코드·parity fault 0이다. 첫 P1은 symbols/2024 HCS 동기화로 비경제 보존됐고 현재 환경을 재동결했다; 기회 경제열은 미열람이며 다음은 같은 실험의 P1-P4 전체 행렬을 P1부터 재시작한다
