...
- `research/native-hold-schedule-curve-v1/`: 열린 Program 4 / meso Unit 060 family; NATIVE `8/12/4/8/6/16`, SHORT_25 `6/9/3/6/5/12`, LONG_25 `10/15/5/10/8/20`의 단일 독립 source/config/EX5/runtime이 build 6140 `0 errors / 0 warnings`로 동결되었고 4기간·12경로 실틱 outcome은 아직 미개봉
