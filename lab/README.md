...
- `research/rc16-long-drift-signal-specificity-v1/`: 활성 Program 1 / meso Unit 070 source-free family; 검증된 US30 M30 native 13:30 경로에서 RC16 신호일을 무조건 롱 및 양의 최근방향·압축미달 대조군과 한 번 비교해 beta 수확과 compression 고유가치를 분리
