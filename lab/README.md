...
현재 active research family는 Program 2 / micro→meso Unit 114 `research/us500-preopen-laguardia-sunshine-cash-direction-v1/` 하나다. NOAA LCDv2 LaGuardia 실제현지 05/06/07/08시 평균운량 `<=4 LONG / >4 SHORT`를 당일 US500 정규 cash session에 전이하며, outcome-free `985`일·P1/P2/P3/P4/latest `370/247/234/91/43`일과 모든 구간 양방향 밀도를 동결했다. 최신 관측은 진입 `36..40`분 전이며 target 가격·spread·경제는 미개봉이다. direct GHCNh의 2026-04-13 이후 결손은 전기간 단일 LCDv2 계열로 교정했으며 연구실패가 아니다. 선언이 origin/main에 도달한 뒤 완전 집계 한 번만 연다. 최신 marker는 `FRONTIER_UNIT_114_LAGUARDIA_MORNING_SUNSHINE_US500_CASH_DIRECTION_DECLARED_ECONOMICS_UNOPENED`다.
