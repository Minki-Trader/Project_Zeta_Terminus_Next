...
- `research/cross-relative-convergence-sleeve-v1/`: 활성 Program 1 / meso→macro Unit 093 단일 실험 family; 자체 source/config/runtime와 최종 build 6140 EX5가 첫 Tester 전 동결됐고, 현재 6전략 CONTROL과 고정 US30+US500 DUAL_APPEND 수렴 sleeve를 binding-long·isolated-latest 4경로에서 함께 판정하며 개별 symbol·threshold·clock·hold 구제는 없음
