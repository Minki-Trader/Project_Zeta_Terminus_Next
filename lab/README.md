...
- `research/loss-channel-risk-contract-attribution-v1/`: 활성 Program 4 / micro→macro Unit 066 source-free family; CP2 2,233개와 binding Tester 2,235개 전체에서 STOP/NONSTOP 손실질량·planned-risk 사용률·기간/컴포넌트 폭·고정 집중도를 한 번 판정하며 stop은 모든 경우 tail bound로 보존
