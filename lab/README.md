...
- `research/us500-monthly-range-break-response-v1/`: 활성 Program 1 / Unit 053 family; 20개 완료 D1 범위 돌파 뒤 5개 D1 continuation/reversion 한 묶음, one-source observer `0/0` compile·독립 runtime 동결, P1 2025 outcome 미개봉
