...
- Active research boundary: Program 2 / meso Unit 090 `standard-options-expiration-week-state-v1` declaration frozen before official source persistence or lifecycle outcomes
...
Active research unit: Program 2 / meso Unit 090 `standard-options-expiration-week-state-v1`; declaration frozen before official source acquisition or lifecycle outcomes

Latest Frontier marker: `FRONTIER_UNIT_090_OPEN_BEFORE_OFFICIAL_SOURCE_ACQUISITION`
