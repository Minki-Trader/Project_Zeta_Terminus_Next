...
- Active research boundary: Unit 038 `us500-ordinal-acceleration-response-v1`; source, configuration, binary and dedicated runtime frozen before P1 outcome
...
## Open US500 ordinal acceleration response Unit 038
...
- Compile receipt SHA-256 is `308836DFD5BE9DF3DD774039D54A3DC93C53B439557765821C728EFF08D339FD`. Source/config/binary/runtime are immutable; only P1 may now open and Live remains untouched.
