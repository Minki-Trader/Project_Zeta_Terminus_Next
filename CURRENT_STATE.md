...
- Active research boundary: Program 4 / micro→macro Unit 069 `performance-endogenous-risk-geometry-v1` declaration is frozen; one source-free capital-tail, local-time-block, cost-R and stop-hazard aggregation remains
...
Active research unit: `performance-endogenous-risk-geometry-069`; declaration frozen, all capital-tail geometry, cost and hazard metrics unopened
