...
- Active research boundary: none; Unit 082 `lab/research/passive-self-blocking-opportunity-v1/` is frozen and closed ambiguous with no candidate, and whole-map recomparison is pending
...
Latest closed research verdict: `AMBIGUOUS_PASSIVE_SELF_BLOCKING_OPPORTUNITY_NO_CANDIDATE`

Active research unit: none; recompare the remaining Claude cards and the whole Frontier map

Latest Frontier marker: `PASSIVE_SELF_BLOCKING_OPPORTUNITY_082_CLOSED_AMBIGUOUS_NO_CANDIDATE`
