...
- Active research boundary: Program 5 / macro Unit 065 `portfolio-drift-benchmark-attribution-v1` declaration is frozen; exactly one source-free exposure, daily-beta, equity-DD and drawdown-matched passive-hurdle aggregation remains
...
Latest closed research verdict: `NO_BROAD_NONSTOP_LOSS_DOMINANCE_PRESERVE_STOP_RISK_INTERPRETATION`

Active research unit: `intraday-sizing-risk-clock-ratchet-067`; declaration and market-only multiplier scope correction frozen, all Unit 067 metrics unopened
