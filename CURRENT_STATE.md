...
- Active research boundary: none; Program 4 / meso Unit 060 `native-hold-schedule-curve-v1` is closed invalid and frozen after the first control path failed the predeclared detailed real-tick gate, and no automatic successor is open
