...
- Active research boundary: none; Program 5 / macro Unit 061 `candidate-funnel-turnover-risk-contract-v1` is closed invalid and frozen after its declared slot formula double-counted active positions inside the reserved-mask union
