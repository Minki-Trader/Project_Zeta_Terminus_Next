...
Latest closed research verdict: `INVALID_MARKET_STOP_REVERSE_LOT_EXECUTION_OR_RECONSTRUCTION_NO_VERDICT`

Active research unit: `all-slot-evaluation-clock-shape-063`; declaration frozen, outcomes unopened
