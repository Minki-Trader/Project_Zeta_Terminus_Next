...
- Active research boundary: Program 3 / micro→meso Unit 073 `order-type-realized-entry-cost-v1`; declaration frozen before any order-type cost, spread or outcome aggregate
...
Latest closed research verdict: `NO_US100_INSURANCE_ONLY_ROLE_POSITIVE_RETURN_AND_WRONG_PROTECTION_DIRECTION`

Active research unit: `order-type-realized-entry-cost-073`; declaration frozen before order-type aggregates
