...
- Active research boundary: `us100-realized-variance-asymmetry-response-032`; frozen observer with runtime path-length correction committed before the identical first valid outcome
...
## Open US100 realized-variance asymmetry response Unit 032
...
- The corrected generated-tick interval is structurally excluded. Preserved cumulative-log suffixes prove zero detailed quality warning for full 2024, 2025 and 2026-07, so the frozen new paths are 2024 H1, 2024 H2, 2025 and 2026-07; each must independently repeat the stricter HTML-plus-detailed-log gate.
- A later standalone question survives only if one direction passes integrity, pooled/path frequency, positive double-spread net, PF `>=1.10`, three positive paths, net-to-DD `>=1.50` and contribution limits. Unit 032 selects no stop, size, hold, priority, EA or Live candidate.
...
- Declaration/compile-receipt/runtime-correction SHA-256 values are `B83BBF7CA1D0663670841FC4D322C000F46B38D503CA7AFA6F48D272E9F20066` / `5F84825EBF7F4BFEFA4307F17F7BAF8B4FCB593E9ED6E85F7B51DCB87E82599E` / `967240AE839A2DACB670BEEF7A4C78FC158A80B490270177B132C1CE6668158A`. Four outcomes remain unopened; no Live surface was changed.
