...
- Active research boundary: Program 5 / macro Unit 074 `turnover-value-frontier-v1`; declaration frozen before any rank, frequency-half transfer or verdict metric
...
Latest closed research verdict: `NO_RECORDED_ORDER_TYPE_COST_SEPARATION_NO_ADVERSE_SELECTION_IDENTIFICATION`

Active research unit: `turnover-value-frontier-074`; declaration frozen before frequency/value metrics
