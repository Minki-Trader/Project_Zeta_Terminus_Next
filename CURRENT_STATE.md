...
- Active research boundary: none; Program 2 Unit 041 is closed with no retained event-time measurement seed, and no adjacent event/window successor is open
...
Latest research verdict: `SCHEDULED_US_MACRO_EVENT_EXPOSURE_041_CLOSED_NO_ROLE_PASSED_NO_SEED`
