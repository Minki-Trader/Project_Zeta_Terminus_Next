...
- Active research boundary: Unit 076 `lab/research/three-index-dispersion-book-relative-value-v1/`; declaration frozen before any dispersion score, regime or conditional outcome metric
...
Latest closed research verdict: `INVALID_OUTCOME_CONCENTRATION_NO_VERDICT`

Active research unit: Unit 076 `three-index-dispersion-book-relative-value-v1`; declaration frozen, outcomes unopened
