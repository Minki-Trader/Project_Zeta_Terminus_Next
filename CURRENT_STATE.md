...
- Active research boundary: `initial-stop-geometry-value-025`; source-free all-strategy initial stop-distance declaration frozen before outcome aggregation
...
## Open initial stop geometry value Unit 025
...
- All `2,233` admitted births expose a positive initial stop distance. Market strategies use OPEN entry/stop; Passive uses the matching PASSIVE_PLACE stop and actual PASSIVE_FILL price. Every strategy-period has at least 23 lifecycles and seven observations in each fixed tail.
...
- A passing field needs pooled `|rho| >= 0.20`, absolute WIDE-minus-NARROW separation of at least `0.10R` and `0.05` stop rate, three-period breadth and coherent R/stop direction. At most one later entry-preserving strategy-specific Proxy question may survive while preserving native initial stops and comparing the whole six-strategy portfolio.
- Declaration SHA-256 is `417E04F77CC512892B72FBB13774FFAB327388B2F1ED65BF7D2D0C2680188AB8`; outcomes, MQL, Tester and Live remain unopened.
