...
- Active research boundary: `us100-tick-flow-imbalance-response-030`; fresh trade-free observer, four configurations and dedicated Portable frozen before outcome
...
## Open US100 tick-flow imbalance response Unit 030

- Fresh Next-only microstructure question: whether the signed imbalance between strict executable-mid upticks and downticks inside one completed US100 M15 bar supports a frequent cost-positive one-market-hour continuation or reversion response.
- A continuous bar with at least 200 directional ticks triggers at absolute imbalance `0.25`. One trade-free observation at a time resolves after four subsequent M15 market bars and prices both directions at `0.01` using observed bid/ask plus exactly one additional entry and exit spread.
- Exactly four serial real-tick paths through completed month 2026-07 are permitted. A direction must pass integrity, pooled/path frequency, double-spread net/PF/net-to-DD, three-positive-path and contribution-concentration gates.
- Unit 030 places no order and selects no stop, size, hold, priority or Live candidate. At most one later standalone additive question may survive; any later combination must retain and evaluate all six existing strategies without reducing their opportunity count.
- The fresh single-source observer compiled on its first build-6140 attempt at `0 errors / 0 warnings`; source/config/binary hashes are `D9482E8C8AE9C4ABC5181A947C0F315ACB3DDA39031C20B1136BA62C8FFB9DA5` / `E6B7256BC0B36DA46AB564A2C04E48A0A18D69AF8E3F3A9655D14C08A5998C68` / `11D0549A5F54F1EE7472432B1383F128BF812C2A8C2C8BC69F793A6BBED4BA0D`.
- Declaration/compile-receipt SHA-256 values are `98172EE896F223CB98A3B82114EE5ADF31ABA044AFB0D1604E2825AE4E066392` / `3EDB11700D890BD00858179B88A106138E2994DEDD67DD1C2983552154EE3839`. Four outcomes remain unopened; no Live process, broker state or Live surface was queried or changed.
