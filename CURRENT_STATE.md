...
- Active research boundary: Unit 082 `lab/research/passive-self-blocking-opportunity-v1/`; its acquisition and sole premetric record-key serialization correction are frozen, with one fixed source-free integrity/shadow aggregation remaining
...
Active research unit: Unit 082 `passive-self-blocking-opportunity-v1`; outcomes unopened
