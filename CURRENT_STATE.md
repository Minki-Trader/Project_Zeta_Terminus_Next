...
- Active research boundary: Unit 084 `predecision-market-participation-state-v1` has a frozen isolated three-symbol H1 acquisition with lifecycle outcomes still unopened; one fixed aggregation is pending
...
Active research unit: Unit 084 `predecision-market-participation-state-v1`; acquisition frozen, outcomes unopened, one fixed aggregation pending

Latest Frontier marker: `UNIT_084_H1_PARTICIPATION_ACQUISITION_FROZEN_LIFECYCLE_OUTCOMES_UNOPENED`
