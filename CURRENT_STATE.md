...
- Active research boundary: Unit 084 `predecision-market-participation-state-v1` is declared with outcomes unopened; one isolated three-symbol H1 volume acquisition is pending
...
Active research unit: Unit 084 `predecision-market-participation-state-v1`; declaration frozen, outcomes unopened, acquisition pending

Latest Frontier marker: `UNIT_084_PREDECISION_MARKET_PARTICIPATION_STATE_DECLARED_OUTCOMES_UNOPENED`
