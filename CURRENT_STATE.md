...
- Active research boundary: Program 2 / meso→macro Unit 089 `cftc-leveraged-money-relative-flow-v1`; declaration frozen before official source acquisition or any state-conditioned supply/lifecycle outcome
...
Active research unit: Unit 089 `cftc-leveraged-money-relative-flow-v1`; declaration frozen before official acquisition or outcomes

Latest Frontier marker: `CFTC_LEVERAGED_MONEY_RELATIVE_FLOW_089_DECLARATION_FROZEN`
