...
Existing V7 improvement continues until user pause. The user has explicitly approved the exact pending closed-model nativecompletion exception with `ㄱㄱ`; this permission must not be requested again. Authority: optimization/evidence/V7_LOG_ALLOCATION_NATIVE_USER_AUTHORIZATION_V1.json. The sole active family19 is optimization/campaigns/v7-native-log-allocation-completion-v1/, Program5. It derives fresh originalV7 source, imports only the exact336B graph and411B initialparameters, and completes full2025 control/static/control/online in one declared bundle. Original model/weights/online rule,100%real ticks, growth/stress5%/DD/recovery/epoch gates are unchanged. Other18 closures and the unrelated oldpyramid exception remain closed.

The prospective DECLARATION_V1 freezes roleidentities260908901..906/control,260908911..916/static,260908921..926/online, own Include/EA/state/logs and a dedicated Optimization Portable. All original signals/clocks/directions/exits remain. Weight scales legal-step marketquantity and its corresponding fresh-entry protectionbudget; Passive remains original0.01. Owncompleted lifecycleR is bucketed by actualcloseserverday, with closeat00 assigned tonewday, and only completeprecedingday labels update the next allocation. All three own EA roles compiled with zero errors and warnings on build6182. Exact graph inference, legal weighted quantity/protection, completed lifecycle/day attribution, online displacement and conservative minute marks are implemented. The initial v1 control is preserved as an allocation-array engineering fault. All three corrected roles compile cleanly. The complete v2 control has zero faults,554 closes, actual121.39/stress112.988 and nativeDD16.073213874%, but its HTML99%real ticks is invalid for economic selection. All12 past-bar streams/contracts and2025tick counts match; it is an environment correction, not a failure or99%waiver. A prospectively recorded89,753,398-byte six-file2024December tick warmup copy supplies the immediately preceding complete month. Fresh v3 control is now complete and valid100%real ticks, with554 closes, actual121.39, conservative stress112.988, DD16.073213874%, recovery3.9825875469 and zero reinvestment births. Corrected past warmup changes neither2025ticks nor money. Frozen877 files SHA5FA21E65E4A35A722AD8831FFFE496E16E0D8E07EDA6048E9B0938BBE9C5AC81 and all12 bar streams/contracts remain exact. Static candidate is now running as ownPID24908; complete all four v3 roles before judgment. No2026 candidate value opened.

Selection storage is funded for the entirefour-role2025 matrix:3.5GiBruntime+1GiBraw+64MiBsource, above30GiB. The amendment retains fullrequired2025tick files and pastbarwarmup without preloading unexecuted2024/2026tick caches; existing originals remain. One fullyeligibleunchanged finalist alone may opencontinuousconfirmation afterits completeremaininggrowth is separatelyfunded. No hypothetical compression/hardlink saving or relaxed economicgate funds this budget. Startup cleanmain==origin/main946deac, freeover35GiB, onlyuntouchedLivePID28324; no broker context query.
