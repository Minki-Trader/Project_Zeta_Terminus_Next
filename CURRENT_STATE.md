...
- Active research boundary: none; Program 4 / micro→macro Unit 069 `performance-endogenous-risk-geometry-v1` is closed partial with no candidate, pending whole-map recomparison after its closure reaches origin
...
Active research unit: none; Unit 069 is frozen closed and whole-map recomparison is required before any successor
