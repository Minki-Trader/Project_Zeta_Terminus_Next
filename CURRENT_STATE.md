...
- Active research boundary: none; Unit 069 closure is on origin and the whole Program 1-5 and 7 plus height map has been recomputed at a clean reporting boundary, with no successor automatically opened
...
Active research unit: none; post-Unit-069 whole-map recomparison is complete, and any successor requires a new pre-outcome declaration
