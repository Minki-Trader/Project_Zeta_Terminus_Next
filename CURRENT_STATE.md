...
- Active research boundary: `native-direction-asymmetry-value-034`; source-free BUY/SELL information-value declaration frozen before outcome aggregation
...
## Open native direction asymmetry value Unit 034
...
- At most one later strategy-specific direction-treatment question may survive, but Unit 034 selects no suppression, response, size, management, EA or Live candidate. Any later question must keep all base opportunities eligible and preserve whole six-strategy opportunity count.
- Declaration SHA-256 is `00C343C5899AFA9A49BC71B24C61EFDA825D5DCD32DCE59F9C96F11523BC993A`. Direction-conditioned outcomes remain unopened; no Tester or Live surface was queried or changed.
