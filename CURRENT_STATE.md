...
- Active research boundary: Program 2 / meso→macro Unit 089 `cftc-leveraged-money-relative-flow-v1`; official acquisition frozen before any positioning-state, supply or lifecycle metric
...
Latest closed research verdict: `AMBIGUOUS_PREDECISION_GOLD_YEN_RISK_STATE_NO_CANDIDATE`

Active research unit: Unit 089 `cftc-leveraged-money-relative-flow-v1`; official source batch frozen before state, supply or lifecycle outcomes

Latest Frontier marker: `CFTC_LEVERAGED_MONEY_RELATIVE_FLOW_089_ACQUISITION_FROZEN`
