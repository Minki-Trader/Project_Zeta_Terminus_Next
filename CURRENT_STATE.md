...
Current status: `OWN_PROCESS_CUDA_VISIBILITY_CORRECTION_PENDING_AGENT_EXIT`. Compile-v5 CPU-only source remains clean and unchanged. Original cs-v4 completed full2025 at100percent,768unchanged inputs/history, and exact original121.39/112.988/DD16.073213873721/554closed; its five primary ledgers equalcs-v3 byteforbyte. Static-v4 stalled for over9minutes inside OnnxCreateFromBuffer with only durableCREATE_BEGIN, no checkpoint/forecast/observation/update/trade result. Its own parentPID37264 exited after normalclose; exact agentPID25104 remained and received a guarded scoped termination request. Actual exit/release is still required before new native work.

Own process snapshot proves exactPID/path/creation/parent and system nvcuda DLLs loaded, but noONNX/ORT/OpenBLAS/DirectML module was observed. Raw threadwaits and three boundedWCTcalls do not identify an external owner or prove GPU causation. OWN_CPU_ONNX_INITIALIZATION_PROCESS_FACTS_V1 SHA6F3674124F8A5CCD8155FE1EB54004C08A8C64911235234D7D083C2893A32465 preserves facts andlimits. An initialstopguard aborted beforeaction because CIM rounded nativecreationtime by100ns; a one-microsecond precision guard thenconfirmedexactidentity. Stop request return doesnotmeanactualexit. AseparateexactspawnedaggregateGPUquery(nvidia-smiPID32568,parentPython22456,execsession37244)also remainsunsignaled afterthe10secondquerytimeoutrequestedtermination(exitcodeobserved1). Nativeagentexitcodeobserved0xFFFFFFFF/wait258 andquerywait258/exitTime0 arepreserved in ROOT_HOST_VENDOR_WAIT_V1 SHA9703538EED7594C4E910DBBC2A156FEF7B090EC6C06EDC116D0EFCFD20C05B2B. NoGPUcountervaluesorotherprocessinventorywereobtained. RootmustnotlaunchanotherGPUquery;collectthisexistingsessionwhenitfinallyreturns. Bothvendor-facingoperationsarewaiting;exacthostcauseunconfirmed. OptionaluserquestionaskswhetheranotherGPUworkloadisrunning;noanswerorpermissionisassumed. Narrow initialmarker/engineCSV/wholeownagentlog copies andalloriginalruntimefilesremainpreserved. Static-v4 has no complete.json/economic result. ROOT_CPU_INITIALIZATION_PARTIAL_RETENTION_V1 SHA496A3E1B62234767E6F8B61338F8E15D0A63243F6DA58898AC40D60C0152FAB0 records all768inputsunchanged beforethelaunchproduceredit.

OWN_CUDA_VISIBILITY_CORRECTION_V1 SHAC13A04C39D59F541B1C216CF7023D0382A83F999F1021888ADBF66E11D01E534 prospectivelylimits only freshlyspawnedownprocess environment to CUDA_VISIBLE_DEVICES empty. This ordinaryproducerchange is authored, notyetexecuted. Parent/User/Machineenvironment,globalGPUsettings/drivers/devices andLive/Lab remainunchanged. NoMQL/EX5/model/fit/cutoff/eta/tradingrulechange. Afteractualallowners0:preserve releasedlock,preparefreshv5fullmatrix/history/wholefreeze,then cs-v5/static-v5/co-v5/online-v5. Compile-v5binaries stayfixed;newMQLcompilationisunnecessaryunlesscodechanges. Nooverlappingtesterormixedmatrixverdict.
