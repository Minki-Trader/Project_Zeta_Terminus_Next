...
- Active research boundary: open Program 2 / meso Unit 088 `predecision-gold-yen-risk-state-v1`; declaration frozen before external H1 acquisition or any state-conditioned lifecycle outcome
...
Active research unit: `predecision-gold-yen-risk-state-088`; declaration frozen, acquisition not yet started

Latest Frontier marker: `FRONTIER_PREDECISION_GOLD_YEN_RISK_STATE_088_DECLARED`
