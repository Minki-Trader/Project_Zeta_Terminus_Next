...
- Active research boundary: Program 5 / micro-to-macro Unit 062 `market-stop-reverse-lot-sizing-v1` has its independent source, native configs, build-6140 EX5 and dedicated runtime frozen; the single native ATR fit path is next and no Tester outcome is open
