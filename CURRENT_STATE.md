...
- Active research boundary: Program 2 / meso→macro Unit 071 `server-calendar-drift-segmentation-v1`; declaration frozen, all gap/intraday/active-window return components unopened, one source-free aggregation remains
