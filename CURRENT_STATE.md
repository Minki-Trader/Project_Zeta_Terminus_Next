...
- Active research boundary: Unit 081 `lab/research/component-removal-counterfactual-v1/`; source, 12-path configuration, build-6140 binary and dedicated physical runtime are frozen before P1 NATIVE, with no source/configuration change or path rerun allowed after it starts
