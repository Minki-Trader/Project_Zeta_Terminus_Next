...
- Active research boundary: none; Program 1 / meso Unit 070 is frozen closed ambiguous with no candidate, and the whole map must be immediately recomputed before opening the next Claude bundle
...
Active research unit: none; Unit 070 is frozen closed and immediate whole-map recomparison precedes the next serial Claude unit
