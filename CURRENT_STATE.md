...
- Active research boundary: Program 4 Unit 052 `held-position-first-peer-exit-state-v1` is declaration-frozen with target close economics unopened; one fixed source-free aggregation remains
