...
- Active research boundary: Program 2 / meso Unit 090 `standard-options-expiration-week-state-v1` sole premetric acquisition correction frozen before the one remaining official source batch or lifecycle outcomes
...
Latest closed research verdict: `NO_MATERIAL_CFTC_LEVERAGED_MONEY_RELATIVE_BOOK_FIELD`

Active research unit: Program 2 / meso Unit 090 `standard-options-expiration-week-state-v1`; sole premetric acquisition correction frozen before the one remaining official source batch or lifecycle outcomes

Latest Frontier marker: `FRONTIER_UNIT_090_PREMETRIC_ACQUISITION_CORRECTION_FROZEN`
