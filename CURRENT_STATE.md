...
- Active research boundary: none; Unit 084 is frozen closed and the whole map has been recomputed with no automatic successor open
...
Latest closed research verdict: `AMBIGUOUS_PREDECISION_MARKET_PARTICIPATION_STATE_NO_CANDIDATE`

Active research unit: none; whole map recomputed after Unit 084, zero held external cards, no automatic successor

Latest Frontier marker: `AFTER_084_WHOLE_MAP_RECOMPARED_ZERO_HELD_CARDS_NO_SUCCESSOR`
