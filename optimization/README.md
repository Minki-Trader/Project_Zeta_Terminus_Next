...
`campaigns/dd20-chronological-stability-proxy-v1/` is the active serial stage with outcomes unopened. It keeps the full `112,752` executable-lattice search and long-selection DD gates, uses June 2026 as a declared positive/DD-bounded development checkpoint, freezes one maximum-selection-stressed-profit role and only then opens untouched July 2026 for final confirmation. July cannot rank, tune or rescue the winner, and at most one candidate can reach MT5.
