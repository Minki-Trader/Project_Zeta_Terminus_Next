...
`campaigns/dd20-exposure-margin-mt5-v1/` is declared with that sole `1.8 / 1.3 / 1.4 / 2.6 / 1.5 / 0` hypothesis. Its source, identity, fixed SET and selection/paired-forward INIs are frozen while compilation, dedicated runtime and all MT5 economics remain unopened. It will run exactly one real-tick selection and one full June/July forward; no closed candidate reruns.
