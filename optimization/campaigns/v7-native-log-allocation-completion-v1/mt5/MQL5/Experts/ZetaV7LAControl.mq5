...
#property description "Execution version: zt-v7-native-log-allocation-control-v1"

#define LAC_MODE 0
#define LAC_NAMESPACE "ZetaV7LAControl"
#resource "\\Files\\ZetaV7LA\\allocation.onnx" as uchar LAC_MODEL_BYTES[]

#include <Trade\Trade.mqh>

#include <ZetaV7LAControl\Domain\ZetaDomain.mqh>
#include <ZetaV7LAControl\Time\ZetaSessionClock.mqh>
#include <ZetaV7LAControl\Strategies\ZetaStrategyShared.mqh>
#include <ZetaV7LAControl\Strategies\ZetaRC16.mqh>
#include <ZetaV7LAControl\Strategies\ZetaRC4.mqh>
#include <ZetaV7LAControl\Strategies\ZetaCross.mqh>
#include <ZetaV7LAControl\Strategies\ZetaPressure.mqh>
#include <ZetaV7LAControl\Strategies\ZetaReturn.mqh>
#include <ZetaV7LAControl\Strategies\ZetaPassive.mqh>
#include <ZetaV7LAControl\Portfolio\ZetaPortfolioRisk.mqh>
#include <ZetaV7LAControl\Execution\ZetaOwnership.mqh>
#include <ZetaV7LAControl\Execution\ZetaOrders.mqh>
#include <ZetaV7LAControl\Execution\ZetaProtectionAndReconciliation.mqh>
#include <ZetaV7LAControl\Persistence\ZetaStateAndEvents.mqh>
#include <ZetaV7LAControl\Observation\ZetaResearchObservation.mqh>

#include <ZetaV7LAControl\Observation\ZetaReturnDiagnostics.mqh>

#include <ZetaV7LAControl\Learning\ZetaLogAllocation.mqh>
...
double OnTester()
  {
   ...
   const bool correction_required =
      (portfolio_state.safety_stopped || persistence_failed ||
       ...
       closed_lifecycles <= 0 || !lac_initialized || lac_faults != 0 ||
       lac_unknown_marks != 0 || lac_births != closed_lifecycles ||
       lac_labels != closed_lifecycles || PositionsTotal() != 0);
