...
input string InpNativeRunTag = "";
input datetime InpNativeFrom = D'2025.01.01 00:00';
input datetime InpNativeTo = D'2026.01.01 00:00';
...
const string EXECUTION_VERSION =
   "zt-v7-native-log-allocation-control-v1";
...
const string SCHEMA_VERSION = "LAC1-CONTROL";
const string RELEASE_ID = "V7LAC1-CONTROL-20260908";
const string PORTFOLIO_ID = "ZT-OPT-V7-LAC1-CONTROL-20260908";
...
const string STATE_MARKER =
   "ZT_LAC1_CONTROL_STATE_V1";
string STATE_PATH_A =
   "ZetaV7LAControl\\state\\state-a.csv";
string STATE_PATH_B =
   "ZetaV7LAControl\\state\\state-b.csv";
string EVENT_PATH_A =
   "ZetaV7LAControl\\state\\events-a.csv";
string EVENT_PATH_B =
   "ZetaV7LAControl\\state\\events-b.csv";
string CURRENT_SNAPSHOT_PATH_A =
   "ZetaV7LAControl\\state\\current-a.csv";
string CURRENT_SNAPSHOT_PATH_B =
   "ZetaV7LAControl\\state\\current-b.csv";
string OWNERSHIP_PATH =
   "ZetaV7LAControl\\state\\runtime.lock";
string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaV7LAControl\\research";
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-v7-lac1-control-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_LAC1_CONTROL_OBSERVATION_STATE_V1";
string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaV7LAControl\\research\\research-state-a.csv";
string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaV7LAControl\\research\\research-state-b.csv";
string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaV7LAControl\\research\\research-candidates.csv";
string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaV7LAControl\\research\\research-lifecycles.csv";
...
const ulong MAGIC_RC16_LONG = 260908901;
const ulong MAGIC_RC4_BOTH = 260908902;
const ulong MAGIC_US100_CROSS = 260908903;
const ulong MAGIC_US30_PRESSURE = 260908904;
const ulong MAGIC_US30_RETURN = 260908905;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260908906;
