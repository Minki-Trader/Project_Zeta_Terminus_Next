...
const string EXECUTION_VERSION =
   "zt-v7-native-log-allocation-static-v1";
const string ECONOMIC_VERSION =
   "zt-v7-native-log-allocation-static-v1";
const string PROJECT_ID = "project-zeta-terminus-next";
const string SCHEMA_VERSION = "LAC1-STATIC";
const string RELEASE_ID = "V7LAC1-STATIC-20260908";
const string PORTFOLIO_ID = "ZT-OPT-V7-LAC1-STATIC-20260908";
...
const string STATE_MARKER =
   "ZT_LAC1_STATIC_STATE_V1";
string STATE_PATH_A =
   "ZetaV7LAStatic\\state\\state-a.csv";
string STATE_PATH_B =
   "ZetaV7LAStatic\\state\\state-b.csv";
string EVENT_PATH_A =
   "ZetaV7LAStatic\\state\\events-a.csv";
string EVENT_PATH_B =
   "ZetaV7LAStatic\\state\\events-b.csv";
string CURRENT_SNAPSHOT_PATH_A =
   "ZetaV7LAStatic\\state\\current-a.csv";
string CURRENT_SNAPSHOT_PATH_B =
   "ZetaV7LAStatic\\state\\current-b.csv";
string OWNERSHIP_PATH =
   "ZetaV7LAStatic\\state\\runtime.lock";
string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaV7LAStatic\\research";
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-v7-lac1-static-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_LAC1_STATIC_OBSERVATION_STATE_V1";
string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaV7LAStatic\\research\\research-state-a.csv";
string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaV7LAStatic\\research\\research-state-b.csv";
string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaV7LAStatic\\research\\research-candidates.csv";
string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaV7LAStatic\\research\\research-lifecycles.csv";
...
const ulong MAGIC_RC16_LONG = 260908911;
const ulong MAGIC_RC4_BOTH = 260908912;
const ulong MAGIC_US100_CROSS = 260908913;
const ulong MAGIC_US30_PRESSURE = 260908914;
const ulong MAGIC_US30_RETURN = 260908915;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260908916;
