...
const string EXECUTION_VERSION =
   "zt-v7-native-log-allocation-online-v1";
const string ECONOMIC_VERSION =
   "zt-v7-native-log-allocation-online-v1";
const string PROJECT_ID = "project-zeta-terminus-next";
const string SCHEMA_VERSION = "LAC1-ONLINE";
const string RELEASE_ID = "V7LAC1-ONLINE-20260908";
const string PORTFOLIO_ID = "ZT-OPT-V7-LAC1-ONLINE-20260908";
...
const string STATE_MARKER =
   "ZT_LAC1_ONLINE_STATE_V1";
string STATE_PATH_A =
   "ZetaV7LAOnline\\state\\state-a.csv";
string STATE_PATH_B =
   "ZetaV7LAOnline\\state\\state-b.csv";
string EVENT_PATH_A =
   "ZetaV7LAOnline\\state\\events-a.csv";
string EVENT_PATH_B =
   "ZetaV7LAOnline\\state\\events-b.csv";
string CURRENT_SNAPSHOT_PATH_A =
   "ZetaV7LAOnline\\state\\current-a.csv";
string CURRENT_SNAPSHOT_PATH_B =
   "ZetaV7LAOnline\\state\\current-b.csv";
string OWNERSHIP_PATH =
   "ZetaV7LAOnline\\state\\runtime.lock";
string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaV7LAOnline\\research";
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-v7-lac1-online-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_LAC1_ONLINE_OBSERVATION_STATE_V1";
string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaV7LAOnline\\research\\research-state-a.csv";
string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaV7LAOnline\\research\\research-state-b.csv";
string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaV7LAOnline\\research\\research-candidates.csv";
string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaV7LAOnline\\research\\research-lifecycles.csv";
...
const ulong MAGIC_RC16_LONG = 260908921;
const ulong MAGIC_RC4_BOTH = 260908922;
const ulong MAGIC_US100_CROSS = 260908923;
const ulong MAGIC_US30_PRESSURE = 260908924;
const ulong MAGIC_US30_RETURN = 260908925;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260908926;
