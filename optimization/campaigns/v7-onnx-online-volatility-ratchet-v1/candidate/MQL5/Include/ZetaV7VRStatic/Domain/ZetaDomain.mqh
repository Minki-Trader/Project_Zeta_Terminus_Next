...
const string STATE_MARKER =
   "ZT_OPT_7VR1S_STATE_V1";
const string STATE_PATH_A =
   "ZetaV7VRStatic\\optimization\\volatility-ratchet\\state\\state-a.csv";
const string STATE_PATH_B =
   "ZetaV7VRStatic\\optimization\\volatility-ratchet\\state\\state-b.csv";
const string EVENT_PATH_A =
   "ZetaV7VRStatic\\optimization\\volatility-ratchet\\state\\events-a.csv";
const string EVENT_PATH_B =
   "ZetaV7VRStatic\\optimization\\volatility-ratchet\\state\\events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaV7VRStatic\\optimization\\volatility-ratchet\\state\\current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaV7VRStatic\\optimization\\volatility-ratchet\\state\\current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaV7VRStatic\\optimization\\volatility-ratchet\\state\\runtime.lock";
const string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaV7VRStatic\\optimization\\volatility-ratchet\\research";
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-opt-v7-vr-candidate-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_OPT_7VR1S_OBSERVATION_STATE_V1";
const string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaV7VRStatic\\optimization\\volatility-ratchet\\research\\research-state-a.csv";
const string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaV7VRStatic\\optimization\\volatility-ratchet\\research\\research-state-b.csv";
const string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaV7VRStatic\\optimization\\volatility-ratchet\\research\\research-candidates.csv";
const string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaV7VRStatic\\optimization\\volatility-ratchet\\research\\research-lifecycles.csv";
...
const ulong MAGIC_RC16_LONG = 2609071711;
const ulong MAGIC_RC4_BOTH = 2609071712;
const ulong MAGIC_US100_CROSS = 2609071713;
const ulong MAGIC_US30_PRESSURE = 2609071714;
const ulong MAGIC_US30_RETURN = 2609071715;
const ulong MAGIC_US100_PASSIVE_LIMIT = 2609071716;
