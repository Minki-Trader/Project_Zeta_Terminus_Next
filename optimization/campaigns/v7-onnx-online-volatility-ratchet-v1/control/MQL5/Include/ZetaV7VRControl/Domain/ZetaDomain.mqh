...
const string EXECUTION_VERSION =
   "zt-opt-v7-volatility-ratchet-control-v1";
...
const string SCHEMA_VERSION = "7VR1C";
const string RELEASE_ID = "OPT-V7-VOL-RATCHET-CONTROL-20260907";
const string PORTFOLIO_ID = "ZT-PORT-OPT-V7-VR-CONTROL-20260907";
...
const string STATE_MARKER =
   "ZT_OPT_7VR1C_STATE_V1";
const string STATE_PATH_A =
   "ZetaV7VRControl\\optimization\\volatility-ratchet\\state\\state-a.csv";
const string STATE_PATH_B =
   "ZetaV7VRControl\\optimization\\volatility-ratchet\\state\\state-b.csv";
const string EVENT_PATH_A =
   "ZetaV7VRControl\\optimization\\volatility-ratchet\\state\\events-a.csv";
const string EVENT_PATH_B =
   "ZetaV7VRControl\\optimization\\volatility-ratchet\\state\\events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaV7VRControl\\optimization\\volatility-ratchet\\state\\current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaV7VRControl\\optimization\\volatility-ratchet\\state\\current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaV7VRControl\\optimization\\volatility-ratchet\\state\\runtime.lock";
const string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaV7VRControl\\optimization\\volatility-ratchet\\research";
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-opt-v7-vr-control-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_OPT_7VR1C_OBSERVATION_STATE_V1";
const string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaV7VRControl\\optimization\\volatility-ratchet\\research\\research-state-a.csv";
const string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaV7VRControl\\optimization\\volatility-ratchet\\research\\research-state-b.csv";
const string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaV7VRControl\\optimization\\volatility-ratchet\\research\\research-candidates.csv";
const string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaV7VRControl\\optimization\\volatility-ratchet\\research\\research-lifecycles.csv";
...
const ulong MAGIC_RC16_LONG = 2609071701;
const ulong MAGIC_RC4_BOTH = 2609071702;
const ulong MAGIC_US100_CROSS = 2609071703;
const ulong MAGIC_US30_PRESSURE = 2609071704;
const ulong MAGIC_US30_RETURN = 2609071705;
const ulong MAGIC_US100_PASSIVE_LIMIT = 2609071706;
