...
#property description "Execution version: zt-opt-v7-volatility-ratchet-control-v1"

#include <Trade\Trade.mqh>

#include <ZetaV7VRControl\Domain\ZetaDomain.mqh>
#include <ZetaV7VRControl\Time\ZetaSessionClock.mqh>
#include <ZetaV7VRControl\Strategies\ZetaStrategyShared.mqh>
#include <ZetaV7VRControl\Strategies\ZetaRC16.mqh>
#include <ZetaV7VRControl\Strategies\ZetaRC4.mqh>
#include <ZetaV7VRControl\Strategies\ZetaCross.mqh>
#include <ZetaV7VRControl\Strategies\ZetaPressure.mqh>
#include <ZetaV7VRControl\Strategies\ZetaReturn.mqh>
#include <ZetaV7VRControl\Strategies\ZetaPassive.mqh>
#include <ZetaV7VRControl\Portfolio\ZetaPortfolioRisk.mqh>
#include <ZetaV7VRControl\Execution\ZetaOwnership.mqh>
#include <ZetaV7VRControl\Execution\ZetaOrders.mqh>
#include <ZetaV7VRControl\Execution\ZetaProtectionAndReconciliation.mqh>
#include <ZetaV7VRControl\Persistence\ZetaStateAndEvents.mqh>
#include <ZetaV7VRControl\Observation\ZetaResearchObservation.mqh>

#include <ZetaV7VRControl\Observation\ZetaReturnDiagnostics.mqh>
#include <ZetaV7VRControl\Observation\ZetaEconomicPath.mqh>
...
int OnInit()
  {
   ...
   FolderCreate("ZetaV7VRControl");
   FolderCreate("ZetaV7VRControl\\optimization");
   FolderCreate("ZetaV7VRControl\\optimization\\volatility-ratchet");
   FolderCreate("ZetaV7VRControl\\optimization\\volatility-ratchet\\state");
   FolderCreate("ZetaV7VRControl\\optimization\\volatility-ratchet\\research");
   if(tester_mode)
...
double OnTester()
  {
   ...
   const bool correction_required =
      (economic_path_failed || portfolio_state.safety_stopped || persistence_failed ||
