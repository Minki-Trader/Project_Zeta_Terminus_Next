...
// Isolated optimization copy of the active RLO1 parent. Only the two declared
// portfolio risk-cap inputs vary in this campaign.
...
const string EXECUTION_VERSION =
   "zt-opt-live-v7-portfolio-risk-cap-envelope-v1";
...
const string SCHEMA_VERSION = "opt-prc-1";
const string RELEASE_ID = "OPT-LIVE-V7-PRC1-20260828";
const string PORTFOLIO_ID = "ZT-OPT-LIVE-V7-PRC1-20260828";
const string ECONOMIC_FINGERPRINT =
   "parent-rlo1-b32e7e176f2e-ref100-base0.01-components6-posrisk0.03to0.05-aggrisk0.10to0.18-only";
const string EXECUTION_FINGERPRINT =
   "isolated-tester-only-parent-rlo1-b32e7e176f2e-dedicated-portable-custom-economic-criterion-v1";
const string STATE_MARKER =
   "ZT_OPT_LIVE_V7_PORTFOLIO_RISK_CAP_ENVELOPE_STATE_V1";
const string STATE_PATH_A =
   "ZetaOptimization\\portfolio-risk-cap-envelope-v1\\state\\state-a.csv";
const string STATE_PATH_B =
   "ZetaOptimization\\portfolio-risk-cap-envelope-v1\\state\\state-b.csv";
const string EVENT_PATH_A =
   "ZetaOptimization\\portfolio-risk-cap-envelope-v1\\state\\events-a.csv";
const string EVENT_PATH_B =
   "ZetaOptimization\\portfolio-risk-cap-envelope-v1\\state\\events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaOptimization\\portfolio-risk-cap-envelope-v1\\state\\current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaOptimization\\portfolio-risk-cap-envelope-v1\\state\\current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaOptimization\\portfolio-risk-cap-envelope-v1\\state\\runtime.lock";
const string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaOptimization\\portfolio-risk-cap-envelope-v1\\research";
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-optimization-portfolio-risk-cap-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_OPT_PORTFOLIO_RISK_CAP_OBSERVATION_STATE_V1";
const string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaOptimization\\portfolio-risk-cap-envelope-v1\\research\\research-state-a.csv";
const string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaOptimization\\portfolio-risk-cap-envelope-v1\\research\\research-state-b.csv";
const string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaOptimization\\portfolio-risk-cap-envelope-v1\\research\\research-candidates.csv";
const string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaOptimization\\portfolio-risk-cap-envelope-v1\\research\\research-lifecycles.csv";
...
const ulong MAGIC_RC16_LONG = 260828801;
const ulong MAGIC_RC4_BOTH = 260828802;
const ulong MAGIC_US100_CROSS = 260828803;
const ulong MAGIC_US30_PRESSURE = 260828804;
const ulong MAGIC_US30_RETURN = 260828805;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260828806;
