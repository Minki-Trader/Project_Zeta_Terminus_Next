...
input string InpECRunTag = "unconfigured";
const string EC_ROLE_ROOT=EC_ROLE_ROOT_LITERAL;
const string EC_ROOT=EC_ROLE_ROOT+"\\"+InpECRunTag;
...
const string EXECUTION_VERSION =
   "zt-next-v7-entry-compound-native-v1-"+EC_ROLE_LABEL;
...
const string SCHEMA_VERSION = "7EC1-"+EC_ROLE_LABEL;
const string RELEASE_ID = "OPT-F23-V7EC1-"+EC_ROLE_LABEL;
const string PORTFOLIO_ID = "ZT-OPT-V7EC1-20260908-"+EC_ROLE_LABEL;
...
const ulong MAGIC_RC16_LONG = (EC_MAGIC_BASE+1);
const ulong MAGIC_RC4_BOTH = (EC_MAGIC_BASE+2);
const ulong MAGIC_US100_CROSS = (EC_MAGIC_BASE+3);
const ulong MAGIC_US30_PRESSURE = (EC_MAGIC_BASE+4);
const ulong MAGIC_US30_RETURN = (EC_MAGIC_BASE+5);
const ulong MAGIC_US100_PASSIVE_LIMIT = (EC_MAGIC_BASE+6);
...
void ECExit(const ResearchExitSnapshot &snapshot);
bool ECInitialize();
bool ECFinish();
void ECShutdown();
