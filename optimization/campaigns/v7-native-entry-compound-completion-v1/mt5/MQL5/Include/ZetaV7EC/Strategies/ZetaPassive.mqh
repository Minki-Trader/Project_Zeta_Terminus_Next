...
bool PlacePassiveLimit(const int direction,
                       ...
                       const datetime expiration)
  {
   ...
   if(!ECPrepare(US100_PASSIVE_LIMIT,direction,state)) return(false);
   MqlTick tick = {};
   ...
   if(!ECJournal(US100_PASSIVE_LIMIT,InpBaseVolume,stop_loss,admitted_planned_risk)) return(false);
   ...
   ECPending(execution_state.passive_pending_order);
