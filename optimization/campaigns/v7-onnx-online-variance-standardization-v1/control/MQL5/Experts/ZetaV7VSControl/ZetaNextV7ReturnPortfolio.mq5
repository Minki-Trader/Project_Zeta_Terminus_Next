...
#property description "Execution version: zt-v7-vs-control-v1"

#include <Trade\Trade.mqh>

#include <ZetaV7VSControl\Domain\ZetaDomain.mqh>
#include <ZetaV7VSControl\Time\ZetaSessionClock.mqh>
#include <ZetaV7VSControl\Strategies\ZetaStrategyShared.mqh>
#include <ZetaV7VSControl\Strategies\ZetaRC16.mqh>
#include <ZetaV7VSControl\Strategies\ZetaRC4.mqh>
#include <ZetaV7VSControl\Strategies\ZetaCross.mqh>
#include <ZetaV7VSControl\Strategies\ZetaPressure.mqh>
#include <ZetaV7VSControl\Strategies\ZetaReturn.mqh>
#include <ZetaV7VSControl\Strategies\ZetaPassive.mqh>
#include <ZetaV7VSControl\Portfolio\ZetaPortfolioRisk.mqh>
#include <ZetaV7VSControl\Execution\ZetaOwnership.mqh>
#include <ZetaV7VSControl\Execution\ZetaOrders.mqh>
#include <ZetaV7VSControl\Execution\ZetaProtectionAndReconciliation.mqh>
#include <ZetaV7VSControl\Persistence\ZetaStateAndEvents.mqh>
#include <ZetaV7VSControl\Observation\ZetaResearchObservation.mqh>

#include <ZetaV7VSControl\Observation\ZetaReturnDiagnostics.mqh>

#include <ZetaV7VSControl\Observation\ZetaVSForecast.mqh>
#include <ZetaV7VSControl\Observation\ZetaVSAccountPath.mqh>
...
int OnInit()
  {
   ...
   if(FileIsExist(STATE_PATH_A) || FileIsExist(STATE_PATH_B) || FileIsExist(RESEARCH_CANDIDATE_LEDGER_PATH) ||
      ...
      FileIsExist(VS_ROOT+"\\forecasts.csv")) return(INIT_FAILED);
   ...
   FolderCreate("ZetaV7VSControl");
   FolderCreate("ZetaV7VSControl\\vs");
   ...
   if(!InitializeConnectedRuntime())
      PrintFormat("%s waiting for the saved FPMarkets connection",
                  EXECUTION_VERSION);
   if(!execution_state.runtime_ready || !VSAccountInit(VS_ROOT) || !VSForecastInit(VS_ROOT))
