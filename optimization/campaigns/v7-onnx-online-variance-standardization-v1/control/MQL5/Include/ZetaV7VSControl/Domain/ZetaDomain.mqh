...
input string InpRunTag="selection-control-static-v1";
const int VS_MODE=0;
const string VS_ROOT="ZetaV7VSControl\\vs\\"+InpRunTag;
...
const string SCHEMA_VERSION = "7VS1C";
const string RELEASE_ID = "OPT-V7-VS-CONTROL-20260907";
const string PORTFOLIO_ID = "ZT-OPT-V7-VS-CONTROL-20260907";
...
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-v7-vs-control-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_NEXT_7VS1C_OBSERVATION_STATE_V1";
...
const ulong MAGIC_RC16_LONG = 260901941;
const ulong MAGIC_RC4_BOTH = 260901942;
const ulong MAGIC_US100_CROSS = 260901943;
const ulong MAGIC_US30_PRESSURE = 260901944;
const ulong MAGIC_US30_RETURN = 260901945;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260901946;
