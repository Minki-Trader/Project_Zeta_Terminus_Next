...
input string InpRunTag="selection-online-v1";
const int VS_MODE=2;
const string VS_ROOT="ZetaV7VSOnline\\vs\\"+InpRunTag;
...
const string SCHEMA_VERSION = "7VS1O";
const string RELEASE_ID = "OPT-V7-VS-ONLINE-20260907";
const string PORTFOLIO_ID = "ZT-OPT-V7-VS-ONLINE-20260907";
...
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-v7-vs-online-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_NEXT_7VS1O_OBSERVATION_STATE_V1";
...
const ulong MAGIC_RC16_LONG = 260901961;
const ulong MAGIC_RC4_BOTH = 260901962;
const ulong MAGIC_US100_CROSS = 260901963;
const ulong MAGIC_US30_PRESSURE = 260901964;
const ulong MAGIC_US30_RETURN = 260901965;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260901966;
