...
const string EXECUTION_VERSION =
   "zt-opt-live-v8-dd20-paired-clean-requal-mt5-v1";
const string ECONOMIC_VERSION =
   "zt-opt-live-v8-dd20-paired-clean-requal-economic-v1";
const string PROJECT_ID = "project-zeta-terminus-next";
const string SCHEMA_VERSION = "opt-dd20-pcr-mt5-1";
const string RELEASE_ID = "OPT-LIVE-V8-DD20PCR1-20260831";
const string PORTFOLIO_ID = "ZT-OPT-LIVE-V8-DD20PCR1-20260831";
const string ECONOMIC_FINGERPRINT =
   "clean-requal-ref100-base0.01-posrisk0.04-aggrisk0.18-control-1-1-1-1-1-1-vs-candidate-2-1.5-2-2.5-1.5-0";
const string EXECUTION_FINGERPRINT =
   "isolated-tester-only-v8-paired-clean-history-adjacent-control-candidate-v1";
const string STATE_MARKER =
   "ZT_OPT_LIVE_V8_DD20_PCR1_STATE_V1";
const string STATE_PATH_A =
   "ZetaTerminusNext\\optimization\\dd20-pcr1\\state\\state-a.csv";
const string STATE_PATH_B =
   "ZetaTerminusNext\\optimization\\dd20-pcr1\\state\\state-b.csv";
const string EVENT_PATH_A =
   "ZetaTerminusNext\\optimization\\dd20-pcr1\\state\\events-a.csv";
const string EVENT_PATH_B =
   "ZetaTerminusNext\\optimization\\dd20-pcr1\\state\\events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaTerminusNext\\optimization\\dd20-pcr1\\state\\current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaTerminusNext\\optimization\\dd20-pcr1\\state\\current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaTerminusNext\\optimization\\dd20-pcr1\\state\\runtime.lock";
const string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaTerminusNext\\optimization\\dd20-pcr1\\research";
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-optimization-dd20-paired-clean-requal-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_OPT_LIVE_V8_DD20_PCR1_OBSERVATION_STATE_V1";
const string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaTerminusNext\\optimization\\dd20-pcr1\\research\\research-state-a.csv";
const string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaTerminusNext\\optimization\\dd20-pcr1\\research\\research-state-b.csv";
const string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaTerminusNext\\optimization\\dd20-pcr1\\research\\research-candidates.csv";
const string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaTerminusNext\\optimization\\dd20-pcr1\\research\\research-lifecycles.csv";
...
const ulong MAGIC_RC16_LONG = 260831931;
const ulong MAGIC_RC4_BOTH = 260831932;
const ulong MAGIC_US100_CROSS = 260831933;
const ulong MAGIC_US30_PRESSURE = 260831934;
const ulong MAGIC_US30_RETURN = 260831935;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260831936;
