...
#property description "Project Zeta Terminus Next isolated paired clean-history requalification"
#property description "Execution version: zt-opt-live-v8-dd20-paired-clean-requal-mt5-v1"

#include <Trade\Trade.mqh>

#include <ZetaOptimizationDD20PairedCleanRequalMT5V1\Domain\ZetaDomain.mqh>
#include <ZetaOptimizationDD20PairedCleanRequalMT5V1\Time\ZetaSessionClock.mqh>
#include <ZetaOptimizationDD20PairedCleanRequalMT5V1\Strategies\ZetaStrategyShared.mqh>
#include <ZetaOptimizationDD20PairedCleanRequalMT5V1\Strategies\ZetaRC16.mqh>
#include <ZetaOptimizationDD20PairedCleanRequalMT5V1\Strategies\ZetaRC4.mqh>
#include <ZetaOptimizationDD20PairedCleanRequalMT5V1\Strategies\ZetaCross.mqh>
#include <ZetaOptimizationDD20PairedCleanRequalMT5V1\Strategies\ZetaPressure.mqh>
#include <ZetaOptimizationDD20PairedCleanRequalMT5V1\Strategies\ZetaReturn.mqh>
#include <ZetaOptimizationDD20PairedCleanRequalMT5V1\Strategies\ZetaPassive.mqh>
#include <ZetaOptimizationDD20PairedCleanRequalMT5V1\Portfolio\ZetaPortfolioRisk.mqh>
#include <ZetaOptimizationDD20PairedCleanRequalMT5V1\Execution\ZetaOwnership.mqh>
#include <ZetaOptimizationDD20PairedCleanRequalMT5V1\Execution\ZetaOrders.mqh>
#include <ZetaOptimizationDD20PairedCleanRequalMT5V1\Execution\ZetaProtectionAndReconciliation.mqh>
#include <ZetaOptimizationDD20PairedCleanRequalMT5V1\Persistence\ZetaStateAndEvents.mqh>
#include <ZetaOptimizationDD20PairedCleanRequalMT5V1\Observation\ZetaResearchObservation.mqh>

// The EA owns assembly and the inherited event ordering only.

void PrintPCR1RequiredSymbolContract(const string stage,
                                     const string symbol)
  {
   PrintFormat("%s PCR1_CONTRACT stage=%s symbol=%s "
...
void PrintPCR1RequiredContracts(const string stage)
  {
   PrintPCR1RequiredSymbolContract(stage, "US30");
   PrintPCR1RequiredSymbolContract(stage, "US100");
   PrintPCR1RequiredSymbolContract(stage, "US500");
  }
...
bool InitializeConnectedRuntime()
  {
   ...
   PrintFormat("%s initialized portfolio=%s recovered=%s "
               ...
               state_sequence);
   PrintPCR1RequiredContracts("START");
   return(true);
  }
...
int OnInit()
  {
   ...
   FolderCreate("ZetaTerminusNext\\optimization\\dd20-pcr1");
   FolderCreate("ZetaTerminusNext\\optimization\\dd20-pcr1\\state");
   FolderCreate("ZetaTerminusNext\\optimization\\dd20-pcr1\\research");
...
void OnDeinit(const int reason)
  {
   ...
   PrintPCR1RequiredContracts("END");
   ReleaseRuntimeOwnership();
  }
