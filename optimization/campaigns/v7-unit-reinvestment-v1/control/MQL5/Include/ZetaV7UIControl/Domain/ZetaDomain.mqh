...
input string InpUnitRunTag = "selection-control-v1";
const bool UNIT_REINVESTMENT = false;
...
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-v7-ui-control-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_UI1C_OBSERVATION_STATE_V1";
...
const ulong MAGIC_RC16_LONG = 260901921;
const ulong MAGIC_RC4_BOTH = 260901922;
const ulong MAGIC_US100_CROSS = 260901923;
const ulong MAGIC_US30_PRESSURE = 260901924;
const ulong MAGIC_US30_RETURN = 260901925;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260901926;
