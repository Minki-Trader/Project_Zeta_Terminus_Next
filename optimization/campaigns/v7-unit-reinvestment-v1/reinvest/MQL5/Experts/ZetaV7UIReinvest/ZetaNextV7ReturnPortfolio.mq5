...
#property description "Execution version: zt-next-v7-unit-reinvest-v1"

#include <Trade\Trade.mqh>

#include <ZetaV7UIReinvest\Domain\ZetaDomain.mqh>
#include <ZetaV7UIReinvest\Time\ZetaSessionClock.mqh>
#include <ZetaV7UIReinvest\Strategies\ZetaStrategyShared.mqh>
#include <ZetaV7UIReinvest\Strategies\ZetaRC16.mqh>
#include <ZetaV7UIReinvest\Strategies\ZetaRC4.mqh>
#include <ZetaV7UIReinvest\Strategies\ZetaCross.mqh>
#include <ZetaV7UIReinvest\Strategies\ZetaPressure.mqh>
#include <ZetaV7UIReinvest\Strategies\ZetaReturn.mqh>
#include <ZetaV7UIReinvest\Strategies\ZetaPassive.mqh>
#include <ZetaV7UIReinvest\Portfolio\ZetaPortfolioRisk.mqh>
#include <ZetaV7UIReinvest\Execution\ZetaOwnership.mqh>
#include <ZetaV7UIReinvest\Execution\ZetaOrders.mqh>
#include <ZetaV7UIReinvest\Execution\ZetaProtectionAndReconciliation.mqh>
#include <ZetaV7UIReinvest\Persistence\ZetaStateAndEvents.mqh>
#include <ZetaV7UIReinvest\Observation\ZetaResearchObservation.mqh>

#include <ZetaV7UIReinvest\Observation\ZetaReturnDiagnostics.mqh>
#include <ZetaV7UIReinvest\Observation\ZetaUnitObservation.mqh>
...
int OnInit()
  {
   if(!MQLInfoInteger(MQL_TESTER))
     {
      Print("V7UI refuses non-Tester execution");
      return(INIT_FAILED);
     }
...
double OnTester()
  {
   const bool unit_complete = UnitCompleteObservation();
   PrintFormat("V7UI_NATIVE profit=%.6f equity_dd=%.6f equity_dd_relative_pct=%.9f balance_dd_relative_pct=%.9f trades=%.0f",
   ...
   PrintFormat("%s V7UI_UNAVAILABLE_SUMMARY aggregate=%I64d rows=%I64d "
   ...
   const bool correction_required =
      (!unit_complete || portfolio_state.safety_stopped || persistence_failed ||
   ...
   if(correction_required)
     {
      PrintFormat("V7UI_RESULT status=CORRECTION_REQUIRED "
   ...
   PrintFormat("V7UI_RESULT status=ECONOMIC position_risk=%.6f "
