...
input string InpUnitRunTag = "selection-reinvest-v1";
const bool UNIT_REINVESTMENT = true;
double unit_pending_volume = 0.0;
double unit_positive_closed_swap = 0.0;
string unit_run_root = "";
string unit_path_file = "";
...
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-v7-ui-reinvest-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_UI1R_OBSERVATION_STATE_V1";
...
const ulong MAGIC_RC16_LONG = 260901931;
const ulong MAGIC_RC4_BOTH = 260901932;
const ulong MAGIC_US100_CROSS = 260901933;
const ulong MAGIC_US30_PRESSURE = 260901934;
const ulong MAGIC_US30_RETURN = 260901935;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260901936;
