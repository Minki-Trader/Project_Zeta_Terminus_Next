...
#include <ZetaV7WCStatic\WinnerChild\InitialFit.mqh>
#resource "\\Files\\ZetaV7WCStatic\\winner-child-kernel.onnx" as uchar wc_graph[]
...
#include <ZetaV7WCStatic\WinnerChild\Checkpoint.mqh>
...
bool WCInitialize()
  {
   ...
   wc_root="ZetaV7WCStatic\\"+InpRunTag;
   if(!WCIdentity()) return(false);
   FolderCreate("ZetaV7WCStatic"); FolderCreate(wc_root);FolderCreate(wc_root+"\\state");FolderCreate(wc_root+"\\research");
