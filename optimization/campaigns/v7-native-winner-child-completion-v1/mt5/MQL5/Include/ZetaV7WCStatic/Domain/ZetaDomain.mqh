...
const string SCHEMA_VERSION = "WC1STATIC";
const string RELEASE_ID = "OPT-V7-WC-STATIC-V1";
const string PORTFOLIO_ID = "ZT-OPT-V7-WC-STATIC-20260908";
...
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_WC_STATIC_OBSERVATION_STATE_V1";
...
const ulong MAGIC_RC16_LONG = 2609081041;
const ulong MAGIC_RC4_BOTH = 2609081042;
const ulong MAGIC_US100_CROSS = 2609081043;
const ulong MAGIC_US30_PRESSURE = 2609081044;
const ulong MAGIC_US30_RETURN = 2609081045;
const ulong MAGIC_US100_PASSIVE_LIMIT = 2609081046;
...
#define WC_ROLE 2
const ulong WC_MAGIC_FIRST=2609081051;
