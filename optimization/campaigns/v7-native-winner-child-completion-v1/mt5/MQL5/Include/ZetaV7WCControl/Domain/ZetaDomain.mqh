...
const string SCHEMA_VERSION = "WC1CONTROL";
const string RELEASE_ID = "OPT-V7-WC-CONTROL-V1";
const string PORTFOLIO_ID = "ZT-OPT-V7-WC-CONTROL-20260908";
...
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_WC_CONTROL_OBSERVATION_STATE_V1";
...
const ulong MAGIC_RC16_LONG = 2609081001;
const ulong MAGIC_RC4_BOTH = 2609081002;
const ulong MAGIC_US100_CROSS = 2609081003;
const ulong MAGIC_US30_PRESSURE = 2609081004;
const ulong MAGIC_US30_RETURN = 2609081005;
const ulong MAGIC_US100_PASSIVE_LIMIT = 2609081006;
...
#define WC_ROLE 0
const ulong WC_MAGIC_FIRST=2609081011;
