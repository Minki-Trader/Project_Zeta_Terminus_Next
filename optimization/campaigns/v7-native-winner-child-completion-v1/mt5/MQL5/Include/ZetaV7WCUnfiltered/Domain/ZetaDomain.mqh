...
const string SCHEMA_VERSION = "WC1UNFILTERED";
const string RELEASE_ID = "OPT-V7-WC-UNFILTERED-V1";
const string PORTFOLIO_ID = "ZT-OPT-V7-WC-UNFILTERED-20260908";
...
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_WC_UNFILTERED_OBSERVATION_STATE_V1";
...
const ulong MAGIC_RC16_LONG = 2609081021;
const ulong MAGIC_RC4_BOTH = 2609081022;
const ulong MAGIC_US100_CROSS = 2609081023;
const ulong MAGIC_US30_PRESSURE = 2609081024;
const ulong MAGIC_US30_RETURN = 2609081025;
const ulong MAGIC_US100_PASSIVE_LIMIT = 2609081026;
...
#define WC_ROLE 1
const ulong WC_MAGIC_FIRST=2609081031;
