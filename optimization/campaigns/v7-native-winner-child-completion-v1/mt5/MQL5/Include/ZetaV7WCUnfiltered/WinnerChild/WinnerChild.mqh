...
#include <ZetaV7WCUnfiltered\WinnerChild\InitialFit.mqh>
#resource "\\Files\\ZetaV7WCUnfiltered\\winner-child-kernel.onnx" as uchar wc_graph[]
...
#include <ZetaV7WCUnfiltered\WinnerChild\Checkpoint.mqh>
...
bool WCInitialize()
  {
   ...
   wc_root="ZetaV7WCUnfiltered\\"+InpRunTag;
   if(!WCIdentity()) return(false);
   FolderCreate("ZetaV7WCUnfiltered"); FolderCreate(wc_root);FolderCreate(wc_root+"\\state");FolderCreate(wc_root+"\\research");
