...
#include <ZetaV7WCOnline\WinnerChild\InitialFit.mqh>
#resource "\\Files\\ZetaV7WCOnline\\winner-child-kernel.onnx" as uchar wc_graph[]
...
#include <ZetaV7WCOnline\WinnerChild\Checkpoint.mqh>
...
bool WCInitialize()
  {
   ...
   wc_root="ZetaV7WCOnline\\"+InpRunTag;
   if(!WCIdentity()) return(false);
   FolderCreate("ZetaV7WCOnline"); FolderCreate(wc_root);FolderCreate(wc_root+"\\state");FolderCreate(wc_root+"\\research");
