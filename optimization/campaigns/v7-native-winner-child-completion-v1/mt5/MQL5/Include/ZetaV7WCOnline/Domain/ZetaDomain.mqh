...
const string SCHEMA_VERSION = "WC1ONLINE";
const string RELEASE_ID = "OPT-V7-WC-ONLINE-V1";
const string PORTFOLIO_ID = "ZT-OPT-V7-WC-ONLINE-20260908";
...
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_WC_ONLINE_OBSERVATION_STATE_V1";
...
const ulong MAGIC_RC16_LONG = 2609081061;
const ulong MAGIC_RC4_BOTH = 2609081062;
const ulong MAGIC_US100_CROSS = 2609081063;
const ulong MAGIC_US30_PRESSURE = 2609081064;
const ulong MAGIC_US30_RETURN = 2609081065;
const ulong MAGIC_US100_PASSIVE_LIMIT = 2609081066;
...
#define WC_ROLE 3
const ulong WC_MAGIC_FIRST=2609081071;
