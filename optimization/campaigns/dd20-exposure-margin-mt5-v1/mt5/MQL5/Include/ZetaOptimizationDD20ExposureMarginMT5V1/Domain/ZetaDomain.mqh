...
// Only identity and the six MT5-calibrated proxy-selected multipliers differ.
...
input double InpRC16RiskMultiplier = 1.8;
input double InpRC4RiskMultiplier = 1.3;
input double InpUS100CrossRiskMultiplier = 1.4;
input double InpUS30PressureRiskMultiplier = 2.6;
...
const string EXECUTION_VERSION =
   "zt-opt-live-v7-dd20-exposure-margin-mt5-v1";
...
const string SCHEMA_VERSION = "opt-dd20-em-mt5-1";
const string RELEASE_ID = "OPT-LIVE-V7-DD20EM1-20260828";
const string PORTFOLIO_ID = "ZT-OPT-LIVE-V7-DD20EM1-20260828";
const string ECONOMIC_FINGERPRINT =
   "parent-rlo1-b32e7e176f2e-ref100-base0.01-posrisk0.04-aggrisk0.18-component-exposure-multipliers-1.8-1.3-1.4-2.6-1.5-0";
const string EXECUTION_FINGERPRINT =
   "isolated-tester-only-dd20-exposure-margin-one-candidate-real-tick-v1";
const string STATE_MARKER =
   "ZT_OPT_LIVE_V7_DD20_EXPOSURE_MARGIN_STATE_V1";
const string STATE_PATH_A =
   "ZetaOptimization\\dd20-exposure-margin-mt5-v1\\state\\state-a.csv";
const string STATE_PATH_B =
   "ZetaOptimization\\dd20-exposure-margin-mt5-v1\\state\\state-b.csv";
const string EVENT_PATH_A =
   "ZetaOptimization\\dd20-exposure-margin-mt5-v1\\state\\events-a.csv";
const string EVENT_PATH_B =
   "ZetaOptimization\\dd20-exposure-margin-mt5-v1\\state\\events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaOptimization\\dd20-exposure-margin-mt5-v1\\state\\current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaOptimization\\dd20-exposure-margin-mt5-v1\\state\\current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaOptimization\\dd20-exposure-margin-mt5-v1\\state\\runtime.lock";
const string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaOptimization\\dd20-exposure-margin-mt5-v1\\research";
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-optimization-dd20-exposure-margin-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_OPT_DD20_EXPOSURE_MARGIN_OBSERVATION_STATE_V1";
const string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaOptimization\\dd20-exposure-margin-mt5-v1\\research\\research-state-a.csv";
const string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaOptimization\\dd20-exposure-margin-mt5-v1\\research\\research-state-b.csv";
const string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaOptimization\\dd20-exposure-margin-mt5-v1\\research\\research-candidates.csv";
const string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaOptimization\\dd20-exposure-margin-mt5-v1\\research\\research-lifecycles.csv";
...
const ulong MAGIC_RC16_LONG = 260828831;
const ulong MAGIC_RC4_BOTH = 260828832;
const ulong MAGIC_US100_CROSS = 260828833;
const ulong MAGIC_US30_PRESSURE = 260828834;
const ulong MAGIC_US30_RETURN = 260828835;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260828836;
