...
#property description "Project Zeta Terminus Next isolated DD20 frequency-lane combined-portfolio MT5 candidate"
#property description "Execution version: zt-opt-live-v7-dd20-frequency-lane-combined-portfolio-mt5-v1"

#include <Trade\Trade.mqh>

#include <ZetaOptDD20FLCP1\Domain\ZetaDomain.mqh>
#include <ZetaOptDD20FLCP1\Time\ZetaSessionClock.mqh>
#include <ZetaOptDD20FLCP1\Strategies\ZetaStrategyShared.mqh>
#include <ZetaOptDD20FLCP1\Strategies\ZetaRC16.mqh>
#include <ZetaOptDD20FLCP1\Strategies\ZetaRC4.mqh>
#include <ZetaOptDD20FLCP1\Strategies\ZetaCross.mqh>
#include <ZetaOptDD20FLCP1\Strategies\ZetaPressure.mqh>
#include <ZetaOptDD20FLCP1\Strategies\ZetaReturn.mqh>
#include <ZetaOptDD20FLCP1\Strategies\ZetaPassive.mqh>
#include <ZetaOptDD20FLCP1\Portfolio\ZetaPortfolioRisk.mqh>
#include <ZetaOptDD20FLCP1\Execution\ZetaOwnership.mqh>
#include <ZetaOptDD20FLCP1\Execution\ZetaOrders.mqh>
#include <ZetaOptDD20FLCP1\Execution\ZetaProtectionAndReconciliation.mqh>
#include <ZetaOptDD20FLCP1\Persistence\ZetaStateAndEvents.mqh>
#include <ZetaOptDD20FLCP1\Observation\ZetaResearchObservation.mqh>
#include <ZetaOptDD20FLCP1\Strategies\ZetaUS500H4StagedOverlay.mqh>
...
int OnInit()
  {
   ...
   FolderCreate("ZetaOptimization\\dd20-flcp1");
   FolderCreate("ZetaOptimization\\dd20-flcp1\\state");
   FolderCreate("ZetaOptimization\\dd20-flcp1\\research");
...
double OnTester()
  {
   ...
   const bool correction_required =
      (portfolio_state.safety_stopped || persistence_failed ||
       ...
       h4_open_positions != 0 || closed_lifecycles <= 0);
