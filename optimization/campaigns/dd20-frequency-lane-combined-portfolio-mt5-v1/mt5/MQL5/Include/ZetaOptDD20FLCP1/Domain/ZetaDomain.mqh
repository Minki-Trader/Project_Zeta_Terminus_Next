...
// Isolated optimization copy of the completed executable-exposure MT5 path.
// The paired-month multipliers own the high/mid-frequency core. A separately
// owned fixed-volume US500 H4 lane is assembled in the same tester executable.
...
const string EXECUTION_VERSION =
   "zt-opt-live-v7-dd20-frequency-lane-combined-portfolio-mt5-v1";
...
const string SCHEMA_VERSION = "opt-dd20-flcp-mt5-1";
const string RELEASE_ID = "OPT-LIVE-V7-DD20FLCP1-20260829";
const string PORTFOLIO_ID = "ZT-OPT-LIVE-V7-DD20FLCP1-20260829";
const string ECONOMIC_FINGERPRINT =
   "parent-rlo1-b32e7e176f2e-ref100-base0.01-posrisk0.04-aggrisk0.18-component-exposure-multipliers-2-1.5-2-2.5-1.5-0-plus-exact-us500-h4-staged-lane";
const string EXECUTION_FINGERPRINT =
   "isolated-tester-only-dd20-frequency-lane-combined-portfolio-one-candidate-real-tick-v1";
const string STATE_MARKER =
   "ZT_OPT_LIVE_V7_DD20_FREQUENCY_LANE_COMBINED_PORTFOLIO_STATE_V1";
const string STATE_PATH_A =
   "ZetaOptimization\\dd20-flcp1\\state\\state-a.csv";
const string STATE_PATH_B =
   "ZetaOptimization\\dd20-flcp1\\state\\state-b.csv";
const string EVENT_PATH_A =
   "ZetaOptimization\\dd20-flcp1\\state\\events-a.csv";
const string EVENT_PATH_B =
   "ZetaOptimization\\dd20-flcp1\\state\\events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaOptimization\\dd20-flcp1\\state\\current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaOptimization\\dd20-flcp1\\state\\current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaOptimization\\dd20-flcp1\\state\\runtime.lock";
const string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaOptimization\\dd20-flcp1\\research";
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-optimization-dd20-frequency-lane-combined-portfolio-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_OPT_DD20_FREQUENCY_LANE_COMBINED_PORTFOLIO_OBSERVATION_STATE_V1";
const string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaOptimization\\dd20-flcp1\\research\\research-state-a.csv";
const string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaOptimization\\dd20-flcp1\\research\\research-state-b.csv";
const string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaOptimization\\dd20-flcp1\\research\\research-candidates.csv";
const string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaOptimization\\dd20-flcp1\\research\\research-lifecycles.csv";
...
const ulong MAGIC_RC16_LONG = 260829901;
const ulong MAGIC_RC4_BOTH = 260829902;
const ulong MAGIC_US100_CROSS = 260829903;
const ulong MAGIC_US30_PRESSURE = 260829904;
const ulong MAGIC_US30_RETURN = 260829905;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260829906;
const ulong MAGIC_US500_H4_STAGED_OVERLAY = 260829907;
