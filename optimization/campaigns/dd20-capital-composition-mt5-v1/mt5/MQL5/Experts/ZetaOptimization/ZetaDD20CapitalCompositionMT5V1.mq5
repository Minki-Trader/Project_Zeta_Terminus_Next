...
#property description "Project Zeta Terminus Next isolated DD20 capital-composition MT5 confirmation"
#property description "Execution version: zt-opt-live-v7-dd20-capital-composition-mt5-v1"

#include <Trade\Trade.mqh>

#include <ZetaOptimizationDD20CapitalCompositionMT5V1\Domain\ZetaDomain.mqh>
#include <ZetaOptimizationDD20CapitalCompositionMT5V1\Time\ZetaSessionClock.mqh>
#include <ZetaOptimizationDD20CapitalCompositionMT5V1\Strategies\ZetaStrategyShared.mqh>
#include <ZetaOptimizationDD20CapitalCompositionMT5V1\Strategies\ZetaRC16.mqh>
#include <ZetaOptimizationDD20CapitalCompositionMT5V1\Strategies\ZetaRC4.mqh>
#include <ZetaOptimizationDD20CapitalCompositionMT5V1\Strategies\ZetaCross.mqh>
#include <ZetaOptimizationDD20CapitalCompositionMT5V1\Strategies\ZetaPressure.mqh>
#include <ZetaOptimizationDD20CapitalCompositionMT5V1\Strategies\ZetaReturn.mqh>
#include <ZetaOptimizationDD20CapitalCompositionMT5V1\Strategies\ZetaPassive.mqh>
#include <ZetaOptimizationDD20CapitalCompositionMT5V1\Portfolio\ZetaPortfolioRisk.mqh>
#include <ZetaOptimizationDD20CapitalCompositionMT5V1\Execution\ZetaOwnership.mqh>
#include <ZetaOptimizationDD20CapitalCompositionMT5V1\Execution\ZetaOrders.mqh>
#include <ZetaOptimizationDD20CapitalCompositionMT5V1\Execution\ZetaProtectionAndReconciliation.mqh>
#include <ZetaOptimizationDD20CapitalCompositionMT5V1\Persistence\ZetaStateAndEvents.mqh>
#include <ZetaOptimizationDD20CapitalCompositionMT5V1\Observation\ZetaResearchObservation.mqh>
...
int OnInit()
  {
   ...
   if(!tester_mode || _Symbol != "US30" || _Period != PERIOD_M30 ||
       ...
       MathAbs(InpRC16RiskMultiplier - 3.0) > 1.0e-9 ||
       MathAbs(InpRC4RiskMultiplier - 3.0) > 1.0e-9 ||
   ...
   FolderCreate("ZetaOptimization\\dd20-capital-composition-mt5-v1");
   FolderCreate("ZetaOptimization\\dd20-capital-composition-mt5-v1\\state");
   FolderCreate("ZetaOptimization\\dd20-capital-composition-mt5-v1\\research");
