...
input double InpRC16RiskMultiplier = 3.0;
input double InpRC4RiskMultiplier = 3.0;
input double InpUS100CrossRiskMultiplier = 1.0;
input double InpUS30PressureRiskMultiplier = 2.5;
input double InpUS30ReturnRiskMultiplier = 1.0;
...
const string EXECUTION_VERSION =
   "zt-opt-live-v7-dd20-capital-composition-mt5-v1";
...
const string SCHEMA_VERSION = "opt-dd20-cc-mt5-1";
...
const string STATE_MARKER =
   "ZT_OPT_LIVE_V7_DD20_CAPITAL_COMPOSITION_STATE_V1";
const string STATE_PATH_A =
   "ZetaOptimization\\dd20-capital-composition-mt5-v1\\state\\state-a.csv";
const string STATE_PATH_B =
   "ZetaOptimization\\dd20-capital-composition-mt5-v1\\state\\state-b.csv";
const string EVENT_PATH_A =
   "ZetaOptimization\\dd20-capital-composition-mt5-v1\\state\\events-a.csv";
const string EVENT_PATH_B =
   "ZetaOptimization\\dd20-capital-composition-mt5-v1\\state\\events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaOptimization\\dd20-capital-composition-mt5-v1\\state\\current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaOptimization\\dd20-capital-composition-mt5-v1\\state\\current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaOptimization\\dd20-capital-composition-mt5-v1\\state\\runtime.lock";
const string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaOptimization\\dd20-capital-composition-mt5-v1\\research";
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-optimization-dd20-capital-composition-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_OPT_DD20_CAPITAL_COMPOSITION_OBSERVATION_STATE_V1";
const string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaOptimization\\dd20-capital-composition-mt5-v1\\research\\research-state-a.csv";
const string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaOptimization\\dd20-capital-composition-mt5-v1\\research\\research-state-b.csv";
const string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaOptimization\\dd20-capital-composition-mt5-v1\\research\\research-candidates.csv";
const string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaOptimization\\dd20-capital-composition-mt5-v1\\research\\research-lifecycles.csv";
...
const ulong MAGIC_RC16_LONG = 260828811;
const ulong MAGIC_RC4_BOTH = 260828812;
const ulong MAGIC_US100_CROSS = 260828813;
const ulong MAGIC_US30_PRESSURE = 260828814;
const ulong MAGIC_US30_RETURN = 260828815;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260828816;
