#ifndef ZETA_OPT_DD20_FLCGQ1_DOMAIN_MQH
#define ZETA_OPT_DD20_FLCGQ1_DOMAIN_MQH

// Isolated Optimization validation of one Unit 125 accounting treatment.
// The paired-month high/mid-frequency core and exact fixed-volume US500 H4
// lane share real account surfaces while owning separate growth ledgers.
...
const string EXECUTION_VERSION =
   "zt-opt-live-v7-dd20-frequency-lane-core-growth-quarantine-mt5-v1";
...
const string SCHEMA_VERSION = "opt-dd20-flcgq-mt5-1";
const string RELEASE_ID = "OPT-LIVE-V7-DD20FLCGQ1-20260831";
const string PORTFOLIO_ID = "ZT-OPT-LIVE-V7-DD20FLCGQ1-20260831";
const string ECONOMIC_FINGERPRINT =
   "parent-rlo1-b32e7e176f2e-ref100-base0.01-posrisk0.04-aggrisk0.18-component-exposure-multipliers-2-1.5-2-2.5-1.5-0-plus-exact-us500-h4-lane-core-growth-quarantined";
const string EXECUTION_FINGERPRINT =
   "isolated-tester-only-dd20-frequency-lane-core-growth-quarantine-one-candidate-real-tick-v1";
const string STATE_MARKER =
   "ZT_OPT_LIVE_V7_DD20_FREQUENCY_LANE_CORE_GROWTH_QUARANTINE_STATE_V1";
const string STATE_PATH_A =
   "ZetaOptimization\\dd20-flcgq1\\state\\state-a.csv";
const string STATE_PATH_B =
   "ZetaOptimization\\dd20-flcgq1\\state\\state-b.csv";
const string EVENT_PATH_A =
   "ZetaOptimization\\dd20-flcgq1\\state\\events-a.csv";
const string EVENT_PATH_B =
   "ZetaOptimization\\dd20-flcgq1\\state\\events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaOptimization\\dd20-flcgq1\\state\\current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaOptimization\\dd20-flcgq1\\state\\current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaOptimization\\dd20-flcgq1\\state\\runtime.lock";
const string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaOptimization\\dd20-flcgq1\\research";
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-optimization-dd20-frequency-lane-core-growth-quarantine-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_OPT_DD20_FREQUENCY_LANE_CORE_GROWTH_QUARANTINE_OBSERVATION_STATE_V1";
const string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaOptimization\\dd20-flcgq1\\research\\research-state-a.csv";
const string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaOptimization\\dd20-flcgq1\\research\\research-state-b.csv";
const string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaOptimization\\dd20-flcgq1\\research\\research-candidates.csv";
const string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaOptimization\\dd20-flcgq1\\research\\research-lifecycles.csv";
...
const ulong MAGIC_RC16_LONG = 260831921;
const ulong MAGIC_RC4_BOTH = 260831922;
const ulong MAGIC_US100_CROSS = 260831923;
const ulong MAGIC_US30_PRESSURE = 260831924;
const ulong MAGIC_US30_RETURN = 260831925;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260831926;
const ulong MAGIC_US500_H4_STAGED_OVERLAY = 260831927;
...
long h4_overlay_core_ledger_mutations = 0;
