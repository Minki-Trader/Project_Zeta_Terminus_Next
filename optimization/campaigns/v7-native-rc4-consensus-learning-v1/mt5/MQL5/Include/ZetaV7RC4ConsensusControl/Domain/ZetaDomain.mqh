...
const string EXECUTION_VERSION =
   "zt-opt-v7-rc4-consensus-control-v1";
...
const string SCHEMA_VERSION = "RC4C1CONTROL";
const string RELEASE_ID = "OPT-V7-RC4-CONSENSUS-CONTROL-V1";
const string PORTFOLIO_ID = "ZT-OPT-V7-RC4-CONSENSUS-CONTROL-20260908";
...
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_RC4C1_CONTROL_OBSERVATION_STATE_V1";
...
const ulong MAGIC_RC16_LONG = 2609081101;
const ulong MAGIC_RC4_BOTH = 2609081102;
const ulong MAGIC_US100_CROSS = 2609081103;
const ulong MAGIC_US30_PRESSURE = 2609081104;
const ulong MAGIC_US30_RETURN = 2609081105;
const ulong MAGIC_US100_PASSIVE_LIMIT = 2609081106;
