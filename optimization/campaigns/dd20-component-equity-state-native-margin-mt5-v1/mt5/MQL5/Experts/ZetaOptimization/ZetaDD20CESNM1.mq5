...
#property description "Project Zeta Terminus Next isolated DD20 component equity-state native-margin MT5 clue"
#property description "Execution version: zt-opt-live-v7-dd20-component-equity-state-native-margin-mt5-v1"

#include <Trade\Trade.mqh>

#include <ZetaOptimizationDD20ComponentEquityStateNativeMarginMT5V1\Domain\ZetaDomain.mqh>
#include <ZetaOptimizationDD20ComponentEquityStateNativeMarginMT5V1\Time\ZetaSessionClock.mqh>
#include <ZetaOptimizationDD20ComponentEquityStateNativeMarginMT5V1\Strategies\ZetaStrategyShared.mqh>
#include <ZetaOptimizationDD20ComponentEquityStateNativeMarginMT5V1\Strategies\ZetaRC16.mqh>
#include <ZetaOptimizationDD20ComponentEquityStateNativeMarginMT5V1\Strategies\ZetaRC4.mqh>
#include <ZetaOptimizationDD20ComponentEquityStateNativeMarginMT5V1\Strategies\ZetaCross.mqh>
#include <ZetaOptimizationDD20ComponentEquityStateNativeMarginMT5V1\Strategies\ZetaPressure.mqh>
#include <ZetaOptimizationDD20ComponentEquityStateNativeMarginMT5V1\Strategies\ZetaReturn.mqh>
#include <ZetaOptimizationDD20ComponentEquityStateNativeMarginMT5V1\Strategies\ZetaPassive.mqh>
#include <ZetaOptimizationDD20ComponentEquityStateNativeMarginMT5V1\Portfolio\ZetaPortfolioRisk.mqh>
#include <ZetaOptimizationDD20ComponentEquityStateNativeMarginMT5V1\Execution\ZetaOwnership.mqh>
#include <ZetaOptimizationDD20ComponentEquityStateNativeMarginMT5V1\Execution\ZetaOrders.mqh>
#include <ZetaOptimizationDD20ComponentEquityStateNativeMarginMT5V1\Execution\ZetaProtectionAndReconciliation.mqh>
#include <ZetaOptimizationDD20ComponentEquityStateNativeMarginMT5V1\Persistence\ZetaStateAndEvents.mqh>
#include <ZetaOptimizationDD20ComponentEquityStateNativeMarginMT5V1\Observation\ZetaResearchObservation.mqh>
...
int OnInit()
  {
   ...
   FolderCreate("ZetaOptimization\\dd20-cesnm1");
   FolderCreate("ZetaOptimization\\dd20-cesnm1\\state");
   FolderCreate("ZetaOptimization\\dd20-cesnm1\\research");
...
double OnTester()
  {
   ...
   const bool correction_required =
      (portfolio_state.safety_stopped || persistence_failed ||
       ...
       !state_counts_match || closed_lifecycles <= 0);
