#ifndef ZETA_OPT_DD20_CESNM1_DOMAIN_MQH
#define ZETA_OPT_DD20_CESNM1_DOMAIN_MQH

// Isolated tester-only optimization copy of the frozen RLO1 source.
// The candidate changes only portfolio exposure through causal component-local
// stressed-R state, plus its independent identity and mutable paths.
...
const string EXECUTION_VERSION =
   "zt-opt-live-v7-dd20-component-equity-state-native-margin-mt5-v1";
...
const string SCHEMA_VERSION = "opt-dd20-cesnm-mt5-1";
const string RELEASE_ID = "OPT-LIVE-V7-DD20CESNM1-20260829";
const string PORTFOLIO_ID = "ZT-OPT-LIVE-V7-DD20CESNM1-20260829";
const string ECONOMIC_FINGERPRINT =
   "parent-rlo1-b32e7e176f2e-ref100-base0.01-step150-posrisk0.04-aggrisk0.18-baseweights-1.6-0.8-0.4-3.2-1.2-0-component-stressed-r-lookback40-band0.10-loss0-gain1.125";
const string EXECUTION_FINGERPRINT =
   "isolated-tester-only-dd20-component-equity-state-native-margin-one-candidate-real-tick-v1";
const string STATE_MARKER =
   "ZT_OPT_LIVE_V7_DD20_COMPONENT_EQUITY_STATE_NATIVE_MARGIN_STATE_V1";
const string STATE_PATH_A =
   "ZetaOptimization\\dd20-cesnm1\\state\\state-a.csv";
const string STATE_PATH_B =
   "ZetaOptimization\\dd20-cesnm1\\state\\state-b.csv";
const string EVENT_PATH_A =
   "ZetaOptimization\\dd20-cesnm1\\state\\events-a.csv";
const string EVENT_PATH_B =
   "ZetaOptimization\\dd20-cesnm1\\state\\events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaOptimization\\dd20-cesnm1\\state\\current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaOptimization\\dd20-cesnm1\\state\\current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaOptimization\\dd20-cesnm1\\state\\runtime.lock";
const string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaOptimization\\dd20-cesnm1\\research";
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-optimization-dd20-component-equity-state-native-margin-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_OPT_DD20_COMPONENT_EQUITY_STATE_NATIVE_MARGIN_OBSERVATION_STATE_V1";
const string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaOptimization\\dd20-cesnm1\\research\\research-state-a.csv";
const string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaOptimization\\dd20-cesnm1\\research\\research-state-b.csv";
const string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaOptimization\\dd20-cesnm1\\research\\research-candidates.csv";
const string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaOptimization\\dd20-cesnm1\\research\\research-lifecycles.csv";
...
const ulong MAGIC_RC16_LONG = 260829861;
const ulong MAGIC_RC4_BOTH = 260829862;
const ulong MAGIC_US100_CROSS = 260829863;
const ulong MAGIC_US30_PRESSURE = 260829864;
const ulong MAGIC_US30_RETURN = 260829865;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260829866;
