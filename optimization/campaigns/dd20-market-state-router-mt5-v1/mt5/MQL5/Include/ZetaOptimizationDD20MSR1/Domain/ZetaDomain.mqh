...
// Self-contained Optimization derivation of the frozen RLO1 baseline.
// The paired-month exposure contract and one exact fixed market-state router
// are the only economic changes.
...
input datetime InpRouterActualTradingStart = D'1970.01.01 00:00';
input double InpRouterMinimumPercentile = 0.25;
...
const string EXECUTION_VERSION =
   "zt-opt-live-v7-dd20-market-state-router-mt5-v1";
...
const string SCHEMA_VERSION = "opt-dd20-msr-mt5-1";
const string RELEASE_ID = "OPT-LIVE-V7-DD20MSR1-20260829";
const string PORTFOLIO_ID = "ZT-OPT-LIVE-V7-DD20MSR1-20260829";
const string ECONOMIC_FINGERPRINT =
   "parent-rlo1-b32e7e176f2e-ref100-base0.01-step150-posrisk0.04-aggrisk0.18-weights2-1.5-2-2.5-1.5-0-quarterly-pooled-ridge-alpha10-q25";
const string EXECUTION_FINGERPRINT =
   "isolated-tester-only-dd20-exact-market-state-router-one-candidate-real-tick-v1";
const string STATE_MARKER =
   "ZT_OPT_LIVE_V7_DD20_MARKET_STATE_ROUTER_STATE_V1";
const string STATE_PATH_A =
   "ZetaOptimization\\dd20-market-state-router-mt5-v1\\state\\state-a.csv";
const string STATE_PATH_B =
   "ZetaOptimization\\dd20-market-state-router-mt5-v1\\state\\state-b.csv";
const string EVENT_PATH_A =
   "ZetaOptimization\\dd20-market-state-router-mt5-v1\\state\\events-a.csv";
const string EVENT_PATH_B =
   "ZetaOptimization\\dd20-market-state-router-mt5-v1\\state\\events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaOptimization\\dd20-market-state-router-mt5-v1\\state\\current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaOptimization\\dd20-market-state-router-mt5-v1\\state\\current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaOptimization\\dd20-market-state-router-mt5-v1\\state\\runtime.lock";
const string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaOptimization\\dd20-market-state-router-mt5-v1\\research";
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-optimization-dd20-market-state-router-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_OPT_DD20_MARKET_STATE_ROUTER_OBSERVATION_STATE_V1";
const string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaOptimization\\dd20-market-state-router-mt5-v1\\research\\research-state-a.csv";
const string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaOptimization\\dd20-market-state-router-mt5-v1\\research\\research-state-b.csv";
const string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaOptimization\\dd20-market-state-router-mt5-v1\\research\\research-candidates.csv";
const string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaOptimization\\dd20-market-state-router-mt5-v1\\research\\research-lifecycles.csv";
const string ROUTER_DIRECTORY =
   "ZetaOptimization\\dd20-market-state-router-mt5-v1\\router";
const string ROUTER_DECISION_LEDGER_PATH =
   "ZetaOptimization\\dd20-market-state-router-mt5-v1\\router\\router-decisions.csv";
const string ROUTER_SUMMARY_PATH =
   "ZetaOptimization\\dd20-market-state-router-mt5-v1\\router\\router-summary.csv";
...
const ulong MAGIC_RC16_LONG = 260829921;
const ulong MAGIC_RC4_BOTH = 260829922;
const ulong MAGIC_US100_CROSS = 260829923;
const ulong MAGIC_US30_PRESSURE = 260829924;
const ulong MAGIC_US30_RETURN = 260829925;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260829926;
...
double ComponentRiskMultiplier(const int component);
