...
The governing numeric contract is `evidence/DECLARATION_V1.json`. The physical baseline is exact `optimization/baseline/NEXT-E03-V7R-RLO1-0bba2ca045fe/`. Own input/output and any runtime remain under the matching `optimization/artifacts/raw/` and `optimization/runtime/` names. A single unchanged offline survivor can receive native implementation; proxy marks cannot prove compound profit or equity DD. Live-Dev stays unchanged; at least 30 GiB remains free.
