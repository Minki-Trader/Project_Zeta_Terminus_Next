...
- The declared `35.46%` drawdown gate is actual closed-balance relative drawdown, matching the clean native report's balance basis. The doubled-cost stressed closed-balance drawdown is recorded separately as a conservative diagnostic; it is not substituted for the native anchor definition.
