#ifndef ZETA_OPT_DD20_H4SO1_DOMAIN_MQH
#define ZETA_OPT_DD20_H4SO1_DOMAIN_MQH

// Isolated tester-only optimization copy of the frozen RLO1 source.
// The six-component anchor keeps its fixed component-local stressed-R state.
// One exact lineage-pinned US500 H4 staged overlay is added outside the
// anchor's planned-risk, state and slot accounting.
...
const string EXECUTION_VERSION =
   "zt-opt-live-v7-dd20-legacy-us500-h4-staged-overlay-mt5-v1";
const string ECONOMIC_VERSION =
   "zt-opt-live-v7-dd20-component-equity-state-plus-exact-us500-h4-overlay-v1";
const string PROJECT_ID = "project-zeta-terminus-next";
const string SCHEMA_VERSION = "opt-dd20-h4so-mt5-1";
const string RELEASE_ID = "OPT-LIVE-V7-DD20H4SO1-20260829";
const string PORTFOLIO_ID = "ZT-OPT-LIVE-V7-DD20H4SO1-20260829";
const string ECONOMIC_FINGERPRINT =
   "parent-rlo1-b32e7e176f2e-ref100-base0.01-step150-posrisk0.04-aggrisk0.18-baseweights-1.6-0.8-0.4-3.2-1.2-0-component-stressed-r-lookback40-band0.10-loss0-gain1.125-plus-exact-us500-h4-volatility-expansion-reversion-lookback12-entry1.5-exit0.6-hold30-volume0.01-balance500-margin0.20-no-sl-no-tp";
const string EXECUTION_FINGERPRINT =
   "isolated-tester-only-dd20-legacy-us500-h4-staged-overlay-one-candidate-real-tick-v1";
const string STATE_MARKER =
   "ZT_OPT_LIVE_V7_DD20_LEGACY_US500_H4_STAGED_OVERLAY_STATE_V1";
const string STATE_PATH_A =
   "ZetaOptimization\\dd20-h4so1\\state\\state-a.csv";
const string STATE_PATH_B =
   "ZetaOptimization\\dd20-h4so1\\state\\state-b.csv";
const string EVENT_PATH_A =
   "ZetaOptimization\\dd20-h4so1\\state\\events-a.csv";
const string EVENT_PATH_B =
   "ZetaOptimization\\dd20-h4so1\\state\\events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaOptimization\\dd20-h4so1\\state\\current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaOptimization\\dd20-h4so1\\state\\current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaOptimization\\dd20-h4so1\\state\\runtime.lock";
const string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaOptimization\\dd20-h4so1\\research";
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-optimization-dd20-legacy-us500-h4-staged-overlay-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_OPT_DD20_LEGACY_US500_H4_STAGED_OVERLAY_OBSERVATION_STATE_V1";
const string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaOptimization\\dd20-h4so1\\research\\research-state-a.csv";
const string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaOptimization\\dd20-h4so1\\research\\research-state-b.csv";
const string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaOptimization\\dd20-h4so1\\research\\research-candidates.csv";
const string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaOptimization\\dd20-h4so1\\research\\research-lifecycles.csv";
...
const ulong MAGIC_RC16_LONG = 260829891;
const ulong MAGIC_RC4_BOTH = 260829892;
const ulong MAGIC_US100_CROSS = 260829893;
const ulong MAGIC_US30_PRESSURE = 260829894;
const ulong MAGIC_US30_RETURN = 260829895;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260829896;
const ulong MAGIC_US500_H4_STAGED_OVERLAY = 260829897;
const string US500_H4_STAGED_OVERLAY_CANDIDATE_ID =
   "ZT-H4-US500-V2-VOLATILITY-EXP-b4d28831f9";
const string US500_H4_STAGED_OVERLAY_SYMBOL = "US500";
const double US500_H4_STAGED_OVERLAY_VOLUME = 0.01;
const double US500_H4_STAGED_OVERLAY_BALANCE_GATE_USD = 500.0;
const double US500_H4_STAGED_OVERLAY_MARGIN_FRACTION = 0.20;
const int US500_H4_STAGED_OVERLAY_LOOKBACK = 12;
const double US500_H4_STAGED_OVERLAY_ENTRY_STRENGTH = 1.5;
const double US500_H4_STAGED_OVERLAY_EXIT_STRENGTH = 0.6;
const int US500_H4_STAGED_OVERLAY_MAXIMUM_HOLD_BARS = 30;
...
datetime h4_overlay_last_completed_decision_bar = 0;
datetime h4_overlay_last_order_attempt_server = 0;
double h4_overlay_entry_spread_price = 0.0;
double h4_overlay_entry_transaction_cost = 0.0;
double h4_overlay_entry_adverse_slippage = 0.0;
bool h4_overlay_entry_cost_known = false;
ulong h4_overlay_pending_exit_deal = 0;
ulong h4_overlay_last_processed_exit_deal = 0;
long h4_overlay_completed_entries = 0;
long h4_overlay_completed_exits = 0;
long h4_overlay_entry_failures = 0;
long h4_overlay_exit_failures = 0;
long h4_overlay_partial_or_placed_outcomes = 0;
long h4_overlay_margin_skips = 0;
long h4_overlay_stage_gate_blocks = 0;
long h4_overlay_state_unavailable = 0;
long h4_overlay_late_entry_windows = 0;
long h4_overlay_faults = 0;
double h4_overlay_actual_net = 0.0;
double h4_overlay_stressed_net = 0.0;
