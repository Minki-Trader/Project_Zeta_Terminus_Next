...
#property description "Project Zeta Terminus Next isolated fixed-pair August 2026 MT5 comparison"
#property description "Execution version: zt-opt-live-v7-dd20-fixed-pair-august-relative-mt5-v1"

#include <Trade\Trade.mqh>

#include <ZetaOptimizationDD20FixedPairAugustRelativeMT5V1\Domain\ZetaDomain.mqh>
#include <ZetaOptimizationDD20FixedPairAugustRelativeMT5V1\Time\ZetaSessionClock.mqh>
#include <ZetaOptimizationDD20FixedPairAugustRelativeMT5V1\Strategies\ZetaStrategyShared.mqh>
#include <ZetaOptimizationDD20FixedPairAugustRelativeMT5V1\Strategies\ZetaRC16.mqh>
#include <ZetaOptimizationDD20FixedPairAugustRelativeMT5V1\Strategies\ZetaRC4.mqh>
#include <ZetaOptimizationDD20FixedPairAugustRelativeMT5V1\Strategies\ZetaCross.mqh>
#include <ZetaOptimizationDD20FixedPairAugustRelativeMT5V1\Strategies\ZetaPressure.mqh>
#include <ZetaOptimizationDD20FixedPairAugustRelativeMT5V1\Strategies\ZetaReturn.mqh>
#include <ZetaOptimizationDD20FixedPairAugustRelativeMT5V1\Strategies\ZetaPassive.mqh>
#include <ZetaOptimizationDD20FixedPairAugustRelativeMT5V1\Portfolio\ZetaPortfolioRisk.mqh>
#include <ZetaOptimizationDD20FixedPairAugustRelativeMT5V1\Execution\ZetaOwnership.mqh>
#include <ZetaOptimizationDD20FixedPairAugustRelativeMT5V1\Execution\ZetaOrders.mqh>
#include <ZetaOptimizationDD20FixedPairAugustRelativeMT5V1\Execution\ZetaProtectionAndReconciliation.mqh>
#include <ZetaOptimizationDD20FixedPairAugustRelativeMT5V1\Persistence\ZetaStateAndEvents.mqh>
#include <ZetaOptimizationDD20FixedPairAugustRelativeMT5V1\Observation\ZetaResearchObservation.mqh>
...
bool ExactControlContract()
  {
   return(MathAbs(InpMaximumAggregateRiskFraction - 0.12) <= 1.0e-9 &&
...
bool ExactCandidateContract()
  {
   return(MathAbs(InpMaximumAggregateRiskFraction - 0.18) <= 1.0e-9 &&
...
void SelectFixedPairIdentity(const bool control_contract)
  {
   if(control_contract)
     {
      ECONOMIC_FINGERPRINT =
         "parent-rlo1-b32e7e176f2e-ref100-base0.01-posrisk0.04-aggrisk0.12-component-exposure-multipliers-1-1-1-1-1-1";
      EXECUTION_FINGERPRINT =
         "isolated-tester-only-dd20-fixed-pair-august-relative-control-real-tick-v1";
      return;
     }
   ECONOMIC_FINGERPRINT =
      "parent-rlo1-b32e7e176f2e-ref100-base0.01-posrisk0.04-aggrisk0.18-component-exposure-multipliers-2-1.5-2-2.5-1.5-0";
   EXECUTION_FINGERPRINT =
      "isolated-tester-only-dd20-fixed-pair-august-relative-candidate-real-tick-v1";
  }
...
int OnInit()
  {
   ...
   const bool exact_control_contract = ExactControlContract();
   const bool exact_candidate_contract = ExactCandidateContract();
   if(!tester_mode || _Symbol != "US30" || _Period != PERIOD_M30 ||
       ...
       (!exact_control_contract && !exact_candidate_contract) ||
   ...
   SelectFixedPairIdentity(exact_control_contract);
   FolderCreate("ZetaOptimization");
   FolderCreate("ZetaOptimization\\dd20-fixed-pair-august-relative-mt5-v1");
   FolderCreate("ZetaOptimization\\dd20-fixed-pair-august-relative-mt5-v1\\state");
   FolderCreate("ZetaOptimization\\dd20-fixed-pair-august-relative-mt5-v1\\research");
