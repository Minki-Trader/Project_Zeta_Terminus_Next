...
// One binary accepts only the exact control and fixed-candidate tuples.
...
const string EXECUTION_VERSION =
   "zt-opt-live-v7-dd20-fixed-pair-august-relative-mt5-v1";
...
const string SCHEMA_VERSION = "opt-dd20-fixed-pair-august-relative-mt5-1";
const string RELEASE_ID = "OPT-LIVE-V7-DD20FPAUGR1-20260830";
const string PORTFOLIO_ID = "ZT-OPT-LIVE-V7-DD20FPAUGR1-20260830";
string ECONOMIC_FINGERPRINT = "";
string EXECUTION_FINGERPRINT = "";
const string STATE_MARKER =
   "ZT_OPT_LIVE_V7_DD20_FIXED_PAIR_AUGUST_RELATIVE_STATE_V1";
const string STATE_PATH_A =
   "ZetaOptimization\\dd20-fixed-pair-august-relative-mt5-v1\\state\\state-a.csv";
const string STATE_PATH_B =
   "ZetaOptimization\\dd20-fixed-pair-august-relative-mt5-v1\\state\\state-b.csv";
const string EVENT_PATH_A =
   "ZetaOptimization\\dd20-fixed-pair-august-relative-mt5-v1\\state\\events-a.csv";
const string EVENT_PATH_B =
   "ZetaOptimization\\dd20-fixed-pair-august-relative-mt5-v1\\state\\events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaOptimization\\dd20-fixed-pair-august-relative-mt5-v1\\state\\current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaOptimization\\dd20-fixed-pair-august-relative-mt5-v1\\state\\current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaOptimization\\dd20-fixed-pair-august-relative-mt5-v1\\state\\runtime.lock";
const string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaOptimization\\dd20-fixed-pair-august-relative-mt5-v1\\research";
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-optimization-dd20-fixed-pair-august-relative-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_OPT_DD20_FIXED_PAIR_AUGUST_RELATIVE_OBSERVATION_STATE_V1";
const string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaOptimization\\dd20-fixed-pair-august-relative-mt5-v1\\research\\research-state-a.csv";
const string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaOptimization\\dd20-fixed-pair-august-relative-mt5-v1\\research\\research-state-b.csv";
const string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaOptimization\\dd20-fixed-pair-august-relative-mt5-v1\\research\\research-candidates.csv";
const string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaOptimization\\dd20-fixed-pair-august-relative-mt5-v1\\research\\research-lifecycles.csv";
...
const ulong MAGIC_RC16_LONG = 260830851;
const ulong MAGIC_RC4_BOTH = 260830852;
const ulong MAGIC_US100_CROSS = 260830853;
const ulong MAGIC_US30_PRESSURE = 260830854;
const ulong MAGIC_US30_RETURN = 260830855;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260830856;
