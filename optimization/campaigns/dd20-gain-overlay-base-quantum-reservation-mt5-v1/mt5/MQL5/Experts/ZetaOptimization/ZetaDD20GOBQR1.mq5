...
#property description "Project Zeta Terminus Next isolated DD20 gain-overlay base-quantum reservation MT5 candidate"
#property description "Execution version: zt-opt-live-v7-dd20-gain-overlay-base-quantum-reservation-mt5-v1"

#include <Trade\Trade.mqh>

#include <ZetaOptDD20GOBQR1\Domain\ZetaDomain.mqh>
#include <ZetaOptDD20GOBQR1\Time\ZetaSessionClock.mqh>
#include <ZetaOptDD20GOBQR1\Strategies\ZetaStrategyShared.mqh>
#include <ZetaOptDD20GOBQR1\Strategies\ZetaRC16.mqh>
#include <ZetaOptDD20GOBQR1\Strategies\ZetaRC4.mqh>
#include <ZetaOptDD20GOBQR1\Strategies\ZetaCross.mqh>
#include <ZetaOptDD20GOBQR1\Strategies\ZetaPressure.mqh>
#include <ZetaOptDD20GOBQR1\Strategies\ZetaReturn.mqh>
#include <ZetaOptDD20GOBQR1\Strategies\ZetaPassive.mqh>
#include <ZetaOptDD20GOBQR1\Portfolio\ZetaPortfolioRisk.mqh>
#include <ZetaOptDD20GOBQR1\Execution\ZetaOwnership.mqh>
#include <ZetaOptDD20GOBQR1\Execution\ZetaOrders.mqh>
#include <ZetaOptDD20GOBQR1\Execution\ZetaProtectionAndReconciliation.mqh>
#include <ZetaOptDD20GOBQR1\Persistence\ZetaStateAndEvents.mqh>
#include <ZetaOptDD20GOBQR1\Observation\ZetaResearchObservation.mqh>
...
int OnInit()
  {
   ...
   if(!tester_mode || InpAllowNewEntries ||
       ...
       MathAbs(InpGainOverlayBaseQuantumReserveFraction - 0.04) > 1.0e-9 ||
   ...
   FolderCreate("ZetaOptimization\\dd20-gobqr1");
   FolderCreate("ZetaOptimization\\dd20-gobqr1\\state");
   FolderCreate("ZetaOptimization\\dd20-gobqr1\\research");
...
double OnTester()
  {
   ...
   PrintFormat("GAIN_OVERLAY_RESERVE fraction=%.6f evaluations=%I64d "
               "bindings=%I64d steps_removed=%I64d "
               "neutral_floor_preserved=%I64d",
               InpGainOverlayBaseQuantumReserveFraction,
   ...
   if(correction_required)
     {
      PrintFormat("OPTIMIZATION_RESULT status=CORRECTION_REQUIRED "
                  "position_risk=%.6f aggregate_risk=%.6f reserve=%.6f "
                  "base_weights=%.3f/%.3f/%.3f/%.3f/%.3f/%.3f "
                  "state=lookback%d-band%.3f-loss%.3f-gain%.3f "
                  "closed=%I64d state_faults=%I64d state_counts_match=%d "
                  "reserve_evaluations=%I64d reserve_bindings=%I64d "
                  "reserve_steps_removed=%I64d neutral_floor=%I64d "
