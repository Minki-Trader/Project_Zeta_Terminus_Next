...
const string EXECUTION_VERSION =
   "zt-opt-live-v7-dd20-paired-month-stability-mt5-v1";
...
const string SCHEMA_VERSION = "opt-dd20-pms-mt5-1";
const string RELEASE_ID = "OPT-LIVE-V7-DD20PMS1-20260828";
const string PORTFOLIO_ID = "ZT-OPT-LIVE-V7-DD20PMS1-20260828";
...
const string EXECUTION_FINGERPRINT =
   "isolated-tester-only-dd20-paired-month-stability-one-candidate-real-tick-v1";
const string STATE_MARKER =
   "ZT_OPT_LIVE_V7_DD20_PAIRED_MONTH_STABILITY_STATE_V1";
const string STATE_PATH_A =
   "ZetaOptimization\\dd20-paired-month-stability-mt5-v1\\state\\state-a.csv";
const string STATE_PATH_B =
   "ZetaOptimization\\dd20-paired-month-stability-mt5-v1\\state\\state-b.csv";
const string EVENT_PATH_A =
   "ZetaOptimization\\dd20-paired-month-stability-mt5-v1\\state\\events-a.csv";
const string EVENT_PATH_B =
   "ZetaOptimization\\dd20-paired-month-stability-mt5-v1\\state\\events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaOptimization\\dd20-paired-month-stability-mt5-v1\\state\\current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaOptimization\\dd20-paired-month-stability-mt5-v1\\state\\current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaOptimization\\dd20-paired-month-stability-mt5-v1\\state\\runtime.lock";
const string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaOptimization\\dd20-paired-month-stability-mt5-v1\\research";
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-optimization-dd20-paired-month-stability-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_OPT_DD20_PAIRED_MONTH_STABILITY_OBSERVATION_STATE_V1";
const string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaOptimization\\dd20-paired-month-stability-mt5-v1\\research\\research-state-a.csv";
const string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaOptimization\\dd20-paired-month-stability-mt5-v1\\research\\research-state-b.csv";
const string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaOptimization\\dd20-paired-month-stability-mt5-v1\\research\\research-candidates.csv";
const string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaOptimization\\dd20-paired-month-stability-mt5-v1\\research\\research-lifecycles.csv";
...
const ulong MAGIC_RC16_LONG = 260828821;
const ulong MAGIC_RC4_BOTH = 260828822;
const ulong MAGIC_US100_CROSS = 260828823;
const ulong MAGIC_US30_PRESSURE = 260828824;
const ulong MAGIC_US30_RETURN = 260828825;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260828826;
