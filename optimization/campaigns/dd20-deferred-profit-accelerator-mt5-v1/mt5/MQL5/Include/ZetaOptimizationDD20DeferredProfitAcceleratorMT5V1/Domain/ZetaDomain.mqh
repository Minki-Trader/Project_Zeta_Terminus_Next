...
// Isolated optimization copy of the qualified native-gap/July-robust MT5 path.
// Identity and the frozen deferred profit-accelerator sizing rule differ.
...
input double InpActivationGrowthUSD  = 450.0;
input double InpPostActivationStepUSD = 50.0;
input int    InpMaximumDayVolumeMultiplier = 14;
...
input double InpRC16RiskMultiplier = 1.6;
input double InpRC4RiskMultiplier = 0.8;
input double InpUS100CrossRiskMultiplier = 0.4;
input double InpUS30PressureRiskMultiplier = 3.2;
input double InpUS30ReturnRiskMultiplier = 1.2;
...
const string EXECUTION_VERSION =
   "zt-opt-live-v7-dd20-deferred-profit-accelerator-mt5-v1";
...
const string SCHEMA_VERSION = "opt-dd20-dpa-mt5-1";
const string RELEASE_ID = "OPT-LIVE-V7-DD20DPA1-20260828";
const string PORTFOLIO_ID = "ZT-OPT-LIVE-V7-DD20DPA1-20260828";
const string ECONOMIC_FINGERPRINT =
   "qualified-ngjr-ref100-base0.01-posrisk0.04-aggrisk0.18-weights-1.6-0.8-0.4-3.2-1.2-0-deferred-growth450-poststep50-cap14";
const string EXECUTION_FINGERPRINT =
   "isolated-tester-only-dd20-deferred-profit-accelerator-one-candidate-real-tick-v1";
const string STATE_MARKER =
   "ZT_OPT_LIVE_V7_DD20_DEFERRED_PROFIT_ACCELERATOR_STATE_V1";
const string STATE_PATH_A =
   "ZetaOptimization\\dd20-deferred-profit-accelerator-mt5-v1\\state\\state-a.csv";
const string STATE_PATH_B =
   "ZetaOptimization\\dd20-deferred-profit-accelerator-mt5-v1\\state\\state-b.csv";
const string EVENT_PATH_A =
   "ZetaOptimization\\dd20-deferred-profit-accelerator-mt5-v1\\state\\events-a.csv";
const string EVENT_PATH_B =
   "ZetaOptimization\\dd20-deferred-profit-accelerator-mt5-v1\\state\\events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaOptimization\\dd20-deferred-profit-accelerator-mt5-v1\\state\\current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaOptimization\\dd20-deferred-profit-accelerator-mt5-v1\\state\\current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaOptimization\\dd20-deferred-profit-accelerator-mt5-v1\\state\\runtime.lock";
const string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaOptimization\\dd20-deferred-profit-accelerator-mt5-v1\\research";
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-optimization-dd20-deferred-profit-accelerator-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_OPT_DD20_DEFERRED_PROFIT_ACCELERATOR_OBSERVATION_STATE_V1";
const string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaOptimization\\dd20-deferred-profit-accelerator-mt5-v1\\research\\research-state-a.csv";
const string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaOptimization\\dd20-deferred-profit-accelerator-mt5-v1\\research\\research-state-b.csv";
const string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaOptimization\\dd20-deferred-profit-accelerator-mt5-v1\\research\\research-candidates.csv";
const string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaOptimization\\dd20-deferred-profit-accelerator-mt5-v1\\research\\research-lifecycles.csv";
...
const ulong MAGIC_RC16_LONG = 260828851;
const ulong MAGIC_RC4_BOTH = 260828852;
const ulong MAGIC_US100_CROSS = 260828853;
const ulong MAGIC_US30_PRESSURE = 260828854;
const ulong MAGIC_US30_RETURN = 260828855;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260828856;
