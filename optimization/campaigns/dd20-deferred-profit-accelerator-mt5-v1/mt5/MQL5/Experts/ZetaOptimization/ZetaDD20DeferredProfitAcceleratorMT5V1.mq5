...
#property description "Project Zeta Terminus Next isolated DD20 deferred profit-accelerator MT5 confirmation"
#property description "Execution version: zt-opt-live-v7-dd20-deferred-profit-accelerator-mt5-v1"

#include <Trade\Trade.mqh>

#include <ZetaOptimizationDD20DeferredProfitAcceleratorMT5V1\Domain\ZetaDomain.mqh>
#include <ZetaOptimizationDD20DeferredProfitAcceleratorMT5V1\Time\ZetaSessionClock.mqh>
#include <ZetaOptimizationDD20DeferredProfitAcceleratorMT5V1\Strategies\ZetaStrategyShared.mqh>
#include <ZetaOptimizationDD20DeferredProfitAcceleratorMT5V1\Strategies\ZetaRC16.mqh>
#include <ZetaOptimizationDD20DeferredProfitAcceleratorMT5V1\Strategies\ZetaRC4.mqh>
#include <ZetaOptimizationDD20DeferredProfitAcceleratorMT5V1\Strategies\ZetaCross.mqh>
#include <ZetaOptimizationDD20DeferredProfitAcceleratorMT5V1\Strategies\ZetaPressure.mqh>
#include <ZetaOptimizationDD20DeferredProfitAcceleratorMT5V1\Strategies\ZetaReturn.mqh>
#include <ZetaOptimizationDD20DeferredProfitAcceleratorMT5V1\Strategies\ZetaPassive.mqh>
#include <ZetaOptimizationDD20DeferredProfitAcceleratorMT5V1\Portfolio\ZetaPortfolioRisk.mqh>
#include <ZetaOptimizationDD20DeferredProfitAcceleratorMT5V1\Execution\ZetaOwnership.mqh>
#include <ZetaOptimizationDD20DeferredProfitAcceleratorMT5V1\Execution\ZetaOrders.mqh>
#include <ZetaOptimizationDD20DeferredProfitAcceleratorMT5V1\Execution\ZetaProtectionAndReconciliation.mqh>
#include <ZetaOptimizationDD20DeferredProfitAcceleratorMT5V1\Persistence\ZetaStateAndEvents.mqh>
#include <ZetaOptimizationDD20DeferredProfitAcceleratorMT5V1\Observation\ZetaResearchObservation.mqh>
...
int OnInit()
  {
   ...
   if(!tester_mode || _Symbol != "US30" || _Period != PERIOD_M30 ||
       ...
       MathAbs(InpActivationGrowthUSD - 450.0) > 1.0e-9 ||
       MathAbs(InpPostActivationStepUSD - 50.0) > 1.0e-9 ||
       InpMaximumDayVolumeMultiplier != 14 ||
       ...
       MathAbs(InpRC16RiskMultiplier - 1.6) > 1.0e-9 ||
       MathAbs(InpRC4RiskMultiplier - 0.8) > 1.0e-9 ||
       MathAbs(InpUS100CrossRiskMultiplier - 0.4) > 1.0e-9 ||
       MathAbs(InpUS30PressureRiskMultiplier - 3.2) > 1.0e-9 ||
       MathAbs(InpUS30ReturnRiskMultiplier - 1.2) > 1.0e-9 ||
   ...
   FolderCreate("ZetaOptimization\\dd20-deferred-profit-accelerator-mt5-v1");
   FolderCreate("ZetaOptimization\\dd20-deferred-profit-accelerator-mt5-v1\\state");
   FolderCreate("ZetaOptimization\\dd20-deferred-profit-accelerator-mt5-v1\\research");
   ...
   if(correction_required)
     {
      PrintFormat("OPTIMIZATION_RESULT status=CORRECTION_REQUIRED "
                  ...
                  InpActivationGrowthUSD,
                  InpPostActivationStepUSD,
                  InpMaximumDayVolumeMultiplier,
                  closed_lifecycles,
