...
- Full June/July sequential DD uses the preserved base and new near-miss MT5 forward anchors, never falls below raw DD, and adds a frozen `0.25` percentage-point reserve before the same hard gate.
...
The nine-file copied input bundle, contract and outcome-free script are frozen before invocation. The selection, full paired forward, June, July, ranking and shortlist remain unopened. This campaign has no Live or Lab authority and cannot promote anything automatically.
