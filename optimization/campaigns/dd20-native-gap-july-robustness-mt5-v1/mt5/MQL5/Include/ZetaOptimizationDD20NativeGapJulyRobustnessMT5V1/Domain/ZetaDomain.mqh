...
// Only identity and the six native-gap/July-robust proxy multipliers differ.
...
const string EXECUTION_VERSION =
   "zt-opt-live-v7-dd20-native-gap-july-robustness-mt5-v1";
...
const string SCHEMA_VERSION = "opt-dd20-ngjr-mt5-1";
const string RELEASE_ID = "OPT-LIVE-V7-DD20NGJR1-20260828";
const string PORTFOLIO_ID = "ZT-OPT-LIVE-V7-DD20NGJR1-20260828";
const string ECONOMIC_FINGERPRINT =
   "parent-rlo1-b32e7e176f2e-ref100-base0.01-posrisk0.04-aggrisk0.18-component-exposure-multipliers-1.6-0.8-0.4-3.2-1.2-0";
const string EXECUTION_FINGERPRINT =
   "isolated-tester-only-dd20-native-gap-july-robustness-one-candidate-real-tick-v1";
const string STATE_MARKER =
   "ZT_OPT_LIVE_V7_DD20_NATIVE_GAP_JULY_ROBUSTNESS_STATE_V1";
const string STATE_PATH_A =
   "ZetaOptimization\\dd20-native-gap-july-robustness-mt5-v1\\state\\state-a.csv";
const string STATE_PATH_B =
   "ZetaOptimization\\dd20-native-gap-july-robustness-mt5-v1\\state\\state-b.csv";
const string EVENT_PATH_A =
   "ZetaOptimization\\dd20-native-gap-july-robustness-mt5-v1\\state\\events-a.csv";
const string EVENT_PATH_B =
   "ZetaOptimization\\dd20-native-gap-july-robustness-mt5-v1\\state\\events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaOptimization\\dd20-native-gap-july-robustness-mt5-v1\\state\\current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaOptimization\\dd20-native-gap-july-robustness-mt5-v1\\state\\current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaOptimization\\dd20-native-gap-july-robustness-mt5-v1\\state\\runtime.lock";
const string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaOptimization\\dd20-native-gap-july-robustness-mt5-v1\\research";
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-optimization-dd20-native-gap-july-robustness-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_OPT_DD20_NATIVE_GAP_JULY_ROBUSTNESS_OBSERVATION_STATE_V1";
const string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaOptimization\\dd20-native-gap-july-robustness-mt5-v1\\research\\research-state-a.csv";
const string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaOptimization\\dd20-native-gap-july-robustness-mt5-v1\\research\\research-state-b.csv";
const string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaOptimization\\dd20-native-gap-july-robustness-mt5-v1\\research\\research-candidates.csv";
const string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaOptimization\\dd20-native-gap-july-robustness-mt5-v1\\research\\research-lifecycles.csv";
...
const ulong MAGIC_RC16_LONG = 260828841;
const ulong MAGIC_RC4_BOTH = 260828842;
const ulong MAGIC_US100_CROSS = 260828843;
const ulong MAGIC_US30_PRESSURE = 260828844;
const ulong MAGIC_US30_RETURN = 260828845;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260828846;
