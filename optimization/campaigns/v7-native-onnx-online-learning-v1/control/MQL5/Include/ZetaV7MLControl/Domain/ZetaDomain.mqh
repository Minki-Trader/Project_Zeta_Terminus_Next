...
const string EXECUTION_VERSION =
   "zt-opt-v7-nml-control-20260907";
...
const string SCHEMA_VERSION = "NMC1";
const string RELEASE_ID = "OPT-V7-NML-CONTROL-20260907";
const string PORTFOLIO_ID = "ZT-OPT-V7-NML-CONTROL-20260907";
...
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_NEXT_NMC1_OBSERVATION_STATE_V1";
...
const ulong MAGIC_RC16_LONG = 260907910;
const ulong MAGIC_RC4_BOTH = 260907911;
const ulong MAGIC_US100_CROSS = 260907912;
const ulong MAGIC_US30_PRESSURE = 260907913;
const ulong MAGIC_US30_RETURN = 260907914;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260907915;
