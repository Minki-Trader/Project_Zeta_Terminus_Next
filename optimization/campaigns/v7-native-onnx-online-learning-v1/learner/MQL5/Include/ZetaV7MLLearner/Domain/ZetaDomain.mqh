...
const string EXECUTION_VERSION =
   "zt-opt-v7-nml-learner-20260907";
...
const string SCHEMA_VERSION = "NML1";
const string RELEASE_ID = "OPT-V7-NML-LEARNER-20260907";
const string PORTFOLIO_ID = "ZT-OPT-V7-NML-LEARNER-20260907";
...
const string STATE_MARKER =
   "ZT_NEXT_NML1_STATE_V1";
const string STATE_PATH_A =
   "ZetaV7MLLearner\\optimization\\native-learning\\state\\state-a.csv";
const string STATE_PATH_B =
   "ZetaV7MLLearner\\optimization\\native-learning\\state\\state-b.csv";
const string EVENT_PATH_A =
   "ZetaV7MLLearner\\optimization\\native-learning\\state\\events-a.csv";
const string EVENT_PATH_B =
   "ZetaV7MLLearner\\optimization\\native-learning\\state\\events-b.csv";
const string CURRENT_SNAPSHOT_PATH_A =
   "ZetaV7MLLearner\\optimization\\native-learning\\state\\current-a.csv";
const string CURRENT_SNAPSHOT_PATH_B =
   "ZetaV7MLLearner\\optimization\\native-learning\\state\\current-b.csv";
const string OWNERSHIP_PATH =
   "ZetaV7MLLearner\\optimization\\native-learning\\state\\runtime.lock";
const string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaV7MLLearner\\optimization\\native-learning\\research";
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-next-native-learning-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_NEXT_NML1_OBSERVATION_STATE_V1";
const string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaV7MLLearner\\optimization\\native-learning\\research\\research-state-a.csv";
const string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaV7MLLearner\\optimization\\native-learning\\research\\research-state-b.csv";
const string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaV7MLLearner\\optimization\\native-learning\\research\\research-candidates.csv";
const string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaV7MLLearner\\optimization\\native-learning\\research\\research-lifecycles.csv";
...
const ulong MAGIC_RC16_LONG = 260907920;
const ulong MAGIC_RC4_BOTH = 260907921;
const ulong MAGIC_US100_CROSS = 260907922;
const ulong MAGIC_US30_PRESSURE = 260907923;
const ulong MAGIC_US30_RETURN = 260907924;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260907925;
