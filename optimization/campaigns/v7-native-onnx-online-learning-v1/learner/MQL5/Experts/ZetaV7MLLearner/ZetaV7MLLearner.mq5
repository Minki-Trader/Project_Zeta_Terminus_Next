...
#property description "Execution version: zt-opt-v7-nml-learner-20260907"

#resource "online-linear.onnx" as uchar NativeOnlineGraph[]

#include <Trade\Trade.mqh>

#include <ZetaV7MLLearner\Domain\ZetaDomain.mqh>
#include <ZetaV7MLLearner\Learning\ZetaNativeOnlineLearning.mqh>
#include <ZetaV7MLLearner\Time\ZetaSessionClock.mqh>
#include <ZetaV7MLLearner\Strategies\ZetaStrategyShared.mqh>
#include <ZetaV7MLLearner\Strategies\ZetaRC16.mqh>
#include <ZetaV7MLLearner\Strategies\ZetaRC4.mqh>
#include <ZetaV7MLLearner\Strategies\ZetaCross.mqh>
#include <ZetaV7MLLearner\Strategies\ZetaPressure.mqh>
#include <ZetaV7MLLearner\Strategies\ZetaReturn.mqh>
#include <ZetaV7MLLearner\Strategies\ZetaPassive.mqh>
#include <ZetaV7MLLearner\Portfolio\ZetaPortfolioRisk.mqh>
#include <ZetaV7MLLearner\Execution\ZetaOwnership.mqh>
#include <ZetaV7MLLearner\Execution\ZetaOrders.mqh>
#include <ZetaV7MLLearner\Execution\ZetaProtectionAndReconciliation.mqh>
#include <ZetaV7MLLearner\Persistence\ZetaStateAndEvents.mqh>
#include <ZetaV7MLLearner\Observation\ZetaResearchObservation.mqh>

#include <ZetaV7MLLearner\Observation\ZetaReturnDiagnostics.mqh>
...
int OnInit()
  {
   ...
   FolderCreate("ZetaV7MLLearner");
   FolderCreate("ZetaV7MLLearner\\optimization");
   FolderCreate("ZetaV7MLLearner\\optimization\\native-learning");
   FolderCreate("ZetaV7MLLearner\\optimization\\native-learning\\state");
   FolderCreate("ZetaV7MLLearner\\optimization\\native-learning\\research");
   if(tester_mode)
      ResetTesterArtifacts();
   if(!NativeMLInitialize())
      return(INIT_FAILED);
...
double OnTester()
  {
   ...
   const bool correction_required =
      (native_ml_errors != 0 || portfolio_state.safety_stopped || persistence_failed ||
