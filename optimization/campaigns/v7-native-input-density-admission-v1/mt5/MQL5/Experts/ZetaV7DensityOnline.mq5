#define DENSITY_ROLE 2
#define DENSITY_EA_NAME "ZetaV7DensityOnline"
#define DENSITY_MAGIC_FIRST 2609081401
#define DENSITY_SCHEMA "DENS1ONLINE"
#define DENSITY_EXECUTION "zt-opt-v7-input-density-online-v1"
#define DENSITY_RELEASE "OPT-V7-INPUT-DENSITY-ONLINE-V1"
#define DENSITY_PORTFOLIO "ZT-OPT-V7-INPUT-DENSITY-ONLINE-20260908"
#define DENSITY_STATE_MARKER "DENSITY_ONLINE_CORE_V1"
#define DENSITY_RESEARCH_MARKER "DENSITY_ONLINE_RESEARCH_V1"
...
#include <ZetaV7Density\Time\ZetaSessionClock.mqh>
#include <ZetaV7Density\Strategies\ZetaStrategyShared.mqh>
#include <ZetaV7Density\Strategies\ZetaRC16.mqh>
#include <ZetaV7Density\Strategies\ZetaRC4.mqh>
#include <ZetaV7Density\Strategies\ZetaCross.mqh>
#include <ZetaV7Density\Strategies\ZetaPressure.mqh>
#include <ZetaV7Density\Strategies\ZetaReturn.mqh>
#include <ZetaV7Density\Strategies\ZetaPassive.mqh>
#include <ZetaV7Density\Portfolio\ZetaPortfolioRisk.mqh>
#include <ZetaV7Density\Execution\ZetaOwnership.mqh>
#include <ZetaV7Density\Execution\ZetaOrders.mqh>
#include <ZetaV7Density\Execution\ZetaProtectionAndReconciliation.mqh>
#include <ZetaV7Density\Persistence\ZetaStateAndEvents.mqh>
#include <ZetaV7Density\Observation\ZetaResearchObservation.mqh>

#include <ZetaV7Density\Observation\ZetaReturnDiagnostics.mqh>

#include <ZetaV7Density\Learning\DensityLearning.mqh>
...
int OnInit()
  {
   ...
   if(!DensityInitializeOwnedPaths())
      return(INIT_FAILED);
