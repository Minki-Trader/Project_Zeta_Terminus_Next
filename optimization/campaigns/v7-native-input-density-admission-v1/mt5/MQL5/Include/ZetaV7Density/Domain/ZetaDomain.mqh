...
const string SCHEMA_VERSION = DENSITY_SCHEMA;
const string RELEASE_ID = DENSITY_RELEASE;
const string PORTFOLIO_ID = DENSITY_PORTFOLIO;
...
const ulong MAGIC_RC16_LONG = (DENSITY_MAGIC_FIRST+0);
const ulong MAGIC_RC4_BOTH = (DENSITY_MAGIC_FIRST+1);
const ulong MAGIC_US100_CROSS = (DENSITY_MAGIC_FIRST+2);
const ulong MAGIC_US30_PRESSURE = (DENSITY_MAGIC_FIRST+3);
const ulong MAGIC_US30_RETURN = (DENSITY_MAGIC_FIRST+4);
const ulong MAGIC_US100_PASSIVE_LIMIT = (DENSITY_MAGIC_FIRST+5);
