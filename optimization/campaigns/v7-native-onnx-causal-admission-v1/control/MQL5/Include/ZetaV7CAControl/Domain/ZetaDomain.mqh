...
const string EXECUTION_VERSION =
   "zt-next-v7-causal-admission-control-v1";
...
const string SCHEMA_VERSION = "7CA1C";
const string RELEASE_ID = "OPT-V7CA-CONTROL-V1";
const string PORTFOLIO_ID = "ZT-PORT-NEXT-V7CA-CONTROL-20260907";
...
const string STATE_MARKER =
   "ZT_NEXT_7CA1C_STATE_V1";
string STATE_PATH_A =
   "ZetaV7CAControl\\optimization\\causal-admission\\state\\state-a.csv";
string STATE_PATH_B =
   "ZetaV7CAControl\\optimization\\causal-admission\\state\\state-b.csv";
string EVENT_PATH_A =
   "ZetaV7CAControl\\optimization\\causal-admission\\state\\events-a.csv";
string EVENT_PATH_B =
   "ZetaV7CAControl\\optimization\\causal-admission\\state\\events-b.csv";
string CURRENT_SNAPSHOT_PATH_A =
   "ZetaV7CAControl\\optimization\\causal-admission\\state\\current-a.csv";
string CURRENT_SNAPSHOT_PATH_B =
   "ZetaV7CAControl\\optimization\\causal-admission\\state\\current-b.csv";
string OWNERSHIP_PATH =
   "ZetaV7CAControl\\optimization\\causal-admission\\state\\runtime.lock";
string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaV7CAControl\\optimization\\causal-admission\\research";
...
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_NEXT_7CA1C_OBSERVATION_STATE_V1";
string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaV7CAControl\\optimization\\causal-admission\\research\\research-state-a.csv";
string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaV7CAControl\\optimization\\causal-admission\\research\\research-state-b.csv";
string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaV7CAControl\\optimization\\causal-admission\\research\\research-candidates.csv";
string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaV7CAControl\\optimization\\causal-admission\\research\\research-lifecycles.csv";
...
const ulong MAGIC_RC16_LONG = 260901901;
const ulong MAGIC_RC4_BOTH = 260901902;
const ulong MAGIC_US100_CROSS = 260901903;
const ulong MAGIC_US30_PRESSURE = 260901904;
const ulong MAGIC_US30_RETURN = 260901905;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260901906;
