...
#include <ZetaV7CAControl\Learning\ZetaCausalParameters.mqh>
#include <ZetaV7CAControl\Learning\ZetaCausalGraph.mqh>
...
bool CausalPreparePaths()
  {
   ...
   const string top="ZetaV7CAControl";
   const string base=top+"\\optimization\\causal-admission\\"+InpCausalRunTag;
   ...
   FolderCreate(top);
   FolderCreate(top+"\\optimization");
   FolderCreate(top+"\\optimization\\causal-admission");
