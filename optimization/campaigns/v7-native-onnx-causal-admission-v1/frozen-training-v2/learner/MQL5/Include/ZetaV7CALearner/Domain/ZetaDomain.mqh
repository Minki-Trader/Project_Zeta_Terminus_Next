...
input int InpCausalRole = 1;
input uint InpCausalSeed = 2026090701;
input string InpCausalRunTag = "unassigned";
...
const string EXECUTION_VERSION =
   "zt-next-v7-causal-admission-learner-v1";
...
const string SCHEMA_VERSION = "7CA1L";
const string RELEASE_ID = "OPT-V7CA-LEARNER-V1";
const string PORTFOLIO_ID = "ZT-PORT-NEXT-V7CA-LEARNER-20260907";
...
const string STATE_MARKER =
   "ZT_NEXT_7CA1L_STATE_V1";
string STATE_PATH_A =
   "ZetaV7CALearner\\optimization\\causal-admission\\state\\state-a.csv";
string STATE_PATH_B =
   "ZetaV7CALearner\\optimization\\causal-admission\\state\\state-b.csv";
string EVENT_PATH_A =
   "ZetaV7CALearner\\optimization\\causal-admission\\state\\events-a.csv";
string EVENT_PATH_B =
   "ZetaV7CALearner\\optimization\\causal-admission\\state\\events-b.csv";
string CURRENT_SNAPSHOT_PATH_A =
   "ZetaV7CALearner\\optimization\\causal-admission\\state\\current-a.csv";
string CURRENT_SNAPSHOT_PATH_B =
   "ZetaV7CALearner\\optimization\\causal-admission\\state\\current-b.csv";
string OWNERSHIP_PATH =
   "ZetaV7CALearner\\optimization\\causal-admission\\state\\runtime.lock";
string RESEARCH_OBSERVATION_DIRECTORY =
   "ZetaV7CALearner\\optimization\\causal-admission\\research";
const string RESEARCH_OBSERVATION_SCHEMA =
   "zeta-next-causal-admission-observation-v1";
const string RESEARCH_OBSERVATION_MARKER =
   "ZT_NEXT_7CA1L_OBSERVATION_STATE_V1";
string RESEARCH_OBSERVATION_STATE_PATH_A =
   "ZetaV7CALearner\\optimization\\causal-admission\\research\\research-state-a.csv";
string RESEARCH_OBSERVATION_STATE_PATH_B =
   "ZetaV7CALearner\\optimization\\causal-admission\\research\\research-state-b.csv";
string RESEARCH_CANDIDATE_LEDGER_PATH =
   "ZetaV7CALearner\\optimization\\causal-admission\\research\\research-candidates.csv";
string RESEARCH_LIFECYCLE_LEDGER_PATH =
   "ZetaV7CALearner\\optimization\\causal-admission\\research\\research-lifecycles.csv";
...
const ulong MAGIC_RC16_LONG = 260901911;
const ulong MAGIC_RC4_BOTH = 260901912;
const ulong MAGIC_US100_CROSS = 260901913;
const ulong MAGIC_US30_PRESSURE = 260901914;
const ulong MAGIC_US30_RETURN = 260901915;
const ulong MAGIC_US100_PASSIVE_LIMIT = 260901916;
