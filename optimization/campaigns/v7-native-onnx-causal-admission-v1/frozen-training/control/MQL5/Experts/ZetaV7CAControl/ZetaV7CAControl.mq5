...
#property description "Execution version: zt-next-v7-causal-admission-control-v1"

#include <Trade\Trade.mqh>

#include <ZetaV7CAControl\Domain\ZetaDomain.mqh>
#include <ZetaV7CAControl\Time\ZetaSessionClock.mqh>
#include <ZetaV7CAControl\Strategies\ZetaStrategyShared.mqh>
#include <ZetaV7CAControl\Strategies\ZetaRC16.mqh>
#include <ZetaV7CAControl\Strategies\ZetaRC4.mqh>
#include <ZetaV7CAControl\Strategies\ZetaCross.mqh>
#include <ZetaV7CAControl\Strategies\ZetaPressure.mqh>
#include <ZetaV7CAControl\Strategies\ZetaReturn.mqh>
#include <ZetaV7CAControl\Strategies\ZetaPassive.mqh>
#include <ZetaV7CAControl\Portfolio\ZetaPortfolioRisk.mqh>
#include <ZetaV7CAControl\Execution\ZetaOwnership.mqh>
#include <ZetaV7CAControl\Execution\ZetaOrders.mqh>
#include <ZetaV7CAControl\Execution\ZetaProtectionAndReconciliation.mqh>
#include <ZetaV7CAControl\Persistence\ZetaStateAndEvents.mqh>
#include <ZetaV7CAControl\Observation\ZetaResearchObservation.mqh>

#include <ZetaV7CAControl\Observation\ZetaReturnDiagnostics.mqh>

#include <ZetaV7CAControl\Learning\ZetaCausalAdmission.mqh>
...
int OnInit()
  {
   ...
   if(InpCausalRunTag=="unassigned" || InpCausalRole!=0) return(INIT_PARAMETERS_INCORRECT);
