...
The active engineering task is `NEXT-E01`: derive modular V7 from frozen B70 V6R6 without changing any of the six entry streams, causal management, sizing, risk, cost, timing, order, or protection contracts. The old Terminus repository remains the sole B70 Live-Dev operator until V7 has exact fixed-window real-tick evidence, entries-disabled operating evidence, a flat handoff boundary, and separate explicit user authorization.
