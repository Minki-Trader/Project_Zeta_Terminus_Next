...
Live-Dev and V7 new entries are explicitly authorized in `CURRENT_STATE.md`. The root Master launcher restores only the exact V7 owner and Korean dashboard without duplicating them. Running or compiling Lab material never changes Live.
